<?php
	...
	class Branch_locationsController extends Controller
	{
		...
		public function area_zone_data()
		{
			$allData['zone'] = DB::table( 'tbl_zone as z' )->get();
			$allData['area'] = DB::table( 'tbl_area as a' )->get();
			echo json_encode($allData);
		}
		...
		{
			$allData['br_info'] = DB::table( 'branch_locations as bl' )
			             ->leftJoin( 'tbl_branch as b', 'bl.branch_code', '=', 'b.br_code' )
			             ->leftJoin( 'tbl_area as a', 'b.area_code', '=', 'a.area_code' )
			             ->leftJoin( 'tbl_zone as z', 'b.zone_code', '=', 'z.zone_code' )
						 ->where('b.branch_name', 'NOT LIKE', '%-%')
		...
		public function index()
		{
			...
			$allData = DB::table( 'branch_locations as bl' )
			             ...
			             ->leftJoin( 'tbl_area as a', 'b.area_code', '=', 'a.area_code' )
			             ->leftJoin( 'tbl_zone as z', 'b.zone_code', '=', 'z.zone_code' )
						 ->leftJoin( 'tbl_cib_upazila as u', 'bl.upa_code', '=', 'u.upa_code' )
						  ->leftJoin( 'tbl_cib_district as d', 'bl.dis_code', '=', 'd.dis_code' )
			            // ->where( 'bl.branch_location_status', 1 )
						->where('branch_name', 'NOT LIKE', '%-%')
			             ->orderBy( 'z.zone_code', 'ASC' )
//			             ->orderBy( 'a.area_code', 'ASC' )
...
//			             ->orderBy( 'bl.branch_location_id', 'DESC' )
			...
			$allDistrictData = DB::table( 'tbl_cib_district' )
			                   ->where( 'dis_status', 1 )
							   ->orderBy( 'dis_name', 'ASC' )
			                   ->get();
							   
			$allUpazilaData = DB::table('tbl_cib_upazila')
							->where('upa_status', 1)
							->orderBy( 'upa_name', 'ASC' )
							->get();
		...
		public function saveBranch_locations( Request $request )
		{
			...
			$allData = DB::table( 'branch_locations as bl' )					            
					   ->where( 'bl.branch_code', $allData[ 'branch_code' ] )
					   ->get();
			if(!empty($allData)){
			...
			if ( $request->hasFile( 'agreement_file' ) ) {
				$image2           = $request->file( 'agreement_file' );
				$name2           = $allData[ 'branch_code' ]."1-".time().'.'.$image2->getClientOriginalExtension();
				$destinationPath2 = public_path( '/images' );
				$image2->move( $destinationPath2, $name2 );
				$allData[ 'agreement_file' ] = 'public/images/'.$name2;
			}
		...
		public function showInformation()
		{
			...
			if($type==1){
				...
				$data = DB::table( 'branch_locations as bl' )
						 ...
						 ->leftJoin( 'tbl_area as a', 'b.area_code', '=', 'a.area_code' )
						 ->leftJoin( 'tbl_zone as z', 'b.zone_code', '=', 'z.zone_code' )
						 ->leftJoin( 'tbl_cib_district as cd', 'cd.dis_code', '=', 'bl.dis_code' )
						 ->leftJoin( 'tbl_cib_upazila as cu', 'cu.upa_code', '=', 'bl.upa_code' )
						 ->where( 'bl.branch_location_status', 1 )
						 ->where('b.branch_name', 'NOT LIKE', '%-%')
		...
		public function SelectUpazila($dis_code)
		{  
			$all_upazila = DB::table('tbl_cib_upazila')
							->select('*')
			...
			foreach($all_upazila as $row){
				echo "<option value='$row->upa_code'>$row->upa_name</option>";
			}
