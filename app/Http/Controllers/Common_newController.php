...
class Common_newController extends Controller
{
	...
	public function store_transection(Request $request)
	{
		...
		{
			$data = request()->except(['_token','sarok_no','action_table','salary_br_code','action_controller','transection_type','next_increment_date','is_permanent','grade_code_old']);
		}
		else
		{
			$data = request()->except(['_token','sarok_no','action_table','action_controller','transection_type','is_permanent','grade_code_old']);
		}
