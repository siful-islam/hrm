...
class IncrementController extends Controller
{
    ...
    {        	
		return view('admin.employee.manage_increment');			
    }
    ...
    {       
        ...
        {            
            $increments = Increment::join('tbl_appointment_info', 'tbl_increment.emp_id', '=', 'tbl_appointment_info.emp_id' )
							->offset($start)
							->limit($limit)
							//->orderBy($order,$dir)
            ...
            $totalFiltered = Increment::join('tbl_appointment_info', 'tbl_increment.emp_id', '=', 'tbl_appointment_info.emp_id' )
							->where('tbl_increment.emp_id', $search)
                            ->count();
        }
        ...
        if(!empty($increments))
        {
            ...
            foreach ($increments as $v_increments)
            {
                ...
                $nestedData['emp_name'] 	= $v_increments->emp_name;
