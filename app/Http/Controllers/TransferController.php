...
class TransferController extends Controller
{
    ...
    {       
        ...
        {            
            $transfers = Transfer::join('tbl_emp_basic_info', 'tbl_transfer.emp_id', '=', 'tbl_emp_basic_info.emp_id' )
							...
							->select('tbl_transfer.id','tbl_transfer.emp_id','tbl_transfer.sarok_no','tbl_transfer.letter_date','tbl_transfer.effect_date','tbl_transfer.status','tbl_emp_basic_info.emp_name_eng','tbl_designation.designation_name','tbl_branch.branch_name')
							->get();
        }
        else {
        ...
        if(!empty($transfers))
        {
            ...
            foreach ($transfers as $v_transfers)
            {
				...
				$nestedData['options'] 		= '<a class="btn btn-sm btn-danger btn-xs" title="Edit" href="transfer/'.$v_transfers->id.'/edit"><i class="glyphicon glyphicon-pencil"></i> View</a>';		
    ...
    public function edit($id)
    {
		...
		$data['salary_br_code'] 		= $transfer_info->salary_br_code;
