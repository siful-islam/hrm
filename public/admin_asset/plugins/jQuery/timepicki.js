	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='prevtime action-prevtime'></div>" :
				"<div class='prevtime action-nexttime'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='nexttime action-nexttime'></div>" :
				"<div class='nexttime action-prevtime'></div>";
			...
			function change_time(cur_ele, direction) {
				...
				} else if ((cur_ele && cur_ele.hasClass('action-prevtime')) || direction === 'prevtime') {
			...
			var cur_next = ele_next.find(".action-nexttime");
			var cur_prev = ele_next.find(".action-prevtime");
