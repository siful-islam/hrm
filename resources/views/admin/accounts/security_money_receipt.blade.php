			...
			<div class="box-body">
				...
				<div id="printme">
					...
					<div>
						...
						<table align="center">
							<tr>
								<td rowspan="3"><img src="{{asset(Session::get('org_logo'))}}" class="user-image" alt="Image" width="60"> </td>
						...
						<table width="100%" align="center">
							...
							<tr>
								...
								<td>Amount: </td>
								<td><span id="amount">{{$diposit_amount}}</span> Tk.</td>
							</tr>
							<tr>
