            ...
            <li>
			  ...
			  <?php
                ...
                <li>
				  @if(!empty($singleData))	
					  <a href="#">
					<img id="myImg" style = "max-height: 150px;min-height: 150px" class = "myImg img-thumbnail" src = "{{asset($singleData->branch_photo)}}" alt = "IMAGE"/><br></br><strong><span style="color:blue;">Branch Name: {{$branch->branch_name}}</span></strong></br><strong><span style="color:blue;">Branch Code: {{$branch->main_br_code}}</span></strong> </a>
				  @else
