				...
				<legend>Manual : </legend>
					...
					<table class="table table-bordered table-striped">
					  <thead>
						<tr class="active-row">
							<th>CDIP Manual</th>
							<td> <a target="_blank" href="http://hrm.microfineye.com/public/CDIP_Manual.pdf"><img src="{{asset('storage/office_order/pdf.png')}}" width="40" style="height:35px;" /> View</i></a></td>
						</tr>
					  </thead>
					  <tbody>
						<tr class="active-row">
							<th>Finance Manual</th>
							<td> <a target="_blank" href="http://hrm.microfineye.com/public/FinanceMannual.pdf"><img src="{{asset('storage/office_order/pdf.png')}}" width="40" style="height:35px;" /> View</i></a></td>
						</tr>
					  </tbody>
					</table>
			</fieldset>
					...
					<table  class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<a href="{{asset('storage/office_order/'.$order_file->file_name)}}" target="_blank"><img src="{{asset('storage/office_order/pdf.png')}}" width="40" style="height:35px;" /></a> 
								<?php } ?>
								  </td> 
							</tr> 
							<?php } ?>
