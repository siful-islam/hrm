...
<body>
    ...
    <br><br>
	<div>
        <a id="accept" href="{{ URL::to('/leave_mail_action' . '/' . $mail_data['application_id'] . '/' . $mail_data['sub_supervisors_emp_id'] . '/1' . '/2') }}"
            target="_blanck">Proceed</a>
        &nbsp;&nbsp;&nbsp;&nbsp; |
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a id="reject" href="{{ URL::to('/leave_mail_action' . '/' . $mail_data['application_id'] . '/' . $mail_data['sub_supervisors_emp_id'] . '/2' . '/2') }}"
