...
<body>
    ...
    <div>
        <a id="accept" href="{{ URL::to('/visit_mail_action' . '/' . $v_mail_data['move_id'] . '/' . $v_mail_data['supervisors_emp_id'] . '/1' . '/1') }}"
            target="_blanck">Approve</a>
        &nbsp;&nbsp;&nbsp;&nbsp; |
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a id="reject" href="{{ URL::to('/visit_mail_action' . '/' . $v_mail_data['move_id'] . '/' . $v_mail_data['supervisors_emp_id'] . '/2' . '/1') }}"
