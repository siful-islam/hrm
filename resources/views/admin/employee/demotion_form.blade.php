...
.required {
			...
			<!-- form start -->
				...
				<div class="box-body col-md-9">
					...
					<div class="form-group">
						...
						<label for="zone_code" class="col-sm-2 control-label">Demotion Type <span class="required">*</span> </label>
						<div class="col-sm-3">
							<select class="form-control" id="demotion_type" name="demotion_type" required>						
	...
	<script>
		$(document).ready(function() {
			...
			document.getElementById("demotion_type").value = '{{$demotion_type}}';
		})
		...
		function set_next_increment_date()
		{
			...
			document.getElementById("next_increment_date").value = dateFormated;
		}		
