...
.required {
			...
			<form id="form" class="form-horizontal" action="{{URL::to($action)}}" method="post" enctype="multipart/form-data">
				...
				<div class="box-body col-md-9">
					...
					<div class="form-group">
						...
						<label for="zone_code" class="col-sm-2 control-label">Increment Type <span class="required">*</span> </label>
						<div class="col-sm-3">
	...
	<script>
		$(document).ready(function() {
			...
			document.getElementById("increment_type").value = '{{$increment_type}}';
