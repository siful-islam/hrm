...
<?php $branch_code =  Session::get('branch_code');   ?>	
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Appointment Manager</h3>
							<a href="{{URL::to('/employee-appointment/create')}}" id="add_new" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Add New</a> 
					</div>
					<!-- /.box-header -->
					<div class="box-body">					
