				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Contractual Renew info</h3>
							<a href="{{URL::to('/contractual_renew/create')}}" id="add_new" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Add New</a>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
							...
							<?php 
								...
								foreach($results as $v_result){ ?>
									...
									<td>
										...
										<a class="btn btn-sm btn-success btn-xs" title="Edit" href="{{URL::to('contractual_renew/'.$v_result->id.'/edit')}}"><i class="glyphicon glyphicon-pencil"></i> Edit</a>&nbsp;&nbsp;&nbsp;
										<?php } ?>
									
									<a class="btn btn-sm btn-info btn-xs" title="view" href="{{URL::to('view_contract_renew_info/'.$v_result->id)}}"><i class="fa fa-eye"></i> View</a></td> 
									<?php }else{ ?> 
										<td> <a class="btn btn-sm btn-info btn-xs" title="view" href="{{URL::to('view_contract_renew_info/'.$v_result->id)}}"><i class="fa fa-eye"></i> View</a></td> 
									<?php } ?>
								</tr>
							<?php
								} 
