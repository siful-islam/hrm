...
@section('title', 'Contractual Cancel')
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Contractual Cancell</h3>
							<a href="{{URL::to('/non-cancel/create')}}" id="add_new" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Add New</a>
					</div>
					<!-- /.box-header -->
					<div class="box-body">	
						...
						<table id="table" class="table table-bordered table-hover" cellspacing="0" width="100%">
							...
							<tfoot>
								...
								foreach($results as $v_result){ ?>
									...
									<td><a class="btn btn-sm btn-success btn-xs" title="Edit" href="{{URL::to('non-cancel/'.$v_result->id.'/edit')}}"><i class="glyphicon glyphicon-pencil"></i> Edit</a></td>  
								</tr>
							<?php
							}
							?>
