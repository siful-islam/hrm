				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Contractual Cancell Branch</h3>
							<a href="{{URL::to('/non_id_cancel_br_create')}}" id="add_new" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Add New</a>
					</div>
					<!-- /.box-header -->
					<div class="box-body">	
						...
						<table id="table" class="table table-bordered table-hover" cellspacing="0" width="100%">
							...
							<tbody>
								...
								foreach($result as $v_result){ ?>
									...
									<td><a class="btn btn-sm btn-success btn-xs" title="Edit" href="{{URL::to('non_id_cancel_br_edit/'.$v_result->id)}}"><i class="glyphicon glyphicon-pencil"></i> Edit</a></td>  
								</tr>
							<?php
							}
							?>
