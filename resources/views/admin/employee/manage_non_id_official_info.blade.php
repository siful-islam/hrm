				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Contractual Official info</h3>
							<a href="{{URL::to('/con_official_info/create')}}" id="add_new" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Add New</a>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						...
						<table id="table" class="table table-bordered table-hover" cellspacing="0" width="100%">
							...
							<?php 
								...
								foreach($results as $v_result){ ?>
									...
									<td><a class="btn btn-sm btn-success btn-xs" title="Edit" href="{{URL::to('con_official_info/'.$v_result->id.'/edit')}}"><i class="glyphicon glyphicon-pencil"></i> Edit</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-sm btn-info btn-xs" title="view" href="{{URL::to('view_nonid_official_info/'.$v_result->id)}}"><i class="fa fa-eye"></i> View</a>&nbsp;&nbsp;
										<a class="btn btn-primary" onclick="return checkDelete();"  href="{{URL::to('/del_nonid_official_info/'.$v_result->id)}}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td> 
									<?php }else{ ?> 
										<td> <a class="btn btn-sm btn-info btn-xs" title="view" href="{{URL::to('view_nonid_official_info/'.$v_result->id)}}"><i class="fa fa-eye"></i> View</a>&nbsp;&nbsp;<a class="btn btn-primary" onclick="return checkDelete();"  href="{{URL::to('/del_nonid_official_info/'.$v_result->id)}}"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td> </td> 
									<?php } ?>
								</tr>
							<?php
								} 
