...
@section('main_content')
    ...
    <section class="content-header">
		<h1>Employee<small>Promotion</small></h1>
		<ol class="breadcrumb">
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Promotion List</h3>
							<a href="{{URL::to('/promotion/create')}}" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Add Promotion </a>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
