		...
		<div class="box box-info">
			...
			<!-- form start -->
				...
				<div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="vill_road" id="vill_road" value="{{$vill_road}}" class="form-control" required>
                        <span class="help-block"></span>
                    </div>
               </div>
			   <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="post_office" id="post_office" value="{{$post_office}}" class="form-control" required>
                        <span class="help-block"></span>
                    </div>
                </div>
			...
			<div class="form-group">	
				...
				<div class="col-md-6" id="contract_end_hide" style="display:block;">
                    ...
                    <div class="col-md-6">
                        <input type="date" name="c_end_date" readonly id="c_end_date" value="{{$c_end_date}}" class="form-control">
                        <span class="help-block">Till the Project is running &nbsp;&nbsp;&nbsp;<input type="checkbox" onclick="change_contract_end_type()" name="end_type" id="end_type" value="{{$end_type}}" checked ></span>
						 <span class="help-block"></span>
                    </div>
				</div>
			</div>
				<div class="box-header with-border"> 
					<h3 class="box-title" style="float:left;">Salary Information&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h3>
					 <span class="help-block">is Consolidated? &nbsp;&nbsp;&nbsp;<input type="checkbox" onclick="change_is_cosoleded()" name="is_Consolidated" id="is_Consolidated" value="{{$is_Consolidated}}" ></span>
				</div><br>
				<div class="form-group">	
				 <div class="col-md-6">	
