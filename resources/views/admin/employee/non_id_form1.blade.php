	...
	<section class="content">
		...
		<div class="box box-info">
			...
			<!-- form start -->
				...
				<div class="form-group">                   
					<label class="control-label col-md-2">Father Name: <span style="color:red;">*</span></label>
                    <div class="col-md-3">
                        <input type="text" name="father_name" id="father_name" value="{{$father_name}}" class="form-control" required placeholder="Father Name">
                        <span class="help-block"></span>
                    </div>
					<label class="control-label col-md-2">Mother Name : <span style="color:red;">*</span></label>
                    <div class="col-md-3">
				...
				<div class="form-group">                  
                    ...
                    <div class="col-md-3">
                        <input type="date" name="birth_date" id="birth_date" value="{{$birth_date}}" class="form-control" required>
                        <span class="help-block"></span>
                    </div>
				...
				<div class="form-group">
					...
					<label class="control-label col-md-2">Maritial Status: <span style="color:red;">*</span> </label>
                    <div class="col-md-3">
				...
				<div class="form-group">
                    <label class="control-label col-md-2">Joining Branch: <span style="color:red;">*</span> </label>
					<div class="col-md-3">
					...
					<label class="control-label col-md-2">Joining Date: <span style="color:red;">*</span> </label>
                    <div class="col-md-3">
                        <input type="date" name="joining_date" id="joining_date" value="{{$joining_date}}" onchange="set_renew_date();" required class="form-control">
                        <span class="help-block"></span>
                    </div>
                </div>
				...
				<div class="form-group">
                    <label class="control-label col-md-2">Last Education: <span style="color:red;">*</span> </label>
                    <div class="col-md-3">
				...
				<div class="form-group">
                    ...
                    <div class="col-md-3">
						<select class="form-control" name="emp_type" id="emp_type" onchange="myFunction();" required>
							...
							<option value="sacmo">CH</option>
							<option value="non_id">OT</option>
				...
				<div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="sacmo_id" id="sacmo_id" value="{{$sacmo_id}}" required class="form-control">
                        <span class="help-block"></span>
                    </div>
					<label class="control-label col-md-2">Br Join Date: <span style="color:red;">*</span> </label>
                    <div class="col-md-3">
                        <input type="date" name="br_join_date" id="br_join_date" value="{{$br_join_date}}" required class="form-control">
                        <span class="help-block"></span>
                    </div>
                </div>
				
				<div class="form-group">
                    <label class="control-label col-md-2">Next Renew Date: <span style="color:red;">*</span> </label>
                    <div class="col-md-3">
				...
				<div class="form-group">
                    <label class="control-label col-md-2">Village : <span style="color:red;">*</span> </label>
                    <div class="col-md-3">
                        <input type="text" name="vill_road" id="vill_road" value="{{$vill_road}}" class="form-control" required placeholder="Village">
                        <span class="help-block"></span>
                    </div>
					<label class="control-label col-md-2">Post Office : <span style="color:red;">*</span> </label>
                    <div class="col-md-3">
				...
				<div class="form-group">
					...
					<label class="control-label col-md-2">Thana : <span style="color:red;">*</span> </label>
                    @if(!empty($thana_code)) 
					<div class="col-md-3">
				...
				<div class="form-group">
                    <label class="control-label col-md-2">Permanenet Address : <span style="color:red;">*</span> </label>
                    <div class="col-md-3">
				...
				<div class="form-group">
                    <label class="control-label col-md-2" id="basic_level"><?php echo ($emp_type=='non_id') ? 'Consolidated Salary' : 'Basic Salary'; ?> : <span style="color:red;">*</span> </label>
                    <div class="col-md-3">
                        <input type="number" name="basic_salary" id="basic_salary" value="{{$basic_salary}}" onkeyup="calculate(this.value);" required class="form-control">
                        <span class="help-block"></span>
                    </div>
					<label class="control-label col-md-2" id="npa_level"><?php echo ($emp_type=='shs') ? 'Hardship' : 'NPA'; ?> : <span style="color:red;">*</span></label>
                    <div class="col-md-3">
                        <input type="number" name="npa_a" id="npa_a" value="{{$npa_a}}" required onkeyup="calculate(this.value);" class="form-control">
                        <span class="help-block"></span>
                    </div>
                </div>
				
				<div class="form-group">
                    <label class="control-label col-md-2" id="motor_level"><?php echo ($emp_type=='shs') ? 'Other' : 'Motor-Cycle / Convence'; ?> : <span style="color:red;">*</span></label>
                    <div class="col-md-3">
                        <input type="number" name="motor_a" id="motor_a" value="{{$motor_a}}" required onkeyup="calculate(this.value);" class="form-control">
                        <span class="help-block"></span>
                    </div>
					<label class="control-label col-md-2" id="mobile_level">Mobile Allowance: <span style="color:red;">*</span> </label>
                    <div class="col-md-3">
                        <input type="number" name="mobile_a" id="mobile_a" value="{{$mobile_a}}" required onkeyup="calculate(this.value);" class="form-control">
                        <span class="help-block"></span>
                    </div>
                </div>

				<div class="form-group">
                    <label class="control-label col-md-2" id="gross_level">Gross Salary: <span style="color:red;">*</span> </label>
                    <div class="col-md-3">
                        <input type="number" name="gross_salary" id="gross_salary" value="{{$gross_salary}}" required class="form-control">
                        <span class="help-block"></span>
                    </div>
