...
.required {
	...
	<section class="content-header">
		<h1>Employee <small>{{$Heading}}</small></h1>
		<ol class="breadcrumb">
		...
		<div class="box box-info">
			...
			<!-- form start -->
                ...
                {{ csrf_field() }}	
					...
					<input type="hidden" id="grade_code_old" name="grade_code_old" value="{{$grade_code_old}}">
				...
				<div class="box-body col-md-9">
					...
					<div class="form-group">
						<label for="zone_code" class="col-sm-2 control-label">Reported To <span class="required">*</span> </label>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="report_to" id="report_to" value="{{$report_to}}">
						</div>
						<label for="zone_code" class="col-sm-2 control-label">Promotion Type <span class="required">*</span> </label>
						<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="date" class="form-control" name="next_increment_date" id="next_increment_date" value="{{$next_increment_date}}">
						</div>						
				...
				<div class="col-md-3">
					...
					<div class="box-body box-profile">
						...
						<ul class="list-group list-group-unbordered">
							...
							<li class="list-group-item">
								<b>Joining Work Station : </b><span id="branch_name"> {{$branch_name}} </span>
							</li>
						</ul>
	...
	<script>
		$(document).ready(function() {
			...
			document.getElementById("grade_code_old").value = '{{$grade_code}}';
