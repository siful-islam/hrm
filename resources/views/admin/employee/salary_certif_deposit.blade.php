	...
	<section class="content">
		<div class="box box-info">
			<div class="box-header with-border">
				...
				<form class="form-horizontal" action="{{URL::to('salary_certicate_emo_info_depo')}}" method="post">
                {{ csrf_field() }}	
							...
							<div>		
								...
								<?php $tot_amount = 0; $tot_amount_non = 0; $i = 1;  ?>
									...
									<tr>
										...
										<td style="text-align:right;"> <?php $tot_amount += (double) $all_report['pf_balance']; echo taka_format(round($all_report['pf_balance']));?></td>
									</tr>
									 
									<tr>
										<td>2</td>
										<td>Death Compensation and Employee Welfare Fund</td>
										<td style="text-align:right;"> <?php $tot_amount += (double) $all_report['sdcf_balance']; echo taka_format(round($all_report['sdcf_balance'])); ?></td>
									</tr>  
									<tr>
										...
										<td style="text-align:right;"><b> <?php echo taka_format(round($tot_amount)); ?></b>
											...
											<script>
														document.getElementById("tot_deposit").innerHTML = '<?php echo taka_format(round($tot_amount));?>';
											</script>
										</td>
									</tr>
								</table> 
