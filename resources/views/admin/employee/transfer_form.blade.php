...
.required {
	...
	<section class="content">
		<div class="box box-info">
			...
			<!-- form start -->
				...
				<input type="hidden" id="next_increment_date" name="next_increment_date" value="{{$next_increment_date}}">				
				...
				<input type="hidden" id="grade_effect_date" name="grade_effect_date" value="{{$grade_effect_date}}">	
				<input type="hidden" id="effect_date" name="effect_date" value="{{$effect_date}}">	
				<input type="hidden" id="designation_code_old" name="designation_code_old" value="{{$designation_code}}">	
				...
				<div class="box-body col-md-7">					
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="date" class="form-control" name="br_joined_date" id="br_joined_date" value="{{$br_joined_date}}" onchange="set_date();">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<select class="form-control" style="width: 100%;" id="remarks" name="remarks">						
								<option value="" hidden>-SELECT-</option>
								@foreach ($transfer_remarks as $v_transfer_remarks)
								<option value="{{$v_transfer_remarks->id}}">{{$v_transfer_remarks->remarks_note}}</option>
								@endforeach
							</select>
						</div>
					</div>					
	...
	<script>
			...
			document.getElementById("grade_effect_date").value = '{{$grade_effect_date}}';
			document.getElementById("next_increment_date").value = '{{$next_increment_date}}';
			document.getElementById("effect_date").value = '{{$effect_date}}';
			...
			document.getElementById("designation_code_old").value = '{{$designation_code}}';
		...
		function get_transfer(val)
		{
			...
			//alert(emp_id);
			$.ajax({
				url : "{{ url::to('get-transfer-info') }}"+"/"+ emp_id +"/"+ val,
				type: "GET",
				success: function(data)
				{
					//alert(data);
