	...
	<section class="content">
		<div class="box box-info">
			...
			<!-- form start -->
				...
				<br>
				<br>
				<form class="form-horizontal" action="{{URL::to('/update_aprove_leave')}}" onsubmit="return change_with_pay();" role="form" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
				...
				<input type="hidden"  name="db_id" id="db_id" class="form-control" value="{{$db_id}}" readonly >
				<input type="hidden" name="pre_no_of_days" class="form-control" readonly value="{{$no_of_days}}" required>
				<input type="hidden" name="org_join_date" id="org_join_date"  class="form-control" value="{{$joining_date}}" readonly required>
									...
									<div class="col-md-5">
										<div class="form-group"> 
											<label class="control-label col-md-4">Employee Name </label>
												<div class="col-md-6">
													<input type="text" name="emp_name_eng" class="form-control" value="{{$emp_name}}" readonly required>
													<span class="help-block"></span>
												</div> 
										</div> 
									</div> 
									...
									<div class="col-md-5">
										<div class="form-group"> 
											<label class="control-label col-md-4">Designation</label>
												<div class="col-md-6">
													<input type="text" class="form-control" value="{{$designation_name}}" readonly required>
													<input type="hidden" name="designation_code"  class="form-control" value="{{$designation_code}}" readonly required>
													<span class="help-block"></span>
												</div> 
										</div> 
									</div> 
									<div class="col-md-5">
										<div class="form-group"> 
											<label class="control-label col-md-4">Working Station</label>
												<div class="col-md-6">
													<input type="text"   readonly  class="form-control" value="{{$branch_name}}" required>
													<input type="hidden" name="branch_code" readonly  class="form-control" value="{{$branch_code}}" required>
													<span class="help-block"></span>
												</div> 
										</div> 
									</div> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Application Date </label>
											<div class="col-md-6">
												<input type="text" name="application_date" id="application_date" onchange="calculate_earn_leave();"  class="form-control" value="{{$application_date}}" autocomplete="off"   required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Approved's From </label>
											<div class="col-md-6">
												<input type="text" autocomplete="off"  name="from_date" onchange="settotalday1();"  id="from_date" class="form-control" value="{{$from_date}}" required>
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Approved's To </label>
											<div class="col-md-6">
												<input type="text" autocomplete="off"  name="to_date"  id="to_date"  onchange="settotalday();"  class="form-control" value="{{$to_date}}" required>
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Total Leave Day/s</label>
											<div class="col-md-6">
												<input type="text" name="no_of_days" onkeyup="change_tot_leave()" id="no_of_days" class="form-control" value="{{$no_of_days}}" required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div>
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Remarks</label>
											<div class="col-md-6">
												 <input list="browsers" class="form-control"   name="remarks" value="{{$remarks}}" id="remarks">
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Cumulative Closing</label>
											<div class="col-md-6">
												<input type="text" name="pre_cumulative_close" id="pre_cumulative_close" class="form-control" readonly value="{{$cum_close_balance}}" required>
												<input type="hidden" name="cum_close_balance" id="cum_close_balance" class="form-control" readonly value="{{$cum_close_balance}}">
												<span class="help-block"></span>
											</div> 
									</div> 
								</div>
								 ...
								 <div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">FY Cummulative close</label>
											<div class="col-md-6">
												<input type="text"  id="cum_balance_less_close_12" name="cum_balance_less_close_12" class="form-control" readonly value="{{$cum_balance_less_close_12}}" required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
...
<script>
 function settotalday1(){
	...
	// var dataString = 'employee_id='+employee_id;
			$.ajax({
				type:'get',
				url : "{{URL::to('leave_date_exist_edit')}}"+"/"+from_date+"/"+to_date+"/"+emp_id+"/"+db_id,
...
if('{{$apply_for}}' != ''){
	document.getElementById("apply_for").value = "{{$apply_for}}"; 
}
 if('{{$type_id}}' != ''){
