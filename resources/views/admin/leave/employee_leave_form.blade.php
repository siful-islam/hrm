...
<section class="content">	
	<div class="row">			
		...
		<div id="wait" style="display:none;position:absolute;top:20%;left:45%;">
							<img src="{{asset('/loading.gif')}}" width="150" height="150" />
						</div>
			...
			<div id="html_display" class="box box-info">
					  ...
					  <div class="col-md-8">
						...
						<div class="form-group"> 
									...
									<label class="control-label col-md-3">Application Date </label>
										<div class="col-md-3">
											<input type="text" onchange="calculate_earn_leave()"  autocomplete="off"  name="application_date"  id="application_date" class="form-control" value="{{$application_date}}" required>
											<span class="help-block"></span>
									</div> 
						</div> 
						<div class="form-group"> 
					...
					<div class="form-group"> 
									<label class="control-label col-md-3">From </label>
										<div class="col-md-3">
											<input type="text" name="from_date"  autocomplete="off"  id="from_date" class="form-control" onchange="settotaldayfrom()" value="{{$from_date}}" required>
											<span class="help-block"></span>
										</div> 
							
									<label class="control-label col-md-3">To </label>
										<div class="col-md-3">
											<input type="text" autocomplete="off" name="to_date" id="to_date" class="form-control" onchange="settotalday()" value="{{$to_date}}" required>
											<span class="help-block"></span>
										</div> 
								</div> 
							<div class="form-group"> 
					...
					<div class="box-body box-profile">
						...
						<p class="text-muted text-center"><b>Org. Join Date:</b> <span id="org_join_date_view" ></span></p>
						 <ul class="list-group list-group-unbordered"><b>(Earn Leave)</b>
								...
								<li class="list-group-item"> 
								 Total Current Year Leave( Current ) <p id="this_year_open_balance" class="pull-right">@if(!empty($current_open_balance)){{$current_open_balance}} @else {{0}} @endif</p> 
								</li> 
								<li class="list-group-item">
  ...
  function get_emp_leave_info1(){
	...
	if(employee_id != ''){
		...
		//alert(f_year_start);
		  $.ajax({
			type: "GET",
			url : "{{URL::to('get_emp_leave_info')}}"+"/"+employee_id+"/"+f_year_start, 
			dataType: "JSON",
...
<script language="javascript">
 ...
 function settotalday1(){
	...
	// var dataString = 'employee_id='+employee_id;
		...
		$.ajax({
				type:'get',
				url : "{{URL::to('leave_date_exist_br')}}"+"/"+from_date+"/"+to_date+"/"+emp_id,
