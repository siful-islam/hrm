							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center"> 
									  <a class="btn btn-primary" title="view" href="{{URL::to('/recommend_leave_view/'.$emp_leave['id'].'/'.$emp_leave['emp_id'])}}"><i class="fa fa-file" aria-hidden="true"></i></a>
									</td>
									<td class="text-center">
									 
									<?php if($emp_leave['supervisor_type'] == 1){
											if($emp_leave['hrhd_action'] <= 1 || empty($emp_leave['hrhd_action'])){ ?>
												<a class="btn btn-primary" title="details" href="{{URL::to('/recommend_leave/'.$emp_leave['id'].'/'.$emp_leave['emp_id'])}}"><i class="glyphicon glyphicon-eye-open"></i></a>
									<?php		}
										}else{
