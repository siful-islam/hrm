									...
									<div class="form-group"> 
										<label class="control-label col-md-3">Visit Type</label>
											<div class="col-md-9">
												 ...
												 <input type="text" name="" id=""  class="form-control" value="{{$visit}}"   >
								...
								<div class="col-md-4">
									<div class="form-group"> 
										<label class="control-label col-md-3">Purpose </label>
											<div class="col-md-9">
												 <input type="text" name="purpose" id="purpose" class="form-control" value="{{$purpose}}" {{$mode}} required>
											</div> 
								...
								<div class="col-md-4">
									<div class="form-group"> 
										<label class="control-label col-md-3">Departure Date</label>
											<div class="col-md-9">
												<input type="text" name="from_date" id="from_date"  class="form-control" value="{{$travel_date}}" required >
											</div> 
									</div> 
								</div>  
								<div class="col-md-4">
									<div class="form-group"> 
										<label class="control-label col-md-3">Arrival Date</label>
											<div class="col-md-9">
												<input type="text" name="to_date" id="to_date"  class="form-control" value="{{$to_date}}" required>
											</div> 
									</div> 
								</div>
								<div class="col-md-4">
									<div class="form-group"> 
										<label class="control-label col-md-3">Day/s </label> 
											<div class="col-md-9">
												<input type="text" name="tot_day" id="tot_day"  class="form-control" value="{{$tot_day}}" {{$mode}} required> 
									...
									<table class="table table-bordered">
										...
										<tbody id="new_row">
											...
											<tr id="movement_row<?php echo $j;?>">
												<td>
													<input type="text" onchange="select_travel_amt(<?php echo $j;?>)"  name="movement[<?php echo $j;?>][travel_date]"   id="travel_date<?php echo $j;?>"  class="form-control {{$common_date}}" value="<?php echo $v_travel_details->travel_date;?>" required>
												...
												<td> 
													...
													<?php if($visit_type == 1){ ?>
														...
														@foreach($branch_list as $branch)
															<option value="{{$branch->br_code}}" <?php if($branch->br_code == $v_travel_details->source_br_code) echo "selected";?> >{{$branch->branch_name}}</option> 
														@endforeach
													<?php }else if($visit_type == 2){?>
												...
												<td> 
													...
													<?php if($visit_type == 1){ ?>
														...
														@foreach($branch_list as $branch)
															<option value="{{$branch->br_code}}" <?php if($branch->br_code == $v_travel_details->dest_br_code) echo "selected";?>>{{$branch->branch_name}}</option> 
														@endforeach 
														<?php }else if($visit_type == 2){ ?>
															 <option value="0">{{$destination_code}}</option>
														<?php }  ?> 
													</select> 
												</td> 
												<td>
									...
									<div class="form-group"> 
										<label class="control-label col-md-4"></label>
											<div class="col-md-6">
												...
												<a href="{{URL::to('movement_bill/')}}" class="btn btn-success" >&nbsp;&nbsp;list&nbsp;&nbsp;</a>
											</div> 
									</div> 
								</div>
							</div>  
