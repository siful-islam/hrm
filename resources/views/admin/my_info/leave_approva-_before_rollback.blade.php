...
@section('main_content')
						...
						<table border="1" id="list_approval" style="border">
							...
							<?php $duration = 0; if(count($my_stafs) >0) { foreach($my_stafs as $staf) { ?>
								...
								<tr>
									...
									<td align="center"><button type="button" class="btn btn-warning btn-xs" onclick="view(<?php echo $staf->application_id; ?>,<?php echo $staf->supervisor_type; ?>,<?php echo $staf->supervisor_id; ?>)"> View <i class="fa fa-comment" aria-hidden="true"></i></button>
									<a class="btn btn-info btn-xs" target="_blank" href="leave_report_profile/<?php echo $staf->emp_id; ?>"><i class="fa fa-file" aria-hidden="true"></i> Leave Report</a>
									</td>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<div class="table-responsive">
						<form class="form-inline report" id="leave_approval_report"  action="{{URL::to('/approval_report')}}" method="post">
							{{ csrf_field() }}
	...
	$("#leave_approval_report").submit(function(e) {
		...
		function save_approval()
		{
			...
			url = "{{URL::to('/leave-appliacation-approve')}}";
