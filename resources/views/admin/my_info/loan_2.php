                                    ...
                                    <div class="box-body box-profile">
                                        <ul class="list-group list-group-unbordered">
                                            <li class="list-group-item">
                                                <button type="button" class="btn btn-success btn-block" onclick="add_application();">  Application for Loan</button>
                                            </li>
                                            <li class="list-group-item">
                                                <button type="button" class="btn btn-default btn-block"><i class="fa fa-calculator" style="font-size:28px;color:rgb(8, 12, 245)"></i> <b>Loan Calculator</b></button>
                                            </li>
                                        </ul>
                                        <form class="form-horizontal">
                                            <input type="hidden" id="years" placeholder="Years">
                                            <div class="form-group">
                                                <label class="control-label col-sm-6" for="email">Loan Category:</label>
                                                <div class="col-sm-6">
                                                    <select id="loan_category" class="form-control"
                                                        onchange="set_interest();">
                                                        <option value="" hidden>-SELECT-</option>
                                                        <?php foreach ($loan_types as $loan_type) { ?>
                                                        <option
                                                            value="<?php echo $loan_type->interest_rate; ?>">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-6" for="email">Loan Amount:</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-6" for="email">Period in
                                                    Monthst:</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-6" for="email">Interest Rate:</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-6" for="email">EMI:</label>
                                                <div class="col-sm-6">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary btn-xs button view_button"
                                                    ...
                                                    data-id="{{ $loan->loan_id }}" data-loan_code="{{ $loan->loan_code }}"
                                    ...
                                    <tr>
                                        <td align="center"><b>
                                                <font size="4"> <img style="width: 40px"
                                                        src="{{ asset('public/org_logo/cdip.png') }}">
                        ...
                        <table style="margin-bottom: 10px" border="0" cellspacing="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <b>
                                            <font size="2">Print Date: {{ date('d-m-Y') }}</font>
                                        </b>
                                    </td>
                                </tr>
                            </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" method="POST" id="loan_form">
                    ...
                    <div class="form-group">
                        <label for="loan_amount" class="col-sm-4 control-label"> ঋণ নেয়ার কারন (বিবরন) </label>
                        <div class="col-sm-7">
					...
					<!--<div class="form-group">
                        <label for="loan_fixed_amount" class="col-sm-4 control-label">Select Account</label>
                        <div class="col-sm-7">
							<select class="form-control" id="" name="">
								<?php //foreach($my_bank_info as $bank_info){ ?>
								<option value="<?php //echo $bank_info->b_id;?>"><?php //echo $bank_info->my_account;?></option>
								<?php //} ?>
							</select>
                        </div>
                    </div>-->
    ...
    <script>	
        ...
        $(document).ready(function() {
            table_loan_application = $('#table_loan_application').DataTable({
                ...
                "ajax": {
                    "url": "{{ URL::to('/all_loan_application') }}",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
                        _token: "{{ csrf_token() }}"
		...
		<script>
			$(document).on("change", "#bank_id", function () {
				var bank_id = $(this).val();  
					$.ajax({
					url : "{{ url::to('banks_branch') }}"+"/"+bank_id,
					type: "GET",
					success: function(data)
					{
