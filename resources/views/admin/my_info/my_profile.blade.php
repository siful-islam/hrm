    ...
    <section class="content">
		...
		<div class="row"> 
				...
				<div class="col-md-3">
					<div class="box box-widget widget-user">
						...
						<div class="widget-user-image">
							...
							<?php if($emp_photo) { ?>
							<img class="profile-user-img img-responsive img-circle" src="{{asset('public/employee/'.$emp_photo)}}" height="50" alt="User profile picture"> 
							<?php } else { ?>
								<?php if($gender == 'Male') { ?>
								<img class="profile-user-img img-responsive img-circle" src="{{asset('public/avatars/no_photo_male.png')}}" alt="User profile picture">
								<?php } else{ ?>
								<img class="profile-user-img img-responsive img-circle" src="{{asset('public/avatars/no_photo_female.jpg')}}" alt="User profile picture">
								<?php } ?>
							<?php } ?>
						</div>
						<br>							
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<a href="{{ URL::to('/basic_info') }}">
					<div class="info-box">
						<span class="info-box-icon bg-cadetblue" id="cv"><img src="{{asset('public/profile/profile.png')}}" width="60%"></span>  
				...
				<div class="col-md-4 col-sm-6 col-xs-12"> 
					<a href="{{ URL::to('/pay_slips') }}">
					<div class="info-box">
						<span class="info-box-icon bg-maroon" id="pay"><img src="{{asset('public/profile/payslip.png')}}" width="60%"></span>
						<div class="info-box-content">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<a href="{{ URL::to('/my_documents') }}"> 
					<div class="info-box">
						<span class="info-box-icon bg-red" id="document"><img src="{{asset('public/profile/files.png')}}" width="60%"></span>
						<div class="info-box-content">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<a href="{{ URL::to('/leave_visit') }}">      
					<div class="info-box">
						<span class="info-box-icon bg-orange" id="leave"><img src="{{asset('public/profile/leave.png')}}" width="60%"></span>
						<div class="info-box-content">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<a href="{{ URL::to('/my_benefit') }}">      
					<div class="info-box">
						<span class="info-box-icon bg-black" id="money"><img src="{{asset('public/profile/my-benefits.png')}}" width="60%"></span>
						<div class="info-box-content">
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<a href="{{ URL::to('/my_loan') }}">      
					<div class="info-box">
						<span class="info-box-icon bg-blue" id="money"><img src="{{asset('public/profile/loan.png')}}" width="60%"></span>
						<div class="info-box-content">
							<span class="info-box-text"><h3>My Loan</h3></span>
							<span class="info-box-number"><small></small></span>
						</div>
					</div>
					</a>
				...
				<!--<div class="col-md-4 col-sm-6 col-xs-12">
					<a href="{{ URL::to('/attendence') }}">      
					<div class="info-box">
						<span class="info-box-icon bg-fray" id="money"><img src="{{asset('public/profile/finger.png')}}" width="60%"></span>
						<div class="info-box-content">
							<span class="info-box-text"><h3>My Attendance</h3></span>
							<span class="info-box-number"><small></small></span>
						</div>
					</div>
					</a>
