...
@section('title', 'Download Office Order')
							...
							<tbody>
								...
								<tr>
									...
									<?php if(!empty($order_file->file_name)){
										...
										?>
									<a href="{{asset('storage/office_order/'.$order_file->file_name)}}" target="_blank" download="{{$order_file->title}}.{{$ss[1]}}"><img src="{{asset('storage/office_order/pdf.png')}}" width="40" style="height:35px;" /></a> 
									<?php }else{ ?>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<?php } ?>
									...
									<?php if(!empty($order_file->word_file_name)){
										...
										?>
									 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{asset('storage/office_order/'.$order_file->word_file_name)}}" target="_blank" download="{{$order_file->title}}.{{$ss[1]}}"><img src="{{asset('storage/office_order/doc.png')}}" width="40" style="height:35px;" /></a> 
									<?php } ?>
									  </td> 
								</tr> 
								<?php } ?>
