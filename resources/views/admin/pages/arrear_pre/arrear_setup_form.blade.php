			...
			<div class="box box-info">
				<div class="box-body">	
					...
					<div class="form-group">	
						...
						<div class="col-sm-3">
							<input type="text" readonly class="form-control" name="emp_name" id="emp_name" value="{{$emp_name}}" required>						
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="date" class="form-control" onChange="set_date_range_from()" id="arrear_effect_date_from" name="arrear_effect_date_from" value="{{$arrear_effect_date_from}}" required>							
						</div>
					</div>
					<div class="form-group">	
						<label for="arrear_effect_date_to" class="col-sm-2 col-md-offset-1 control-label">To <span class="required">*</span></label>
						<div class="col-sm-3">
							<input type="date" class="form-control" onChange="set_date_range()" id="arrear_effect_date_to" name="arrear_effect_date_to" value="{{$arrear_effect_date_to}}" required>
						</div>
					</div>
					<div class="form-group">		
					...
					<div class="form-group">		
						...
						<div class="col-sm-3">
							<input type="text" autocomplete="off" class="form-control" id="arrear_amount" name="arrear_amount" value="{{$arrear_amount}}" required >
					...
					<div class="form-group">	
						...
						<div class="col-sm-3">
							<textarea class="form-control" id="comments" name="comments" value="">{{$comments}}</textarea>
						</div>
					</div>						
				</div>
				<!-- /.box-body -->
