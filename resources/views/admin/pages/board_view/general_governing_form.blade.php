				...
				<div class="box box-info">
					<div class="box-body">							
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="name_eng" id="name_eng" value="{{$name_eng}}" required autofocus class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Name (Bang)</label><span class="required">*</span>
							<div class="col-sm-6">
								<input type="text" name="name_ban" id="name_ban " value="{{$name_ban}}" required class="form-control">		
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Father's Name (Eng)</label><span class="required">*</span>
							<div class="col-sm-6">
								<input type="text" name="fathers_name_eng" id="fathers_name_eng" value="{{$fathers_name_eng}}" required class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Father's Name (Bang)</label><span class="required">*</span>
							<div class="col-sm-6">
								<input type="text" name="fathers_name_ban" id="fathers_name_ban" value="{{$fathers_name_ban}}" required class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Mother's Name (Eng)</label><span class="required">*</span>
							<div class="col-sm-6">
								<input type="text" name="mothers_name_eng" id="mothers_name_eng" value="{{$mothers_name_eng}}" required class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Mother's Name (Bang)</label><span class="required">*</span>
							<div class="col-sm-6">
								<input type="text" name="mothers_name_ban" id="mothers_name_ban" value="{{$mothers_name_ban}}" required class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Spouse Name (Eng)</label><span class="required">*</span>
							<div class="col-sm-6">
								<input type="text" name="spouse_name_eng" id="spouse_name_eng" value="{{$spouse_name_eng}}" required class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Spouse Name (Bang)</label><span class="required">*</span>
							<div class="col-sm-6">
								<input type="text" name="spouse_name_ban" id="spouse_name_ban" value="{{$spouse_name_ban}}" required class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Permanent Address</label>
							<div class="col-sm-6">
								<textarea name="permanent_address" id="permanent_add" class="form-control" >{{$permanent_address}}</textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<textarea name="present_address" id="present_add" class="form-control" >{{$present_address}}</textarea>
							</div>
						</div>						
						<div class="form-group">
							<label class="col-sm-4 control-label">Date of Birth</label><span class="required">*</span>
							<div class="col-sm-6">
								<input type="text" name="birth_date" id="birth_date" value="{{$birth_date}}" required class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">National ID</label><span class="required">*</span>
							<div class="col-sm-6">
								<input type="text" name="national_id" id="national_id" value="{{$national_id}}" required class="form-control">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="profession" value="{{$profession}}" required class="form-control">
							</div>
						</div>						
					</div>
					<!-- /.box-body -->
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="mobile_phone" id="mobile_phone" value="{{$mobile_phone}}" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">TIN No.</label>
							<div class="col-sm-6">
								<input type="text" name="tin_no" id="tin_no" value="{{$tin_no}}" class="form-control">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="effect_date" id="effect_date" value="{{$effect_date}}" class="form-control form_date">
							</div>
						</div>						
						<div class="form-group">
							<label class="col-sm-4 control-label"> AGM Serial No. </label>
							<div class="col-sm-6">
								<input type="text" name="agm_serial_no" id="agm_serial_no" value="{{$agm_serial_no}}" required class="form-control" placeholder="Only Number" onkeypress="return IsNumeric(event,'error1');" onpaste="return false;" ondrop = "return false;"><span id="error1" style="color: Red; display: none">Only Numbers</span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">AGM Date </label>
							<div class="col-sm-6">
								<input type="text" name="agm_date" id="agm_date" value="{{$agm_date}}" class="form-control form_date">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="relation_other_member" id="relation_other_member" value="{{$relation_other_member}}" required class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">Previous Experience Social Work</label><span class="required">*</span>
							<div class="col-sm-6">
								<input type="text" name="pre_exp_social_work" id="pre_exp_social_work" value="{{$pre_exp_social_work}}" required class="form-control">
							</div>
						</div>					
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="close_date" id="close_date" value="{{$close_date}}" class="form-control form_date">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="image-upload">
									<label for="file-input">
										<img id="blah" class="img-thumbnail" src="{{asset('public/board_member/'.$photo)}}" width="100"/> 
									</label>
					...
					<div class="box-footer">
						<a href="{{URL::to('/board-member')}}" class="btn bg-olive" type="button"><i class="icon-list" ></i> List</a>&nbsp;
