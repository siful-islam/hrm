						...
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="50%" style="border: 1px solid black; padding: 5px;">{{$result_info->name_ban}}</td>
								</tr>
								<tr>
									<td></td>
									<td width="20%" style="padding-right: 25px;">ইংরেজি :</td>
									<td width="70%" style="border: 1px solid black; padding: 5px;">{{$result_info->name_eng}}</td>
								</tr>	 
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="20%">বাংলা :</td>
									<td width="50%" style="border: 1px solid black; padding: 5px;">{{$result_info->fathers_name_ban}}</td>
								</tr>
								<tr>
									<td></td>
									<td width="20%" style="padding-right: 25px;">ইংরেজি :</td>
									<td width="70%" style="border: 1px solid black; padding: 5px;">{{$result_info->fathers_name_eng}}</td>
								</tr>	 
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="20%">বাংলা :</td>
									<td width="50%" style="border: 1px solid black; padding: 5px;">{{$result_info->mothers_name_ban}}</td>
								</tr>
								<tr>
									<td></td>
									<td width="20%" style="padding-right: 25px;">ইংরেজি :</td>
									<td width="70%" style="border: 1px solid black; padding: 5px;">{{$result_info->mothers_name_eng}}</td>
								</tr>	 
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="20%">বাংলা :</td>
									<td width="50%" style="border: 1px solid black; padding: 5px;">{{$result_info->spouse_name_ban}}</td>
								</tr>
								<tr>
									<td></td>
									<td width="20%" style="padding-right: 25px;">ইংরেজি :</td>
									<td width="70%" style="border: 1px solid black; padding: 5px;">{{$result_info->spouse_name_eng}}</td>
								</tr>	 
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="60%" style="border: 1px solid black; padding: 5px; margin-left: 20%;">{{$result_info->permanent_address}}</td>
								</tr>	 
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="60%" style="border: 1px solid black; padding: 5px; margin-left: 20%;">{{$result_info->present_address}}</td>
								</tr>	 
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="60%" style="border: 1px solid black; padding: 5px; margin-left: 20%;">{{$result_info->profession}}</td>
								</tr>
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="60%" style="border: 1px solid black; padding: 5px; margin-left: 20%;">{{$result_info->exam_name}}</td>
								</tr>
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="60%" style="border: 1px solid black; padding: 5px; margin-left: 20%;">{{$result_info->birth_date}}</td>
								</tr>
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="60%" style="border: 1px solid black; padding: 5px; margin-left: 20%;">{{$result_info->mobile_phone}}</td>
								</tr>
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="60%" style="border: 1px solid black; padding: 5px; margin-left: 20%;">{{$result_info->political_involve == 1 ? "Yes" : "No"}}</td>
								</tr>
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="60%" style="border: 1px solid black; padding: 5px; margin-left: 20%;">{{$result_info->relation_other_member}}</td>
								</tr>
							</tbody>
						</table>
						<br/>
						<table style="border-collapse: collapse; padding: 10px;" width="100%">
							<tbody>						
								<tr> 
									...
									<td width="60%" style="border: 1px solid black; padding: 5px; margin-left: 20%;">{{$result_info->pre_exp_social_work}}</td>
								</tr>
							</tbody>
						</table>					
						</div>					
