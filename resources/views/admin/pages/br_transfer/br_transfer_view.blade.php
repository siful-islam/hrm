					...
					<div class="box box-info">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">			
									<p class="form-control-static">: {{$area_name}}</p>
								</div>
							</div>
							<?php } ?>
							<div class="form-group">
								...
								<div class="col-sm-4">			
									<p class="form-control-static">: {{$branch_name}}</p>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<p class="form-control-static">: {{ucwords($tr_purpose)}}</p>
								</div>
							</div>
							<div class="form-group">
						...
						<div class="box-footer">
							...
							<a class="btn btn-primary" id="newform" onclick="approve({{$id}},{{$emp_id}})" >Approved</a>
							<?php } } ?>
						</div>
					</div>
				</div>
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">			
								<p class="form-control-static">: {{$area_manager_id}}</p>
							</div>
						</div>
						<div class="form-group">
...
function approve(id,emp_id)
	...
	$.ajax({
			url : "{{ url::to('approve_br_transfer') }}"+"/"+ id +"/"+emp_id,
			type: "GET",
			dataType: "JSON",
