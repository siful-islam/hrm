					...
					<div class="box box-info">
						<div class="box-body">							
							<div class="form-group{{ $errors->has('exam_name') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input type="text" name="exam_name" id="exam_name" value="{{$exam_name}}" required autofocus class="form-control">
						...
						<div class="box-footer">
							<a href="{{URL::to('/exam')}}" class="btn bg-olive" type="button"><i class="icon-list" ></i> List</a>&nbsp;
