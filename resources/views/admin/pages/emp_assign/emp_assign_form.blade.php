...
<section class="content">	
	<div class="row">			
		...
		<div class="col-md-12">
			...
			<div class="box box-info">
				<div class="box-body">							
					...
					<div class="form-group">		
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" id="incharge_as" name="incharge_as" value="{{$incharge_as}}" required>
						</div>
				...
				<div class="box-footer">
					<a href="{{URL::to('/emp-assign')}}" class="btn bg-olive" >List</a>
			...
			<?php if(!empty($id)){ ?>
			<form class="form-horizontal" action="{{URL::to('/emp-assign-close')}}" method="post" >
			{{ csrf_field() }}
			<div class="box box-info">
				<div class="box-body">
					<div class="form-group">		
...
$(document).ready(function() {
	...
	document.getElementById("branch_code").value="{{$br_code}}";
