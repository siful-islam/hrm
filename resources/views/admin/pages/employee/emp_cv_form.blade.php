					...
					<div class="box box-info">
						<div class="box-body">							
							...
							<div class="form-group{{ $errors->has('emp_name_ban') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input type="text" name="emp_name_ban" id="emp_name_ban" value="{{$emp_cv['emp_name_ban']}}" required class="form-control">
							...
							<div class="form-group{{ $errors->has('birth_date') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input type="text" name="birth_date" id="birth_date" value="{{$emp_cv['birth_date']}}" readonly required class="form-control">
							...
							<div class="form-group{{ $errors->has('nationality') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input type="text" name="nationality" id="nationality" value="{{$emp_cv['nationality']}}" class="form-control">
					...
					<div class="box box-info">
						<div class="box-body">
							<div class="form-group{{ $errors->has('contact_num') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input type="text" name="contact_num" id="contact_num" value="{{$emp_cv['contact_num']}}" class="form-control">
							...
							<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input type="text" name="email" id="email" value="{{$emp_cv['email']}}" class="form-control">
									@if ($errors->has('email'))
									<span class="help-block">
							...
							<div class="form-group{{ $errors->has('org_join_date') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<input type="date" name="org_join_date" id="start_date" value="{{$emp_cv['org_join_date']}}" required class="form-control">
							...
							<div class="form-group{{ $errors->has('permanent_add') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<textarea name="permanent_add" class="form-control" id="address" >{{$emp_cv['permanent_add']}}</textarea>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<select name="fun_desig_id" id="fun_desig_id" class="form-control" >
										<option value="">Select</option>								
										@foreach($all_functional_designation as $functional_designation)
										<option value="{{$functional_designation->id}}">{{$functional_designation->fun_deg_name}}</option>
										@endforeach
									</select>
								</div>
							</div>
								...
								<table id="training" class="table table-bordered">
									...
									<tbody id="training-row<?php echo $training_row; ?>">
									  <tr>
										...
										<td><input type="text" name="tra_val[<?php echo $training_row; ?>][tr_period_to]" value="{{$tra_val->train_period_to}}" class="form_date form-control" /></td>
								...
								<table id="reference" class="table table-bordered">
									...
									<tbody id="reference-row<?php echo $reference_row; ?>">
									  <tr>
										...
										<td><input type="text" name="refer_val[<?php echo $reference_row; ?>][email]" value="{{$refer_val->rf_email}}" size="16" class="form-control" /></td>
										<td><input type="text" name="refer_val[<?php echo $reference_row; ?>][nid]" value="{{$refer_val->rf_national_id}}" size="14" class="form-control" /></td>
										<td><input type="text" name="refer_val[<?php echo $reference_row; ?>][remarks]" value="{{$refer_val->rf_remarks}}" size="12" class="form-control" /></td>
								...
								<td style="width:20%;">  
									<div class="image-upload">
										...
										<label for="file-input">
											<img id="blah" class="img-thumbnail" src="{{asset('public/employee/'.$emp_photo_val->emp_photo)}}" width="100"/> 
										</label> 
										@else
										<label for="file-input">
											<img id="blah" class="img-thumbnail" src="{{asset('public/employee/placeholder.png')}}" width="100"/> 
										</label> 
										@endif
										<input type="hidden" name="emp_id" value="{{$emp_cv['emp_id']}}" >
								...
								<table id="neces_phone" class="table table-bordered">
									...
									<tbody id="neces_phone-row<?php echo $neces_phone_row; ?>">
									  <tr>
										...
										<td><input type="text" name="neces_phone_val[<?php echo $neces_phone_row; ?>][email]" value="{{$neces_phone_val->email}}" size="16" class="form-control" /></td>
										<td><input type="text" name="neces_phone_val[<?php echo $neces_phone_row; ?>][nid]" value="{{$neces_phone_val->national_id}}" size="14" class="form-control" /></td>
										<td><input type="text" name="neces_phone_val[<?php echo $neces_phone_row; ?>][remarks]" value="{{$neces_phone_val->remarks}}" size="12" class="form-control" /></td>
...
<script>
	...
	document.getElementById("fun_desig_id").value="{{$emp_cv['fun_desig_id']}}";
</script>
