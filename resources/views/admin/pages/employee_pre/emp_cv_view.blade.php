					...
					<form class="form-horizontal">
						...
						<div class="box-body">
							<div style="padding-left:2px;" class="col-md-8 col-xs-6">
								...
								<div class="form-group">
									<label class="col-sm-4">Employee Name (ENG)</label>
									<div class="col-sm-6">: {{$emp_cv_basic->emp_name_eng}}</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">Employee Name (Bang)</label>
							...
							<div class="col-md-4 col-xs-6">
								...
								@if($emp_cv_photo)
								<img style="height: 180px; width: 172px;" class="img-thumbnail" src="{{asset('storage/image/'.$emp_cv_photo->emp_photo)}}" />
								@else
								<img style="height: 180px; width: 172px;" class="img-thumbnail" src="{{asset('storage/image/placeholder.png')}}" /> 
								@endif
