				...
				<div class="box box-info">
					<div class="box-body">							
						<div class="form-group">
							...
							<div class="col-sm-3"><div class="form-control">{{$heldup_info->emp_id}}</div></div>
							<label class="col-sm-2 control-label">Letter Date</label>
							<div class="col-sm-3"><div class="form-control">{{$heldup_info->letter_date}}</div></div>
						</div>
						<hr>
						<div class="form-group">
							<label class="col-sm-2 control-label">Branch</label>
							<div class="col-sm-3"><div class="form-control">{{$heldup_info->branch_name}}</div></div>
							<label class="col-sm-2 control-label">Designation</label>
							<div class="col-sm-3"><div class="form-control">{{$heldup_info->designation_name}}</div></div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-3"><div class="form-control">{{$heldup_info->next_increment_date}}</div></div>
							<?php } else { ?>
							<label class="col-sm-2 control-label">HeldUp Until Date</label>
							<div class="col-sm-3"><div class="form-control">{{$heldup_info->heldup_until_date}}</div></div>
							<?php } ?>
							<label class="col-sm-2 control-label">Cause of HeldUp</label>
							<div class="col-sm-3"><div class="form-control">{{$heldup_info->heldup_cause}}</div></div>
						</div>						
					</div>
					<!-- /.box-body -->
					<div class="box-footer">
						<a href="{{URL::to('/heldup')}}" class="btn bg-olive" ><i class="fa fa-fw fa-long-arrow-left" ></i> Back-to-List</a>
					</div>
				   <!-- /.box-footer -->
				</div>
			</div>
