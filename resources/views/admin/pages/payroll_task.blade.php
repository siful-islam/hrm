	    ...
	    <div class="modal fade" id="modal_task">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<form action="{{URL::to('/save_task_hr')}}" method="post" class="form-horizontal" role="form" method="POST" id="new_form">
						<div class="modal-body">
							{{ csrf_field() }}
							<span id="post_method"></span>	 						
							<input type="hidden" class="form-control" value="{{ $assign_employee }}" name="hr_action_by" id="hr_action_by">
							<input type="hidden" class="form-control" value="{{ $assign_employee_name }}" name="hr_assign_employee_name" id="hr_assign_employee_name">
							<input type="hidden" class="form-control" name="month" id="month" value="{{$month}}">
							<input type="hidden" class="form-control" name="year" id="year" value="{{$year}}">
