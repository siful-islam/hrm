...
<section class="content">
	<div class="row">
		<div id="printme">
			...
			<div class="col-md-12">
			<form class="form-inline report" action="{{URL::to('/pms-assessment-detail')}}" method="post">
				{{ csrf_field() }}
				...
				<table id="tblExport" class="table table-bordered table-striped" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center"><a class="btn bg-olive btn-sm" title="View" href="{{URL::to('/pms-assessment-view/'.$result->empid.'/'.$assessment_year)}}"><i class="fa fa-eye"></i></a></td>
						</tr>
						@endforeach
					</tbody>
				</table>
