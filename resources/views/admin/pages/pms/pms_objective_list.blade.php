...
<section class="content">	
	<div class="row">
				...
				<tbody>
					...
					<tr>
						...
						<td style="text-align:center;"><a class="btn btn-primary btn-sm" id="Edit" title="Edit" onclick="edit(<?php echo $result->id.','.$i; ?>)" ><i class="fa fa-pencil"></i></a>
							<a class="btn btn-danger btn-sm" title="Delete" href="{{URL::to('/pms-delete/'.$result->id)}}" onclick="return checkDelete()"><i class="fa fa-times"></i></a></td>
						<?php } ?>
					</tr>
					<?php $i++; } ?>
					<tr>
		...
		<div class="col-md-12">
			<p style="float:right;margin-bottom: 10px;"><a href="{{URL::to('/pms-submit-supervisor/'.$emp_id)}}" class="btn btn-success pull-right" onclick="return checkSubmit()" ><i class="glyphicon glyphicon-plus" ></i> Submit to Supervisor</a></p>
		</div>
		<?php } else { ?>
		<div class="col-md-12">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
						<form method="post" action="{{URL::to('/pms-objective-save')}}" id="new_form" class="form-horizontal form-label-left">
						{{ csrf_field() }}
