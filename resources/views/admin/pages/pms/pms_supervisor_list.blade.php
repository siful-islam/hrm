...
<section class="content">	
	...
	<div class="row">
			...
			<table class="table table-bordered" cellspacing="0">
				<tbody>
					...
					<tr>
						...
						<td style="text-align:center;"><a href="{{ URL::to('/pms-view/'.$result->emp_id.'/2')}}" class="btn btn-primary btn-sm" id="View" title="View" >View</a></td>
					</tr>
					<?php } } else { ?>
					<tr>
						<td style="text-align:center;"><?php echo $i; ?></td>
		...
		<div class="col-md-12">
			<form class="form-inline report" action="{{URL::to('/pms-supervisor')}}" method="post">
				{{ csrf_field() }}
