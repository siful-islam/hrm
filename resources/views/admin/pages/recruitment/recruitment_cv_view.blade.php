					...
					<form class="form-horizontal">
						...
						<div class="box-body">
							<div style="padding-left:2px;" class="col-md-8 col-xs-6">
								<div class="form-group">
									...
									<div class="col-sm-6">: {{$recruitment_cv_basic->id}}</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">Name</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->full_name}}</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">Father Name</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->father_name}}</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">Mother Name</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->mother_name}}</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">Date of Birth</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->birth_date}}</div>
								</div> 
								<div class="form-group">
									<label class="col-sm-4">Religion</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->religion}}</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">Maritial Status</label>
									<div class="col-sm-6">:  {{$recruitment_cv_basic->maritial_status}} 
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">Nationality</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->nationality}}</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">National Id</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->national_id}}</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">Gender</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->gender}}
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">Contact Number</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->contact_num}}</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">Email</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->email}}</div>
								</div>  
								<div class="form-group">
									<label class="col-sm-4">Present Address</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->present_add}}</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4">Permanent Address</label>
									<div class="col-sm-6">: {{$recruitment_cv_basic->permanent_add}}</div>
								</div>
							</div> 
						</div>
						...
						<div class="box-body">
							<div class="table-responsive">
								<table class="table table-bordered">
									...
									<tbody>
										@foreach($recruitment_cv_edu as $emp_edu)
										<tr>
						...
						<div class="box-body">
							<table class="table table-bordered">
								...
								<tbody>
									@foreach($recruitment_cv_tra as $emp_tra)
									<tr>
						...
						<div class="box-body">
							<table class="table table-bordered">
								...
								<tbody>
									@foreach($recruitment_cv_exp as $emp_exp)
									<tr>
