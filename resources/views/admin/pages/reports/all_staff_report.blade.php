	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="{{URL::to('/all-staff-report')}}" method="post">
						{{ csrf_field() }}
			...
			<div class="col-md-12">
				<table id="tblExport" class="table table-bordered" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							<td>{{$i++}}</td>
							<td>{{$result['emp_name_eng']}}<?php if($result['tran_type_no'] == 14) { echo '<span style="color:#F70408"><b> (Demotion)</b></span> '; } ?></td>							
							<td>{{$result['emp_name_ban']}}</td>
