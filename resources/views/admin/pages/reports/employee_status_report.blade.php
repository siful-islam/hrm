	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="{{URL::to('/employee-status')}}" method="post">
						{{ csrf_field() }}
					...
					<div class="box box-info">
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-7">			
									<p class="form-control-static">: {{$all_result->emp_id}}
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<p class="form-control-static">: {{$all_result->fun_deg_name}}</p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label">Grade</label>
								<div class="col-sm-7">
									<p class="form-control-static">: {{$all_result->grade_name}}</p>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<p class="form-control-static">: {{date('d M Y',strtotime($permanent_date->effect_date))}}</p>
								</div>
							</div>
							<?php } ?>
							<?php if (!empty($permanent_date->effect_date)) { ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<p class="form-control-static">:
										<img style="height: 80px; width: 75px;" class="img-thumbnail" src="{{asset('public/employee/'.$all_result->emp_photo)}}" />
									</p>
								</div>
							</div>
						</div>
						...
						<div class="box-body">							
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									<p class="form-control-static">: {{$all_result->branch_name}} (Branch Code - {{$all_result->br_code}})</p>
									<?php } else { ?>
									<p class="form-control-static">: {{$assign_branch->branch_name}} (Branch Code - {{$all_result->br_code}})</p>
									<?php } ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									<p class="form-control-static">: {{$all_result->area_name}}</p>
									<?php } else { ?>
									<p class="form-control-static">: {{$assign_branch->area_name}}</p>
									<?php } ?>
								</div>
							</div>
							<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									<p class="form-control-static">: {{$all_result->zone_name}}</p>
									<?php } else { ?>
									<p class="form-control-static">: {{$assign_branch->zone_name}}</p>
									<?php } ?>
								</div>
							</div>
							<?php } ?>														
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<p class="form-control-static">: {{$all_result->permanent_add}}</p>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<p class="form-control-static">: {{$all_result->contact_num}}</p>
								</div>
							</div>
							<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<p class="form-control-static">: <span style="color:#F70408"><?php echo date('d-m-Y',strtotime($all_result->re_effect_date)); ?> ({{$all_result->resignation_by}})</span></p>
								</div>
							</div>
							<?php } ?>
							<div class="form-group">
					...
					<div class="box box-info">
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-7">			
									<p class="form-control-static">: {{$nonid_emp_status->sacmo_id}}</p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label">Employee Name </label>
								<div class="col-sm-7">
									<p class="form-control-static">: {{$nonid_emp_status->emp_name}}</p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label">Designation </label>
								<div class="col-sm-7">
									<p class="form-control-static">: {{$nonid_emp_status->designation_name}}</p>
								</div>
							</div>
							<div class="form-group">
					...
					<div class="box box-info">
						<div class="box-body">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">Permanent Address </label>
								<div class="col-sm-7">
									<p class="form-control-static">: {{$nonid_emp_status->permanent_add}}</p>
								</div>
							</div>
							<?php if($user_type == 1 || $user_type == 2) { ?>
							<div class="form-group">
								...
								<div class="col-sm-7">
									<p class="form-control-static">: {{$nonid_emp_status->gross_salary}}</p>
								</div>
							</div>
							<?php } ?>
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">Resignation Effect Date </label>
								<div class="col-sm-7">
									<p class="form-control-static">: <span style="color:#F70408"><?php echo date('d-m-Y',strtotime($nonid_emp_status->cancel_date)); ?> ({{$nonid_emp_status->cancel_by}})</span></p>
								</div>
							</div>
							<?php } ?>
							<div class="form-group">
