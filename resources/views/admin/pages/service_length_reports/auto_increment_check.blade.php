...
@section('title', 'Auto Increment Check')
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="{{URL::to('/increment-staff-check')}}" method="post">
						{{ csrf_field() }}
						<div class="form-group">
						  <label for="pwd">Effect Date:</label>
						  <input type="text" id="effect_date" class="form-control" name="effect_date" size="10" value="{{$effect_date}}" required>
						</div>						
