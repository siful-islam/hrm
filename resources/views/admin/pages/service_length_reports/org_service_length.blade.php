...
@section('title', 'Organization Service Length Report')
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="{{URL::to('/org-service-length')}}" method="post">
						{{ csrf_field() }}
						...
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" name="year_as" size="6" value="{{$year_as}}" />
						</div>					
		...
		<div id="printme">		
			...
			<div class="col-md-12">
				...
				<table class="table table-bordered" cellspacing="0">
					...
					<tbody>
						<tr>
							<td>{{$i}}<?php if($result['tran_type_no'] == 14) { echo '<span style="color:#F70408"><b> (Demotion)</b></span> '; } ?></td>
