			  ...
			  <div class="pull-right" id="hide_pending_branch">
						...
						$vc_of_m=0;$vc_of_f=0;$vc_ft_f=0;$vc_ft_m=0;$enrich_m=0;$enrich_f=0;$es_enrich_f=0;$es_enrich_m=0;
							 ...
							 foreach($designation_count as $v_designation_count){
								if($v_designation_count['project_id'] == 1){
									...
									$teacher['microfinance'][] = $v_designation_count['emp_id'];
									...
									//echo $v_designation_count['emp_id'];	
									...
									if($v_designation_count['pomis_designation_group'] == 21){
										if($v_designation_count['gender'] == 'Male'){ 
											$sc_of_m++;
											//echo $v_designation_count['emp_id'].'</br>';
										}else{
											$sc_of_f++;
										}
										/* echo "<br>";
				...
				<table id="tblExport" class="table table-bordered" cellspacing="0">
					...
					<tbody>
						...
						<!--tr > 
							<td style="vertical-align:middle;" id="micro_bold_bottom"  rowspan="2">Microfinance Program</td>
						...
						<tr>
							<td style="vertical-align:middle;" rowspan="12">Special Program</td>
...
<script>
    function printDiv(divID) {
		...
		setTimeout(function () { $("#hide_pending_branch").show(); $("#hide_printdate").hide(); }, 1);
    }
