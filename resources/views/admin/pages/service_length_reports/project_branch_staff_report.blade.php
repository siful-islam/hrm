...
<section class="content">
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="{{URL::to('/project_branch_staff')}}" method="post">
						{{ csrf_field() }}
	...
	<div class="row">
		<div id="printme">
			...
			<form action="{{URL::to('/project-staff-save')}}" id="new_form" method="post" class="form-horizontal">	
			{{ csrf_field() }}
			<div class="col-md-12">
