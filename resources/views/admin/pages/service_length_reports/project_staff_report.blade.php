...
@section('title', 'Reports|Branch Staff Report')
...
<section class="content">
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="{{URL::to('/project-branch-staff')}}" method="post">
						{{ csrf_field() }}
						<div class="form-group">
							...
							<select class="form-control" id="br_code" name="br_code" required>						
								...
								<option value="{{$v_branches->main_br_code}}">{{$v_branches->branch_name}}</option>
								@endforeach
							</select>
						</div>
						<div class="form-group">
	...
	<div class="row">
		<div id="printme">
			...
			<form action="{{URL::to('/project-staff-save')}}" method="post" class="form-horizontal">	
			{{ csrf_field() }}
			<div class="col-md-12">
