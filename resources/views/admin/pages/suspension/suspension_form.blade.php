			...
			<div class="box box-info">
				<div class="box-body">	
					...
					<div class="form-group" >
						...
						<div class="col-sm-3">
							<input type="text" autocomplete="off" class="form-control" id="emp_id" name="emp_id" value="{{$emp_id}}" onChange="get_employee_info();" required>
						</div>
					</div>
					<div class="form-group">	
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="date" class="form-control" onChange="set_date_range_from()" id="from_date" name="from_date" value="{{$from_date}}" required>							
						</div>
					</div>
					<div class="form-group">	
						<label for="to_date" class="col-sm-2 col-md-offset-1 control-label">To <span class="required">*</span></label>
						<div class="col-sm-3">
							<input type="date" class="form-control" onChange="set_date_range()" id="to_date" name="to_date" value="{{$to_date}}" required>
						</div>
					</div>
					<div class="form-group">		
						<label for="total_days" class="col-sm-2 col-md-offset-1 control-label">Days<span class="required">*</span></label>
						<div class="col-sm-3">
							<input type="text" readonly class="form-control" id="total_days" name="total_days" value="{{$total_days}}" required>
				...
				<div class="box-footer">
					<a href="{{URL::to('/suspension')}}" class="btn bg-olive" >List</a>
...
<script type="text/javascript">		
	function get_employee_info() {
		...
		//alert (emp_id);
		$.ajax({
			url : "{{ url::to('get_emp_info_sus') }}"+"/"+ emp_id,
			type: "GET",
			dataType: "JSON",
