...
@section('title', 'Demotion Staff Report')
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="{{URL::to('/demotion-report')}}" method="post">
						{{ csrf_field() }}
				...
				<table class="table table-bordered" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{$result->demotion_type}}</td>
							<td><a href="{{URL::to('/grade-history/'.$result->emp_id)}}" target="_blank" class="btn btn-primary" type="button"> Details</a></td>
						</tr>
						@endforeach
					</tbody>
				</table>
