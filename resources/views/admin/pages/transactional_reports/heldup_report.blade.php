...
@section('title', 'HeldUp Staff Report')
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="{{URL::to('/heldup-report')}}" method="post">
						{{ csrf_field() }}
				...
				<table class="table table-bordered" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{$result['what_heldup']}}</td>
							<td>{{$result['heldup_cause']}}</td>
							<td>{{$result['heldup_time'].' Months'}}</td>
							<td>{{$result['heldup_until_date']}}</td>
