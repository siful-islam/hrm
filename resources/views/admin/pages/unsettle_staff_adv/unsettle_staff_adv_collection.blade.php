				...
				<div class="box box-info">
					<div class="box-body">							
						<div class="form-group">
							...
							<div class="col-sm-2">
								<p class="form-control-static">: {{$result_info->emp_id}}</p>
							</div>
							<label class="col-sm-2 control-label">Entry Date </label>
							<div class="col-sm-2">
								<p class="form-control-static">: {{date('d-m-Y', strtotime($result_info->entry_date))}}</p>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-2">
								<p class="form-control-static">: {{$result_info->designation_name}}</p>
							</div>
							<label class="col-sm-2 control-label">Branch </label>
							<div class="col-sm-2">
								<p class="form-control-static">: {{$result_info->branch_name}}</p>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-2">
								<p class="form-control-static">: {{date('d-m-Y', strtotime($result_info->claim_date))}}</p>
							</div>
							<label class="col-sm-2 control-label">Claim Branch </label>
							<div class="col-sm-2">
								<p class="form-control-static">: {{$result_info->claim_branch_name}}</p>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">Total Amount </label>
							<div class="col-sm-2">
								<p class="form-control-static">: {{$result_info->total_amount}}</p>
							</div>
							<label class="col-sm-2 control-label">Rest of Amount </label>
							<div class="col-sm-2">
								<p class="form-control-static">: {{$result_info->rest_of_amt}}</p>
							</div>
							<label class="col-sm-2 control-label">Comments</label>
							<div class="col-sm-2">
								<p class="form-control-static">: {{$result_info->comments}}</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="hidden" name="us_staff_ad_id" value="{{$result_info->id}}" class="form-control">
								<input type="hidden" name="emp_id" value="{{$result_info->emp_id}}" class="form-control">
								<input type="hidden" name="total_amount" value="{{$result_info->total_amount}}" class="form-control">
								<input type="text" name="collection_amt" value="" class="form-control" required>
							</div>
							<label class="col-sm-2 control-label">Collection Date <span class="required">*</span></label>
							<div class="col-sm-2">
								<input type="text" name="tran_date" value="" class="form-control month_year" required>
							</div>
							<label class="col-sm-2 control-label">Comments</label>
							<div class="col-sm-2">
