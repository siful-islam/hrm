...
<section class="content">
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="{{URL::to('/unsettle-staff-adv')}}" method="post">
						{{ csrf_field() }}
						...
						<div class="form-group">
						  ...
						  <input type="text" id="entry_date" class="form-control entry_date" name="entry_date" size="10" value="{{$entry_date}}" required>
						</div>						
				...
				<div class="box box-info" style="margin-bottom:10px;">
					<div class="box-body">							
						<div class="form-group">
							...
							<div class="col-sm-1">
								<p class="form-control-static"> <a href="{{URL::to('/unsettle-statement/'.$emp_id)}}" target="_blank">Details</a></p>
							</div>
						</div>						
					</div>
				</div>
	...
	<div class="row">
		<div class="col-md-12">
			<form class="form-horizontal" action="{{URL::to('/unsettle-staff-adv')}}" method="post" >
			{{ csrf_field() }}
			<div class="box box-info">
				<div class="box-body">							
					<div class="form-group">
	...
	<!--<div class="modal fade bd-example-modal-sm" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog modal-sm" role="document">
		...
		<form method="post" action="{{URL::to('/unsettle-add-claim')}}">
		  {{ csrf_field() }}
