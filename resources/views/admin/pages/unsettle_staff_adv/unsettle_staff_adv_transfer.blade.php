						...
						<div class="col-md-12 table-responsive">
							<table id="transfer" class="table table-bordered">
								<thead>
								  <tr>
									...
									<td>
										...
										<input type="hidden" name="transfer_from_emp_id" value="{{$result_info->emp_id}}" class="form-control">
										<input type="hidden" name="claim_description" value="{{$result_info->claim_description}}" class="form-control">
										<input type="hidden" name="claim_date" value="{{$result_info->claim_date}}" class="form-control">
										<input type="hidden" name="claim_branch" value="{{$result_info->claim_branch}}" class="form-control">
								...
								<tbody id="transfer-row<?php echo $transfer_row; ?>">
								  <tr>
									<td>
										<input type="text" name="transfer[<?php echo $transfer_row; ?>][emp_id]" value="{{$transfer->emp_id}}" required class="form-control" onChange="get_employee_info(this.value,{{$transfer_row}});" size="8">
									</td>
									<td>
										<input type="text" value="{{$transfer->emp_name_eng}}" style="width:180px;" class="form-control" />
									</td>
									<td>
									...
									<td>
										<input type="text" name="credit_amt" value="" class="form-control">
									</td>
									<td>
										<input type="text" name="credit_amt" value="" class="form-control">
									</td>
