			  ...
			  <ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu">
				  ...
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
				   ...
				   <img src="{{asset(Session::get('admin_photo'))}}" class="user-image" width="30" alt="User Image">
		...
		<section class="content">
			<div class="box">
				<div class="box-header with-border">
					<form class="form-inline report" action="{{URL::to('/generate_payroll')}}" method="post">
						{{ csrf_field() }}
