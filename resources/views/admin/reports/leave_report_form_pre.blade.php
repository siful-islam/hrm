					 ...
					 <?php if(!empty($fiscal_year)){ ?>	
											...
											<tbody>
											   ...
											   $sl = 1;   
												...
												<tr style="text-align:center;">                                    
												  ...
												  <td style="width:8%;border:1px solid black;"><?php echo $pre_previous->no_of_days_appr; if($pre_previous->apply_for == 2){ echo " (Morning)"; }else if($pre_previous->apply_for == 3){ echo " (Evening)"; } ?></td>
						...
						<div style="width:95%;margin:auto;" >
							<table  style="width:100%;">
								<thead>
									<tr>
										<th colspan="3" style="width:100%;text-align:left;"><span style="background-color:#ADD8E6;" class="with_pay_color" >Current</span></th> 
