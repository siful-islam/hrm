...
@section('title','Diary or Calendar')
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						...
						<a href="{{URL::to('/requisition_update')}}" id="add_new" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Update</a>
						<?php }else{ ?>
							<a href="{{URL::to('/requisition_create')}}" id="add_new" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Add New</a>
						<?php } ?>
