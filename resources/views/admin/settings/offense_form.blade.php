			...
			<!-- form start -->				
				...
				<div class="box-body">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="crime_subject" name="crime_subject" value="{{$crime_subject}}" required>
						</div>
					</div>
					<div class="form-group">
						<label for="org_full_name" class="col-sm-2 control-label">Details</label>
						<div class="col-sm-4">
							<textarea class="form-control" id="crime_detail" name="crime_detail" required>{{$crime_detail}}</textarea>
						</div>
					</div>
					<div class="form-group">
						<label for="org_full_name" class="col-sm-2 control-label">Punishment</label>
						<div class="col-sm-4">
							<textarea class="form-control" id="punishment" name="punishment" required>{{$punishment}}</textarea>
						</div>
					</div>
