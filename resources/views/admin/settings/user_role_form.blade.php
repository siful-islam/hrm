					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<?php foreach($data['user_role'] as $user_role) { ?>
								<input type="checkbox" value="<?php echo $user_role->role_id; ?>" name="user_access[]" <?php if(in_array($user_role->role_id, $data['user_access'])) {echo 'checked';} ?>><?php echo $user_role->admin_role_name;?>
							<?php } ?>
						</div>
					</div>
					<div class="form-group">
