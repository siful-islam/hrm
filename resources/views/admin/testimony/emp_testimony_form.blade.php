...
@section('main_content')
	...
	<section class="content">
		<div class="box box-info">
			...
			<!-- /.box-header -->
			<!-- form start -->
				<form   action="{{URL::to('/emp_info_testimony')}}" method="post" enctype="multipart/form-data" id="form1">
					  {{csrf_field()}}  
					<div class="row">   
						<div class="col-md-3">
			...
			<?php if(!empty($employee_his)){?>
				<br>
				<br>
				<form class="form-horizontal" onsubmit="return is_check_resign();" action="{{URL::to('/insert_emp_testimony')}}" role="form" method="POST" enctype="multipart/form-data">
                {{csrf_field()}} 
						<div class="box-body"> 
									...
									<div class="col-md-11 col-md-offset-1">
										<div class="form-group"> 
												...
												<input type="submit" id="submit_btn" class="btn btn-primary" value="{{$button}}">
													<a href="{{URL::to('/testimony')}}" class="btn btn-success" >&nbsp;&nbsp;list&nbsp;&nbsp;</a>
													</span>
												</div>  
										</div> 
									</div> 
...
function is_check_resign(){  
	...
	if(designation_code == ""){
		...
		$.ajax({
				type:'get',
				url : "{{URL::to('duplicate_certificate_check')}}"+"/"+emp_id,
				async: false,
