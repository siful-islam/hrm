						...
						<div class="form-group"> 
							...
							<div class="pull-right"> 
							 <input type="checkbox" name="is_pad" onclick="check_is_pad()" id="is_pad" value="1"> Use Pad ? &nbsp;&nbsp;&nbsp;
								<button type="button" id="print_click" onclick="javascript:printDiv('printme')" class="btn btn-default"><i class="fa fa-print" aria-hidden="true"></i> Print</button>
							</div>
						</div>
			</div> 
				...
				<div id="printme"  class="box box-danger" style="width:90%;margin:auto;">
					<div class="box-header with-border">
						<table align="center" width="80%" border="0" id="with_header">
									<tr>
										<td align="left"><img src="{{asset('public/pic-1.PNG')}}" width="100" ></td> 
										<td align="center"><img src="{{asset(Session::get('org_logo'))}}" width="75" ></td>
										<td align="right"><img src="{{asset('public/pic-3.PNG')}}" width="100" ></td>
									</tr>
								</table>
							<span  id="hr_id" >
...
function check_is_pad(){
	...
	if(is_pad){ 
			 ...
			 $("#with_header").html("<table align='center' width='80%' border='0' id='with_header'><tr><td align='left'><img src='{{asset('public/pic-1.PNG')}}' width='100'></td><td align='center'><img src='{{asset(Session::get('org_logo'))}}' width='75'></td><td align='right'><img src='{{asset('public/pic-3.PNG')}}' width='100' ></td></tr></table>");
...
function printDiv(divID) {
    ...
    newWin.print();
    newWin.close(window.location.href = "{{URL::to('certi_general')}}"); 
   } 
