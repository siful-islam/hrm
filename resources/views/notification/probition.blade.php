...
<body>
    ...
    <b>Dear Concern,</b>
	<br><br />
	This is for your kind information, <b>{{$mail_data['emp_name'] }}</b> has joined CDIP on {{date('d-m-Y',strtotime($mail_data['org_join_date']))}}. @if($mail_data['gender']=='Male')He @else She @endif will complete @if($mail_data['gender']=='Male')his @else her @endif 3 months on {{date('d-m-Y',strtotime($mail_data['three_month_date']))}}. Please take necessary step.
	<br><br>
