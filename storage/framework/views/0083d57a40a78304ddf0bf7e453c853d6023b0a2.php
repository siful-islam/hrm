	...
	<div class="row">			
		...
		<div class="tab-content">
			<div class="tab-pane <?php if ($recruit_data['tab_id'] == 1) echo 'active';?>" id="tab_general">
				<form action="<?php echo e(URL::to($recruit_data['action'])); ?>" method="post"  onsubmit="return calculate_age()" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="col-md-6">
					...
					<div class="box box-info">
						...
						<input type="hidden"   id="end_date" value="<?php echo e($recruit_data['end_date']); ?>"   class="form-control">
						<input type="hidden"   id="normal_age" value="<?php echo e($recruit_data['normal_age']); ?>"   class="form-control">
						<input type="hidden"   id="experience_age" value="<?php echo e($recruit_data['experience_age']); ?>"   class="form-control">
						<input type="hidden"   name="new_recruitment_id" value="<?php echo e($recruit_data['new_recruitment_id']); ?>"   class="form-control">
							...
							<div class="form-group<?php echo e($errors->has('full_name') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="full_name" id="full_name " value="<?php echo e($recruit_data['full_name']); ?>" required class="form-control">
							...
							<div class="form-group<?php echo e($errors->has('father_name') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="father_name" id="father_name" value="<?php echo e($recruit_data['father_name']); ?>" required class="form-control">
							...
							<div class="form-group<?php echo e($errors->has('mother_name') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="mother_name" id="mother_name" value="<?php echo e($recruit_data['mother_name']); ?>"  class="form-control">
							...
							<div class="form-group<?php echo e($errors->has('birth_date') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="birth_date" id="birth_date" onchange="change_disabled_mode();" value="<?php echo e($recruit_data['birth_date']); ?>" required class="form-control">
							...
							<div class="form-group<?php echo e($errors->has('nationality') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="nationality" id="nationality" value="<?php echo e($recruit_data['nationality']); ?>"  class="form-control">
							...
							<div class="form-group<?php echo e($errors->has('national_id') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="national_id" id="national_id" value="<?php echo e($recruit_data['national_id']); ?>"  class="form-control">
							...
							<div class="form-group<?php echo e($errors->has('contact_num') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="contact_num" id="contact_num" value="<?php echo e($recruit_data['contact_num']); ?>" required class="form-control">
					...
					<div class="box box-info">
						<div class="box-body">							
								...
								<div class="col-sm-6"> 
									<select name="post_id" id="post_id" onchange="select_circular_date()" required class="form-control"  >
										...
										<?php $__currentLoopData = $all_post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
											<?php if($recruit_data['post_id'] == $post->id): ?>
											  <option value="<?php echo e($post->id); ?>" selected ><?php echo e($post->post_name); ?></option> 
										    <?php else: ?> 
											  <option value="<?php echo e($post->id); ?>"><?php echo e($post->post_name); ?></option> 	
										    <?php endif; ?>
							...
							<div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="email" id="email" value="<?php echo e($recruit_data['email']); ?>" class="form-control">
							...
							<div class="form-group<?php echo e($errors->has('vill_road') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="vill_road" id="vill_road" value="<?php echo e($recruit_data['vill_road']); ?>" class="form-control">
							...
							<div class="form-group<?php echo e($errors->has('post_office') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="post_office" id="post_office" value="<?php echo e($recruit_data['post_office']); ?>"  class="form-control">
							...
							<div class="form-group<?php echo e($errors->has('thana_code') ? ' has-error' : ''); ?>">
								...
								<?php if(!empty($recruit_data['thana_code'])): ?>
								<div class="col-sm-6">
									<select name="thana_code" id="upazila_id" readonly required class="form-control" style="pointer-events: none;">
										...
										<?php if($thana->thana_code == $recruit_data['thana_code']): ?>
							...
							<div class="form-group<?php echo e($errors->has('permanent_add') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<textarea name="permanent_add" class="form-control" id="address" onclick='LoadAddress()'><?php echo e($recruit_data['permanent_add']); ?></textarea>
							...
							<div class="form-group<?php echo e($errors->has('present_add') ? ' has-error' : ''); ?>">
								<label for="present_add" class="col-sm-4 control-label">Present Address <br> <span style ="font-weight:normal;" >same as permanent address &nbsp;&nbsp;</span><input type="checkbox" onclick="check_same_present_address()" <?php if($recruit_data['is_same_present_address'] == 1): ?> checked <?php endif; ?> name="is_same_present_address" id="is_same_present_address"  value="1"  ></label><span class="required">*</span>
								<div class="col-sm-6">
									<textarea name="present_add" id="present_add" class="form-control" <?php if($recruit_data['is_same_present_address'] == 1): ?> readonly <?php endif; ?> required><?php echo e($recruit_data['present_add']); ?></textarea>
							...
							<div class="form-group">
								...
								<div class="col-sm-1">
									<input type="checkbox" name="is_education_certif" id="is_education_certif" <?php if($recruit_data['is_education_certif'] == 1): ?> checked <?php endif; ?>	value="1" >
								</div>
								<label for="is_nid" class="col-sm-2 control-label">Is NID </label>
								<div class="col-sm-1">
									<input type="checkbox" name="is_nid" id="is_nid" <?php if($recruit_data['is_nid'] == 1): ?> checked <?php endif; ?>  value="1"  >
									
								</div>
								<label for="is_photo" class="col-sm-2 control-label">Is Photo</label>
								<div class="col-sm-1">
									<input type="checkbox" name="is_photo" id="is_photo"  <?php if($recruit_data['is_photo'] ==1 ): ?> checked <?php endif; ?> value="1">
								</div>
							</div> 
						</div> 
					</div>
								...
								<table id="education" class="table table-bordered">
									...
									<tbody id="education-row<?php echo $education_row; ?>">
									  <tr>
										...
										<td>
											<input type="text" <?php if($edu_val->result <= 3){ echo "readonly"; } ?>  id="cgpa<?php echo $education_row; ?>" name="edu_val[<?php echo $education_row; ?>][cgpa]" value="<?php echo e($edu_val->cgpa); ?>"  class="form-control" size="8">
				...
				<div class="col-md-12">
					<div class="box box-info">
								...
								<table id="experience" class="table table-bordered">
									...
									<tbody id="experience-row<?php echo $experience_row; ?>">
									  <tr>
										...
										<td><input type="text" name="exp_val[<?php echo $experience_row; ?>][exp_from]" value="<?php echo e($exp_val->exp_from); ?>"  class="form_date form-control" /></td>
										<td><input type="text" name="exp_val[<?php echo $experience_row; ?>][exp_to]" value="<?php echo e($exp_val->exp_to); ?>"  class="form_date form-control" /></td>
						...
						<div class="box-footer">
							<a href="<?php echo e(URL::to('/recruitment')); ?>" class="btn bg-olive" type="button"><i class="icon-list" ></i> List</a>&nbsp;
			...
			<div class="tab-pane <?php //if ($recruit_data['tab_id'] == 2) echo 'active';?>" id="tab_education">
				<form action="<?php echo e(URL::to('/recruit-edu')); ?>" method="post" class="form-inline" enctype="multipart/form-data">
					<?php echo e(csrf_field()); ?>

					<input type="hidden" name="recruitment_id" value="<?php echo e($recruit_data['recruitment_id']); ?>" >
			...
			<div class="tab-pane <?php if ($recruit_data['tab_id'] == 3) echo 'active';?>" id="tab_training">
				<form action="<?php echo e(URL::to('/recruit-training')); ?>" method="post" class="form-inline" enctype="multipart/form-data">
					<?php echo e(csrf_field()); ?>

					<input type="text" name="recruitment_id" value="<?php echo e($recruit_data['recruitment_id']); ?>" >
				<div class="col-md-12">
					<div class="box box-info">
						<div class="box-body">							
								...
								<table id="training" class="table table-bordered">
									...
									<tbody id="training-row<?php echo $training_row; ?>">
									  <tr>
										...
										<td><input type="text" name="tra_val[<?php echo $training_row; ?>][tr_period_to]" value="<?php echo e($tra_val->train_period_to); ?>" required class="form_date form-control" /></td>
			...
			<!--Start experience tab
			 <div class="tab-pane <?php //if ($recruit_data['tab_id'] == 4) echo 'active';?>" id="tab_experience">
				<form action="<?php echo e(URL::to('/recruit-experience')); ?>" method="post" class="form-inline" enctype="multipart/form-data">
					<?php echo e(csrf_field()); ?>
...
function select_circular_date(){
	  ...
	  //alert('ok');
	  $.ajax({
			url : "<?php echo e(url::to('select_circular_date')); ?>"+"/"+circular_id+"/"+post_id,
			type: "GET",
			dataType: 'json',
...
function check_same_present_address(){
	 ...
	 $(document).on("change", "#circular_id", function () {
		...
		$.ajax({
			url : "<?php echo e(url::to('select_circular_post')); ?>"+"/"+circular_id,
			type: "GET",
			success: function(data)
			{
				//alert(data);
...
<script>
	document.getElementById("religion").value="<?php echo e($recruit_data['religion']); ?>";
	document.getElementById("district_code").value="<?php echo e($recruit_data['district_code']); ?>";
	document.getElementById("circular_id").value="<?php echo e($recruit_data['circular_id']); ?>";
</script>
