				...
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/unsettle-claim-report')); ?>" method="post">
						...
						<div class="form-group">
						  ...
						  <input type="text" id="from_date" class="form-control entry_date" name="from_date" size="10" value="<?php echo e($from_date); ?>" required>
						</div>
						<div class="form-group">
						  <label for="pwd">to date :</label>
						  <input type="text" id="to_date" class="form-control entry_date" name="to_date" size="10" value="<?php echo e($to_date); ?>" required>
						</div>						
				...
				<table class="table table-bordered" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: right;"><?php echo ($result['credit_amt'] ==0) ? '' : $result['debit_amt'];?></td>
							<td style="text-align: right;"><?php echo $result['balance'];?></td>
							<td><a href="<?php echo e(URL::to('/unsettle-statement/'.$result['emp_id'])); ?>" target="_blank">Details</a></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
