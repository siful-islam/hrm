		...
		<div class="box box-info">
			...
			<!-- form start -->
				...
				<div class="form-group">
					...
					<label class="control-label col-md-2">Employee Name (Bangla) <span class="required">*</span></label>
                    <div class="col-md-3">
				...
				<div class="form-group">                  
					...
					<label class="control-label col-md-2">Father's Name (Bangla) </label>
                    <div class="col-md-3">
				...
				<div class="form-group">                  
					...
					<label class="control-label col-md-2">Mother's Name (Bangla) </label>
                    <div class="col-md-3">
				...
				<div class="form-group">
                    ...
                    <div class="col-md-3">
						<input type="text" name="birth_date" id="birth_date" value="<?php echo e($birth_date); ?>" required class="form-control" autocomplete="off">
                    </div>
				...
				<div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="national_id" id="national_id" value="<?php echo e($national_id); ?>" class="form-control" placeholder="National Id">
                    </div>
					<label class="control-label col-md-2">Birth Certificate </label>
                    <div class="col-md-3">
                        <input type="text" name="birth_certificate" id="birth_certificate" value="<?php echo e($birth_certificate); ?>" class="form-control" placeholder="Birth Certificate">
                    </div>
                </div>
				<div class="form-group">
				...
				<div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="date" name="joining_date" id="joining_date" value="<?php echo e($joining_date); ?>" required class="form-control" onchange="set_permanent_date();">
                    ...
                    <div class="col-md-3">
						<input type="date" class="form-control" name="br_join_date" id="br_join_date" value="<?php echo e($br_join_date); ?>" required>
                    </div>					
                </div>
				<div class="form-group">                    
				...
				<div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="date" name="c_end_date" readonly id="c_end_date" value="<?php echo e($next_permanent_date); ?>" class="form-control">
