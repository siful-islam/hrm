...
<?php $__env->startSection('title', 'Branch Contractual | Add Information'); ?>;
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Contractual </h3>
							<a href="<?php echo e(URL::to('/bra_contractual/create')); ?>" id="add_new" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Add New</a>
					</div>
					<!-- /.box-header -->
					<div class="box-body">	
							...
							<?php 
								...
								foreach($results as $v_result){ ?>
									...
									<?php if($v_result->cancel_date == ''){ ?>
										<td><a class="btn btn-sm btn-success btn-xs" href="<?php echo e(URL::to('bra_contractual/'.$v_result->id.'/edit')); ?>"><i class="glyphicon glyphicon-pencil"></i> Edit</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-sm btn-info btn-xs" title="Edit" href="<?php echo e(URL::to('bra_view_non_id/'.$v_result->id)); ?>"><i class="fa fa-eye"></i> View</a></td> 
									<?php }else{ ?> 
											<td><a class="btn btn-sm btn-info btn-xs" title="Edit" href="<?php echo e(URL::to('bra_view_non_id/'.$v_result->id)); ?>"><i class="fa fa-eye"></i> View</a></td> 
									<?php } ?>
