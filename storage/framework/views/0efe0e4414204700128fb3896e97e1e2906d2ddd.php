...
<?php $__env->startSection('title', 'Branch Leave Report'); ?>
						...
						<div style="width:95%;margin:auto;" >
							<table    style="width:100%;">
								<thead>
									...
									<tr>
										<th style="width:75%;text-align:left;">( Earn Leave) Previous Leave : <?php echo $fiscal_year->pre_cumulative_open; ?> &nbsp; &nbsp; &nbsp;Current Year Leave : <?php echo $fiscal_year->current_open_balance; ?></th>
