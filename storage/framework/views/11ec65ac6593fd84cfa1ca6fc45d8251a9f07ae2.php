<?php $__env->startSection('title', 'Previous Leave Report Balance'); ?>
						 ...
						 <table   class="report" border="1" cellspacing="0" style="width:90%;margin:auto;">  
								<thead>
									<tr>
										...
										<th><div align="center">Pre Balance</div></th>   
									</tr>
								</thead>
									<tbody>
									<?php  
									...
									foreach ($all_report as $report) { 
									 ?>
										<tr style="text-align:center;" >                                    
										  ...
										  <td style="width:13%;"><?php echo $report['pre_cumulative_open']; ?></td> 
										</tr> 
									<?php } ?>
								</tbody>
							</table> 
