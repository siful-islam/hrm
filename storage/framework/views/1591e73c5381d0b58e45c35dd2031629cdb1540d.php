	...
	<section class="content">
		<div class="box box-info">
			...
			<?php if(!empty($employee_his)){?>
				<br>
				<br>
				<form class="form-horizontal" onsubmit="return change_with_pay();" action="<?php echo e(URL::to('/insert_aprove_leave')); ?>" role="form" method="POST" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>
				...
				<input type="hidden" name="org_join_date" id="org_join_date"  class="form-control" value="<?php echo e($employee_his->joining_date); ?>" readonly required>
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">FY Cummulative close</label>
											<div class="col-md-6">
												<input type="text"  id="cum_balance_less_close_12" name="cum_balance_less_close_12" class="form-control" readonly value="<?php echo e(0); ?>" required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
...
<script>
 function settotalday1(){
	...
	// var dataString = 'employee_id='+employee_id;
			$.ajax({
				type:'get',
				url : "<?php echo e(URL::to('leave_date_exist')); ?>"+"/"+from_date+"/"+to_date+"/"+emp_id,
