	...
	<section class="content">
		...
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title"> Personal Information &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;">শুধুমাত্র শিসকের শিক্ষক ও কুকের তথ্য এন্ট্রি দিবেন</span> </h3>
			</div>
			<!-- /.box-header -->
			<!-- form start -->
				...
				<div class="form-group"> 
                    ...
                    <div class="col-md-3">
                        <input type="date" name="joining_date" required id="joining_date" value="<?php echo e($joining_date); ?>"   class="form-control">
                        <span class="help-block"></span>
                    </div>
