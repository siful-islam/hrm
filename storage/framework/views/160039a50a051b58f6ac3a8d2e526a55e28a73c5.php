...
.image-upload img
{
	...
	<section class="content">
		...
		<div class="box box-info">
			...
			<!-- form start -->
				...
				<input type="hidden" id="admin_id" name="admin_id" value="<?php echo e($data['admin_id']); ?>">
				
				<div class="box-body">
					<div class="form-group">
						<label for="first_name" class="col-sm-2 control-label">First Name</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="first_name" name="first_name" value="<?php echo e($data['first_name']); ?>" placeholder="First Name">
						</div>
					</div>
					<div class="form-group">
						<label for="last_name" class="col-sm-2 control-label">Last Name</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="last_name" name="last_name" value="<?php echo e($data['last_name']); ?>" placeholder="Last Name">
						</div>
					</div>
					<div class="form-group">
						<label for="first_name" class="col-sm-2 control-label">Emp ID</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="emp_id" name="emp_id" value="<?php echo e($data['emp_id']); ?>" placeholder="Emp Id">
						</div>
					</div>
					<div class="form-group">
						<label for="admin_name" class="col-sm-2 control-label">Username</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="admin_name" name="admin_name" value="<?php echo e($data['admin_name']); ?>" placeholder="Username" required>
						</div>
					</div>
					<div class="form-group">
						<label for="email_address" class="col-sm-2 control-label">User Email</label>
						<div class="col-sm-4">
							<input type="email" class="form-control" id="email_address"  name="email_address" value="<?php echo e($data['email_address']); ?>" placeholder="User Email" required>
						</div>
					</div>
					<div class="form-group">
						<label for="cell_no" class="col-sm-2 control-label">Cell No</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="cell_no"  name="cell_no" value="<?php echo e($data['cell_no']); ?>" placeholder="Cell No">
						</div>
					</div>					
					<div class="form-group">
						<label for="admin_password" class="col-sm-2 control-label">User Password</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="admin_password"  name="admin_password" value="<?php echo e($data['admin_password']); ?>" placeholder="User Password" required>
						</div>
					</div>					
					<div class="form-group">
						...
						<div class="col-sm-4">
							<select class="form-control" name="access_label" id="access_label" required>
								...
								<?php $__currentLoopData = $data['user_role']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user_role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($user_role->id); ?>"><?php echo e($user_role->admin_role_name); ?></option>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<select class="form-control" name="br_code" id="br_code" required>
								...
								<?php $__currentLoopData = $data['branch_info']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<img id="blah" class="img-thumbnail" src="<?php echo e(asset($data['admin_photo'])); ?>" width="90" height="110"/>
							</label>
							<input type="file" onchange="readURL(this);" class="form-control" name="admin_photo" id="admin_photo">
							<input type="hidden" name="pre_admin_photo" value="<?php echo e($data['pre_admin_photo']); ?>">
						</div>
					</div>
				</div>
				<!-- /.box-body -->
	...
	<script>
	document.getElementById("access_label").value=<?php echo e($data['access_label']); ?>

	document.getElementById("br_code").value=<?php echo e($data['br_code']); ?>
