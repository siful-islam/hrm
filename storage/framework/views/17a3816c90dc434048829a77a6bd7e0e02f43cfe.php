                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="table-responsive">
                               ...
                               <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>Own Interest</th>
                                        <td class="text-right"><?php echo e(number_format($pf_info->interest_amount_stuff)); ?></td>
                                        <td class="text-right"> <?php echo e(number_format($pf_info->total_interest_amount_stuff)); ?>

                                        </td>
                                        <td class="text-right">
                                            <?php echo e(number_format($my_interst_total = $pf_info->total_interest_amount_stuff + $pf_info->interest_amount_stuff)); ?>
                                    ...
                                    <tr>
                                        <th>My Total</th>
                                        <th class="text-right">
                                            <?php echo e(number_format($my_total_opening = $opening_balance_staff + $pf_info->interest_amount_stuff)); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo e(number_format($pf_info->interest_amount_org)); ?></td>
                                        <td class="text-right"><?php echo e(number_format($pf_info->total_interest_amount_org)); ?></td>
                                        <td class="text-right">
                                            <?php echo e(number_format($org_total_interest = $pf_info->interest_amount_org + $pf_info->total_interest_amount_org)); ?>

                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Undistributed Org.Contribution <br> + interest</td>
                                        <td class="text-right"><?php echo e(number_format($undistribute_org_contribute_opening = 0)); ?>

                                        </td>
                                        <td class="text-right">
                                            <?php echo e(number_format($undistribute_org_contribute_curent_year = 0)); ?>
									...
									<tr>
                                        <th>CDIP Total</th>
                                        <th class="text-right">
                                            <?php echo e(number_format($org_total_opening = $opening_balance_org + $pf_info->interest_amount_org + $undistribute_org_contribute_opening)); ?>
