...
<body>
    ...
    <b>Dear Concern,</b>
	<br><br />
	This is for your kind information, <b><?php echo e($mail_data['emp_name']); ?></b> has joined CDIP on <?php echo e(date('d-m-Y',strtotime($mail_data['org_join_date']))); ?> as contractual staff. <?php if($mail_data['gender']=='Male'): ?>His <?php else: ?> Her <?php endif; ?> contract ending date is <?php echo e(date('d-m-Y',strtotime($mail_data['permanent_date']))); ?>. Please take necessary step.
	<br><br>
