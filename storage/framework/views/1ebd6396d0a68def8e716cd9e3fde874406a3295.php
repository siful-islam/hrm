...
<?php $__env->startSection('main_content'); ?>
    ...
    <section class="content">
		...
		<div class="row"> 
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<a href="<?php echo e(URL::to('/my_loan')); ?>">      
					<div class="info-box">
						<span class="info-box-icon bg-blue" id="money"><img src="<?php echo e(asset('public/profile/loan.png')); ?>" width="60%"></span>
						<div class="info-box-content">
				...
				<!--<div class="col-md-4 col-sm-6 col-xs-12">
					<a href="<?php echo e(URL::to('/attendence')); ?>">      
					<div class="info-box">
						<span class="info-box-icon bg-fray" id="money"><img src="<?php echo e(asset('public/profile/finger.png')); ?>" width="60%"></span>
						<div class="info-box-content">
