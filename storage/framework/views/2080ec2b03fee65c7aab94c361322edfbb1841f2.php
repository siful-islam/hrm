				...
				<tbody>
					...
					<tr>
						...
						$max_sarok_designation = DB::table('tbl_master_tra as m')
										...
										->where('m.letter_date', '=', function($query) use ($empid)
											{
												$query->select(DB::raw('max(letter_date)'))
													  ->from('tbl_master_tra')
													  ->where('emp_id',$empid)
													  ->where('effect_date', '<=', '2021-06-30');
											})
			...
			<table class="table table-bordered" cellspacing="0">
				<tbody>
					...
					<tr>
						...
						<td id="total_score" style="text-align:center;"><?php echo $pms_final_score->score_b; ?></td>
					</tr>					
				</tbody>
			</table>
		</div>
			...
			<table style="margin-left: 80px;" class="table table-bordered">
				<tbody>
					...
					<tr>
						...
						<td id="total_weightscore" style="text-align:center;"></td>
						<td id="total_rating" style="text-align:center;"><?php echo $pms_final_score->score_c1; ?></td>
					</tr>
				</tbody>
			</table>
			...
			<table style="margin-left: 80px;" class="table" cellspacing="0">
				<tbody>
					...
					<tr>
						...
						<td id="totalrating" style="text-align:center;"><?php echo $pms_final_score->score_c2; ?></td>
					</tr>
				</tbody>
			</table>
			...
			<table style="margin-left: 80px;" class="table" cellspacing="0">
				<tbody>
					...
					<tr>
						...
						<td id="totalra_ting" style="text-align:center;"><?php echo $pms_final_score->score_c3; ?></td>
					</tr>
				</tbody>
			</table>
			...
			<table style="margin-left: 80px;" class="table" cellspacing="0">
				<tbody>
					...
					<tr>
						...
						<td id="total_ra_ting" style="text-align:center;"><?php echo $pms_final_score->score_c3; ?></td>
					</tr>
				</tbody>
			...
			<table style="margin-left: 80px;" class="table" cellspacing="0">
				<tbody>
					<tr>
						...
						<td style="font-weight: bold;width:30%;text-align:center;"><?php echo 'B = '.$pms_final_score->score_b.', '.'C.1 = '.$pms_final_score->score_c1.', '.'C.2 = '.$pms_final_score->score_c2.', '.'C.3 = '.$pms_final_score->score_c3.', '.'C.4 = '.$pms_final_score->score_c4;?></td>
						<td style="font-weight: bold;width:4%;text-align:center;"><?php echo round($pms_final_score->score_b + $pms_final_score->score_c1 + $pms_final_score->score_c2 + $pms_final_score->score_c3 + $pms_final_score->score_c4); ?></td>
					</tr>
				</tbody>
			</table>
		</div>
