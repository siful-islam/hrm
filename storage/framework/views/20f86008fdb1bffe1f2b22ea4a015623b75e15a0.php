				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">						
							...
							<div class="col-sm-3">
								<input type="hidden" name="training_no" value="<?php echo e($max_tra_no); ?>" >
								<input type="text" class="form-control" name="training_name" value="<?php echo e($training_name); ?>" required>
							</div>
						...
						<div class="form-group">						
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" id="start_date" name="tr_date_from" value="<?php echo e($tr_date_from); ?>" required>
							</div>
							<label for="tr_date_to" class="col-sm-2 control-label">Training Date To <span class="required">*</span></label>
							<div class="col-sm-3">
								<input type="text" class="form-control" id="form_date" name="tr_date_to" value="<?php echo e($tr_date_to); ?>" required>
							</div>						
						</div>						
						<div class="form-group">						
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" id="tr_venue_other" name="tr_venue_other" value="<?php echo e($tr_venue_other); ?>" >
							</div>						
							</div>
						</div>
						<hr>
							...
							<table id="training" class="table table-bordered">
								...
								<tbody id="training-row<?php echo $training_row; ?>">
								  <tr>
									<td>
										<input type="hidden" name="training_no" value="<?php echo e($max_tra_no); ?>" >
										<input type="hidden" name="training_detail_id" value="<?php echo e($training->training_detail_id); ?>" >
										<input type="text" name="training[<?php echo $training_row; ?>][emp_id]" value="<?php echo e($training->emp_id); ?>" required class="form-control" onChange="get_employee_info(this.value,<?php echo e($training_row); ?>);" size="8">
									</td>
									<td>
										<input type="text" value="<?php echo e($training->emp_name_eng); ?>" style="width:180px;" class="form-control" />
									</td>
									<td>
									...
									<input type="hidden" name="training[<?php echo $training_row; ?>][id]" value="<?php echo e($training->id); ?>" />
									<td>
					...
					<div class="box-footer">
						<a href="<?php echo e(URL::to('/training')); ?>" class="btn bg-olive" >List</a>
