				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-1">
								<select name="schdule_id" id="schdule_id" required class="form-control">
									<option value="" >Select</option>
									<option value="1" <?php //if($type==1) echo 'selected'; ?> >Schedule</option>
									<option value="2" <?php //if($type==2) echo 'selected'; ?> >Un-Schedule</option>
								</select>
							</div>
