					...
					<div class="box box-info">
						<div class="box-body">							
							...
							<div class="form-group<?php echo e($errors->has('birth_date') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="birth_date" id="birth_date" value="<?php echo e($emp_cv['birth_date']); ?>" required class="form-control">
						...
						<div class="box-body">
							...
							<!--<div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									...
									<span class="help-block">
										<strong><?php echo e($errors->first('employee_photo')); ?></strong>
									</span>
									<?php endif; ?>
								</div>
							</div>-->
