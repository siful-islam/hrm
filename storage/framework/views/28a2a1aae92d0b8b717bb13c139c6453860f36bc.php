<?php $__env->startSection('title', 'Resignation Staff Report'); ?>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/resignation-report')); ?>" method="post">
				...
				<?php if($order_by == 'emp_id') { ?>
					...
					<tbody>
						<tr>
							...
							<td><?php echo e($result['area_name']); ?></td>
							...
							<td><?php echo e($result['terminate_by']); ?></td>
							...
							<td><?php echo e($result['staff_status']); ?></td>
						</tr>
					</tbody>
					<?php } ?>
				</table>
