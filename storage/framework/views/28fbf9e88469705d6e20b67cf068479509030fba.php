<?php $__env->startSection('title', 'Pay-Slip'); ?>
<?php $__env->startSection('main_content'); ?>
    ...
    <script>
        var d = new Date();
        var m = d.getMonth();
        document.getElementById("salary_month").value = "<?php echo $salary_months ?>";
        document.getElementById("salary_year").value = "<?php echo $salary_years ?>";
        ...
        function get_pay_slip() {
            ...
            var url = "<?php echo e(URL::to('/get-pay-slip')); ?>";
            $.ajax({
                type: "GET",
