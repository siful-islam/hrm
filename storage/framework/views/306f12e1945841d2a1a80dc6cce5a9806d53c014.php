				...
				<div class="box">
					...
					<div class="box-header">
						<h3 class="box-title pull-right"> 
							<a href="<?php echo e(URL::to('/movement/create')); ?>" class="btn btn-success pull-right"><i class="fa fa-plus"></i>New Movement</a>
						</h3>
					</div>
					<div class="box-body"> 
						...
						<table id="table" class="table no-border table-striped">
							...
							<?php $__currentLoopData = $movement_register_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $register_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr>
									...
									<a class="btn btn-sm btn-primary" title="Edit" href="<?php echo e(URL::to('/movement/'.$register_list->move_id.'/edit')); ?>"><i class="glyphicon glyphicon-pencil"></i></a>
									<?php if($register_list->status == 1){?>
									<a class="btn btn-sm btn-primary" title="Create Bill" href="<?php echo e(URL::to('/movement_bill_create/'.$register_list->move_id)); ?>"><i class="glyphicon glyphicon-pencil"></i>Create Bill</a>
									<?php }else{ ?>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<?php } ?>
									</td> 
