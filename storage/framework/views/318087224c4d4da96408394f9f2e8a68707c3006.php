...
<?php $__env->startSection('title', 'Add Group-Subject'); ?>
					...
					<div class="box box-info">
						<div class="box-body">							
							<div class="form-group<?php echo e($errors->has('subject_name') ? ' has-error' : ''); ?>">
								...
								<div class="col-sm-6">
									<input type="text" name="subject_name" id="subject_name" value="<?php echo e($subject_name); ?>" required autofocus class="form-control">
						...
						<div class="box-footer">
							<a href="<?php echo e(URL::to('/group-subject')); ?>" class="btn bg-olive" type="button"><i class="icon-list" ></i> List</a>&nbsp;
