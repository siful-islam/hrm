				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Salary Items (+)</h3>
							<a href="<?php echo e(URL::to('/salary-plus/create')); ?>" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Item</a>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						...
						<table id="table" class="table table-bordered table-hover" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td><a class="btn btn-sm btn-primary" title="Edit" href="<?php echo e(URL::to('/salary-plus/'.$item->id.'/edit')); ?>"><i class="glyphicon glyphicon-pencil"></i></a></td>
								</tr>
								<?php } ?>
							</tbody>      
						</table>
