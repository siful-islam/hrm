...
<?php $__env->startSection('title', 'Individual Requisition Report'); ?>
		...
		<div class="row">
		 <div class="col-md-12"> 
			...
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/rpt_dairy_calender_ind_post')); ?>" method="post">
...
$(document).ready(function() {  
	document.getElementById("emp_id").value="<?php echo e($emp_id); ?>";
});
//--></script>
