						...
						<div style="width:95%;margin:auto;" >
							<table    style="width:100%;">
								<thead>
									...
									<tr>
										<th style="width:75%;text-align:left;">( Earn Leave ) Old Leave (9-12): <?php echo $fiscal_year->cum_balance_less_12; ?> &nbsp; &nbsp; &nbsp; Previous Leave : <?php echo $fiscal_year->pre_cumulative_open; ?> &nbsp; &nbsp; &nbsp;Current Year Leave : <?php echo $fiscal_year->current_open_balance; ?>&nbsp; &nbsp; Casual Leave : <?php echo $fiscal_year->casual_leave_open; ?></th>
