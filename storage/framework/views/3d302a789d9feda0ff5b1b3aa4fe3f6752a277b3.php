			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						...
						<a href="<?php echo e(URL::to('/add_user')); ?>" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New</a>
						...
						<table id="table" class="table table-bordered table-hover" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo e($user->cell_no); ?></td>
									<td><?php echo e($user->admin_role_name); ?></td>
									<td><img src="public/avatars/<?php echo e($user->admin_photo); ?>" alt="Logo" width="35"></td>
									<td><a class="btn btn-sm btn-primary" title="Edit" href="<?php echo e(URL::to('/edit-user/'.$user->admin_id)); ?>"><i class="glyphicon glyphicon-pencil"></i></a></td>
								</tr>
