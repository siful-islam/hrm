<?php $__env->startSection('title', 'Leave & Visit'); ?>
<?php $__env->startSection('main_content'); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td rowspan="2" align="center">
                                                    <a class="btn btn-info" target="_BLANCK"
                                                        ...
                                                        Details <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                                                </td>
                                                <td align="center">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#leave_form').on('submit', function(event) {
				...
				/*
				-- BEFORE contuning leave validation --
				if (leave_type == 2) {
                    if (filePath) {
                        document.getElementById("attachments_msg").innerHTML = '';
                        $('#btnSave').attr('disabled', false);
				...
				if (leave_type == 2) {
					...
					else if(no_of_days < 4)
					{
                        ...
                        var flag = 1;
							...
							var flag = check_secquence(emp_id,leave_from,leave_to,no_of_days,leave_type);
						}
					}
                } else {
					document.getElementById("attachments_msg").innerHTML = '';
		...
		function check_secquence(emp_id,leave_from,leave_to,no_of_days,leave_type)
		{
			var flag = 0;
			var returnvalue = 0;
			var url = "<?php echo e(URL::to('/leave-validations')); ?>"; 
			var return_type = false;
			$.ajax({
				type: "GET",
				url: url + "/" + emp_id + "/" + leave_from + "/" + leave_to + "/" + no_of_days + "/" + leave_type,
				async: false,
        ...
        function view_leave_info(id) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    document.getElementById("v_leave_from").value = res.v_leave_from;
                    document.getElementById("v_leave_to").value = res.v_leave_to;
                    ...
                    if(res.modify_cancel > 0)
					{
						...
						{
							var modify_msg = 'Leave Duration Modified';
						}
						else{
							var modify_msg = 'Leave Application Canceled';
						}
        ...
        function cancel_leave(id) {
            if (confirm('Are you sure to delete this data?')) {
                var message = 'Submitted for cancel approval';
                $.ajax({
                    url: "<?php echo e(url('delete_leave_application')); ?>" + "/" + id,
                    type: "GET",
                    dataType: "JSON",
                    success: function(data) {
        ...
        function set_date_range() {
            ...
            var flag =  check_all_leave_validation(leave_type, leave_date, leave_date, half_leave_balance);
        ...
        function check_all_leave_validation(leave_type, leave_from, leave_to, leave_balance) { 
            ...
            var url = "<?php echo e(URL::to('/get-leave-validation')); ?>";
            $.ajax({
                type: "GET",
        ...
        $(document).ready(function() {
            table_leave = $('#table_leave').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(URL::to('/all-leave_application')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" method="POST" id="leave_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="apply_for" class="col-sm-3 control-label">Apply For</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="leave_category" class="col-sm-3 control-label">Leave Type</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group" id="leave_category_sub_div">
                        <label for="leave_category_sub" class="col-sm-3 control-label">Special Type</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group" id="leave_dates_div">
                        <label for="leave_dates" class="col-sm-3 control-label">Leave Dates</label>
                        <div class="col-sm-8">
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" id="v_leave_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="v_leave_from" name="v_leave_from" readonly><span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="leave_to" class="col-sm-3 control-label">Date To</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="v_leave_to" name="v_leave_to" readonly>
                        </div>
                    </div>
                    <div class="form-group">
					...
					<div class="table-responsive" id="is_modify">
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th width="50%">Modification Type</th>
	...
	<script>
		// Modify
        function modify_leave(id,type) {
			document.getElementById("m_post_method").innerHTML = "";
            var url = "<?php echo e(URL::to('/get-leave-info')); ?>";
            $.ajax({
                type: "GET",
                url: url + "/" + id,
                success: function(res) {
                    document.getElementById("m_application_id").value = res.application_id;
                    document.getElementById("m_application_date").value = res.application_date;
                    document.getElementById("m_leave_from").value = res.leave_from;
                    document.getElementById("m_leave_to").value = res.leave_to;
                    document.getElementById("m_apply_for").value = res.apply_for;
                    document.getElementById("m_leave_type").value = res.leave_type;
                    document.getElementById("m_remarks").innerHTML = res.remarks;
                    document.getElementById('m_no_of_days').value = res.no_of_days;
					if(type ==1)
					{
						document.getElementById("modify_remarks_label").innerHTML = 'Cause of Modify';
						$("#m_leave_to_actual_div").attr("style", "display:block"); 
						document.getElementById("modify_cancel").value = 1;
						$('.modal-title').text('Modify: Leave Application'); 
					}
					else
					{
						document.getElementById("modify_remarks_label").innerHTML = 'Cause of Cancel';
						$("#m_leave_to_actual_div").attr("style", "display:none"); 
						document.getElementById("modify_cancel").value = 2;
						$('.modal-title').text('Cancel: Leave Application'); 
					}
					document.getElementById('m_leave_to_actual').value = res.leave_to;
					document.getElementById('m_leave_to_actual').setAttribute("max", res.leave_to);
					document.getElementById('m_leave_to_actual').setAttribute("min", res.leave_from);
					document.getElementById("modify_remarks").value = '';
					document.getElementById("modify_remarks_message").innerHTML = '';	
					document.getElementById("m_leave_to_actual_message").innerHTML = '';	
                    $('#m_modal_form').modal('show'); 
                }
            })
        }
		...
		{
			var modify_cancel = document.getElementById("modify_cancel").value;
			var modify_remarks = document.getElementById("modify_remarks").value;
			if(modify_cancel ==1)
			{
				var m_leave_from = document.getElementById("m_leave_from").value;
				var m_leave_to = document.getElementById("m_leave_to").value;
				var m_leave_to_actual = document.getElementById("m_leave_to_actual").value;
				if(m_leave_to == m_leave_to_actual){
					var d_flag = 2;	
					document.getElementById("m_leave_to_actual_message").innerHTML = 'Invalid Date';
				}
				else if(m_leave_to_actual < m_leave_from || m_leave_to_actual > m_leave_to){
					var d_flag = 2;	
					document.getElementById("m_leave_to_actual_message").innerHTML = 'Invalid Date';
				}
				else{
				...
				if(modify_remarks == '')
				{
					document.getElementById("modify_remarks_message").innerHTML = 'This is required';
					var r_flag = 2;	
				}else{
				...
				if(d_flag ==1 && r_flag == 1){
					var flag = 1;
				}
				else{
					var flag = 2;
				}
			}else if(modify_cancel == 2)
			{
				if(modify_remarks == '')
				{
					document.getElementById("modify_remarks_message").innerHTML = 'This is required';
			...
			if(flag == 1) {
				document.getElementById("myNav").style.width = "100%";
				$('#m_modal_form').modal('hide');
				var url = "<?php echo e(URL::to('/leave-appliacation-modify')); ?>";
					$.ajax({
					url : url,
					type: "POST",
					data: $('#m_leave_form').serialize(),
					dataType: "JSON",
					success: function(data)
					{
						console.log(data);
						...
						$.gritter.add({
							title: 'Success!',
							text: 'Application Submited for Approval',
							sticky: false,
							class_name: 'gritter-light'
						});							
		...
		function set_date_modified() {
			...
			var url = "<?php echo e(URL::to('/get-leave-modify-validation')); ?>";  
            $.ajax({
                type: "GET",
                url: url + "/" + leave_type + "/" + m_leave_from + "/" + m_leave_to_actual + "/" + balance + "/" + apply_for,
                success: function(res) {
					document.getElementById('m_leave_dates').value = res.leave_dates;
					document.getElementById('m_general_message').innerHTML = res.message;
                    document.getElementById('m_no_of_days').value = res.days;
                    if (res.flag == 0) {
                        $('#btnMofify').attr('disabled', true);
                    } else {
                        $('#btnMofify').attr('disabled', false);
                    }
					flag = res.flag;
                   return flag;
                }
	...
	<!-- Start modify Leave modal -->
    <div class="modal fade" id="m_modal_form" role="dialog" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<form class="form-horizontal" role="form" method="POST" id="m_leave_form">
                    <?php echo e(csrf_field()); ?>

					<span id="m_post_method"></span>
					
					<input class="form-control" type="hidden" name="m_leave_dates" id="m_leave_dates" readonly>			
					<input class="form-control" type="hidden" name="modify_cancel" id="modify_cancel" readonly>			
					<input class="form-control" type="hidden" name="m_apply_for" id="m_apply_for" readonly>			
                    <div class="form-group">
                        <label for="supervisor" class="col-sm-3 control-label">Application ID</label>
                        <div class="col-sm-8">
                            <input class="form-control" type="text" name="m_application_id" id="m_application_id"
                                readonly>
                        </div>
                    </div>
					<div class="form-group">
                        <label for="supervisor" class="col-sm-3 control-label">Application Date</label>
                        <div class="col-sm-8">
                            <input class="form-control" type="text" name="m_application_date" id="m_application_date"
                                readonly>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="leave_type" class="col-sm-3 control-label">Leave Source</label>
                        <div class="col-sm-8">
                            <select class="form-control" name="m_leave_type" id="m_leave_type" disabled readonly>
                                <?php foreach ($leave_types_all as $v_leave_types_all) { ?>
                                <option value="<?php echo $v_leave_types_all->id; ?>"><?php echo $v_leave_types_all->type_name; ?></option>
                                <?php } ?>
                            </select>
                    ...
                    <div class="form-group">
                        <label for="leave_from" class="col-sm-3 control-label">Date From</label>
                        <div class="col-sm-8">
                            <input type="date" class="form-control" id="m_leave_from" name="m_leave_from" readonly><span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="leave_to" class="col-sm-3 control-label">Date To</label>
                        <div class="col-sm-8">
                            <input type="date" class="form-control" id="m_leave_to" name="m_leave_to" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="v_no_of_days" class="col-sm-3 control-label">Leave Days</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="m_no_of_days" name="m_no_of_days" readonly>
							<span id="m_general_message" style="color:red;"><span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="remarks" class="col-sm-3 control-label">Purpose of leave</label>
                        <div class="col-sm-8">
                            <textarea class="form-control" name="v_remarks" id="m_remarks" readonly></textarea>
                        </div>
                    </div>
					<div class="form-group" id="m_leave_to_actual_div">
                        <label for="leave_to" class="col-sm-3 control-label" style="color:blue;">Leave Enjoyed Till</label>
                        <div class="col-sm-8">
                            <input type="date" class="form-control" id="m_leave_to_actual" name="m_leave_to_actual" onchange="set_date_modified();">
							<span id="m_leave_to_actual_message" style="color:red;"><span>
                        </div>
                    </div>
					<div class="form-group">
                        <label for="leave_to" class="col-sm-3 control-label" style="color:blue;" id="modify_remarks_label">Remarks</label>
                        <div class="col-sm-8">
                            <textarea class="form-control" id="modify_remarks" name="modify_remarks" required></textarea>
							<span id="modify_remarks_message" style="color:red;"><span>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" id="btnMofify" class="btn btn-danger pull-right" onclick="save_modify();">Submit for Approval</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            table_visit = $('#table_visit').DataTable({
                ...
                "responsive": true,
                "ajax": {
                    "url": "<?php echo e(URL::to('/all_movement_application')); ?>",
                    "dataType": "json",
                    "type": "POST",
                    "data": {
                        _token: "<?php echo e(csrf_token()); ?>"
                            ...
                            <span id="branch_destination" style="display:block;">
                                <select name="destination_code[]" multiple="multiple" style="width: 100%;"
                                    ...
                                    <?php $__currentLoopData = $branch_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($branch->br_code); ?>" <?php if (in_array($branch->
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" id="v_visit_form">
                    ...
                    <div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" id="vehicle_id" class="form-control" value="" readonly>
                        </div>
                    </div> 
					<div class="form-group" id="driver_suport">
                        <label for="driver_id" class="col-sm-3 control-label">Driver</label>
                        <div class="col-sm-4">
							<input type="text" id="driver_id" class="form-control" value="" readonly>
                        </div> 
						<div class="col-sm-4">
							<input type="text" id="dri_mobile" class="form-control" value="" readonly>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" id="c_visit_form">
                    ...
                    <div class="form-group">
                        <label for="v_to_date" class="col-sm-3 control-label">Return Date (Actual)</label>
                        <div class="col-sm-4">
                            <input type="date" id="return_date" onchange="set_date_visit_close()"  name="return_date" autocomplete="off" class="form-control"
                                value="" required>
                            ...
                            <div class="box-header with-border">
                                <center style="text-align:justfy;text-justify: inter-word;" id="with_header">
                                    <span class="box-title" style="text-align:left;">
                                        <img src="<?php echo e(asset(Session::get('org_logo'))); ?>" style="float:left;margin-top:0%;"
                                            width="50">
                                    </span> 
								 </center>
								 <center>
                                ...
                                <table width="100%">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align:right;width:20%;">Designation</th>
                                            <td style="text-align:right;width:30%;" id="visit_designation" ></td> 
                                        </tr> 
										<tr>
    ...
    <script>
        ...
        function add_voucher(move_id, visit_type) {
            ...
            $.ajax({
                type: 'get',
                url: "<?php echo e(URL::to('get_travel_bill_info')); ?>" + "/" + move_id + "/" + visit_type,
                dataType: "JSON",
                success: function(data) {
                    ...
                    var da_sub_total = 0;
                        ...
                        $("#add_table").empty();
                        $("#visit_pupose").empty();
						 $("#visit_designation").empty();
                        var t_row = '';
						 document.getElementById("visit_pupose").innerHTML = data["visit_detail"]["purpose"];
						  document.getElementById("visit_designation").innerHTML = data["visit_detail"]["designation_name"];
		 ...
		 function set_date_visit() {
            ...
            if (to_date < from_date) {
                ...
                $('#btnSave_visit').attr('disabled', false); //set button enable 
				 ...
				 var url = "<?php echo e(URL::to('/visit_check_date')); ?>";
					$.ajax({
						type: "GET",
						url: url + "/" + visit_emp_id+ "/" + from_date+ "/" + to_date+ "/" + db_id+ "/" + leave_time+ "/" + arrival_time,
						success: function(res) {
							//alert(res)
							console.log(res);
							if(res == 1){
		...
		function set_date_visit_close() {
            ...
            var c_arrival_time = document.getElementById('c_arrival_time').value;
            ...
            if (visit_close_to_date <= pre_return_date) {
                ...
                $('#btnvisit_close').attr('disabled', false); //set button enable 
				 ...
				 var url = "<?php echo e(URL::to('/visit_check_date')); ?>";
					$.ajax({
						type: "GET",
						url: url + "/" + visit_emp_id+ "/" + visit_close_from_date+ "/" + visit_close_to_date+ "/" + db_id+ "/" + c_leave_time+ "/" + c_arrival_time,
						success: function(res) {
							//alert(res)
							console.log(res);
							if(res == 1){
        ...
        $(document).ready(function() {
            $('#visit_form').on('submit', function(event) {
                ...
                $('#btnSave_visit').attr('disabled', true); //set button disable
                url = "<?php echo e(URL::to('/movement_application')); ?>";
                message = 'Data Saved Successfully';
                $.ajax({
                    url: url,
                    method: "POST",
        ...
        function view_move_info(id) {
            var url = "<?php echo e(URL::to('/get_move_info')); ?>";
            $.ajax({
                type: "GET",
                url: url + "/" + id,
                success: function(res) {
					...
					if(res.is_need_vehicle_sup == 1){
						$("#driver_suport").show();
						document.getElementById("vehicle_id").value = res.vehicle_id;
						document.getElementById("driver_id").value =  res.driver_id;
						document.getElementById("dri_mobile").value =  res.dri_mobile;
					}else{
						$("#driver_suport").hide();
					}
                    ...
                    if (res.super_action == 1) {
						...
						if(res.first_super_action != 2){
							var supervisor_action = 'Pending...';
						}else{
							var supervisor_action = '';
						}
        ...
        function movement_close(id) {
            var url = "<?php echo e(URL::to('/movement_close')); ?>";
            $.ajax({
                type: "GET",
                url: url + "/" + id,
                success: function(res) {
        ...
        function get_movement_info(id) {
            var url = "<?php echo e(URL::to('/get_movement_info')); ?>";
            $.ajax({
                type: "GET",
                url: url + "/" + id,
                success: function(res) {
        ...
        function delete_move_application(id, reference_id) {
            if (confirm('Are you sure to delete this data?')) {
                ...
                $.ajax({
                    url: "<?php echo e(url('delete_move_application')); ?>" + "/" + id + "/" + reference_id,
                    type: "GET",
                    dataType: "JSON",
                    success: function(data) {
                        reload_table_visit(); // List table reloaded
