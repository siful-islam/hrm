			...
			<div class="col-md-12">
				<div class="box box-info">
						...
						<div class="col-md-10 col-md-offset-1 table-responsive">
							<table id="training" class="table table-bordered">
								...
								<tbody id="training-row<?php echo $training_row; ?>">
								  <tr>
									<td>
										<input type="text" value="<?php echo e($training->emp_id); ?>" class="form-control" size="8" />
									</td>
									<td>
										<input type="text" value="<?php echo e($training->emp_name_eng); ?>" class="form-control" />
									</td>
									<td>
					...
					<div class="box-footer">
						<a href="<?php echo e(URL::to('/training')); ?>" class="btn bg-olive" ><i class="fa fa-fw fa-long-arrow-left" ></i> Back-to-List</a>
					</div>
				   <!-- /.box-footer -->
				</div>
			</div>
