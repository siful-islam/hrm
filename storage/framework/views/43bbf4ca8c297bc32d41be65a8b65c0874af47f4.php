...
<section class="content">
				...
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/unsettle-staff-adv')); ?>" method="post">
						...
						<div class="form-group">
						  ...
						  <input type="text" id="entry_date" class="form-control" name="entry_date" size="10" value="<?php echo e($entry_date); ?>" required>
						</div>						
				...
				<div class="box box-info" style="margin-bottom:10px;">
					<div class="box-body">							
						<div class="form-group">
							...
							<div class="col-sm-2">
								<p class="form-control-static">: <?php echo $result_info->collection_amt + $result_info->transfer_amt; ?></p>
							</div>
							<label class="col-sm-2 control-label">Balance </label>
							<div class="col-sm-1">
								<p class="form-control-static">: <?php echo $balance = $result_info->total_amount - ($result_info->collection_amt + $result_info->transfer_amt); ?></p>
							</div>
							<div class="col-sm-1">
	...
	<?php } } ?>
	<?php if(!empty($resultinfo)) { 
	$transaction = array('1' => "Cash Collection", '2' => "Payroll Collection", '3' => "Transfer", '4' => "Adjustment", '5' => "Add Unsettle Claim");	
	?>
	<div class="row">
		<div class="col-md-12">
