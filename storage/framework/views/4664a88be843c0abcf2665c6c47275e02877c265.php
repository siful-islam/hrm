<?php $__env->startSection('title', 'Office Order'); ?>
						...
						<input type="hidden" name="hidden_document_name" class="form-control" value="" readonly>
						 <div class="box-body">
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-3">
								<input type="text" required class="form-control" id="title" name="title" value="<?php echo e($title); ?>">
							  </div>
							</div>
							<div class="form-group">
							  ...
							  <div class="col-sm-3"> 
								<textarea cols="17" rows="5" required class="form-control" id="comments" name="comments" ><?php echo e($comments); ?></textarea>
							  </div>
							</div>
							<div class="form-group">
...
document.getElementById("upload_type").value = "<?php echo e($upload_type); ?>"; 
document.getElementById("for_which").value = "<?php echo e($for_which); ?>"; 
