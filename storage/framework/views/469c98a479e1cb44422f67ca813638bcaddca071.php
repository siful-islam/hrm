...
<!-- Content Header (Page header) -->
    <section class="content-header">
		<h1>Contractual <small>All Non ID Transfer</small></h1>
		<ol class="breadcrumb">
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Contractual Transfer</h3>
							<a href="<?php echo e(URL::to('/con_transfer/create')); ?>" id="add_new" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Add New</a>
					</div>
					<!-- /.box-header -->
					<div class="box-body">	
						...
						<table id="table" class="table table-bordered table-hover" cellspacing="0" width="100%">
							...
							<?php 
								...
								foreach($results as $v_result){ ?>
									...
									<td><?php echo $v_result->from_branch_name;?></td>   
									<td><?php echo $v_result->to_branch_name;?></td> 
									...
									<td><a class="btn btn-sm btn-success btn-xs" title="Edit" href="<?php echo e(URL::to('con_transfer/'.$v_result->id.'/edit')); ?>"><i class="glyphicon glyphicon-pencil"></i> Edit</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-sm btn-info btn-xs" title="view" href="<?php echo e(URL::to('view_nonid_transfer/'.$v_result->id)); ?>"><i class="fa fa-eye"></i> View</a>&nbsp;&nbsp;
										<a class="btn btn-primary" onclick="return checkDelete();"  href="<?php echo e(URL::to('/del_nonid_transfer/'.$v_result->id)); ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td> 
									<?php }else{ ?> 
										<td><a class="btn btn-sm btn-info btn-xs" title="view" href="<?php echo e(URL::to('view_nonid_transfer/'.$v_result->id)); ?>"><i class="fa fa-eye"></i> View</a></td> 
									<?php } ?>
								</tr>
							<?php
								} 
