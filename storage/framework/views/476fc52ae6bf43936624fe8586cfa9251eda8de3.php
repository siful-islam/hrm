...
<?php $__env->startSection('title', 'Permanent Staff Report'); ?>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/permanent-report')); ?>" method="post">
	...
	<?php if(!empty($all_result)): ?>
		<div id="printme">		
			<div class="col-md-12">
				...
				<b><font size="4">Permanent Staff List</font></b></p>		
			</div>
			<div class="col-md-12">
				...
				<table class="table table-bordered" cellspacing="0">
					<thead>
						<tr>
							...
							<th rowspan="2">Next Increment Date</th>
						</tr>
						<tr>
							<th>HO/BO Name</th>
							<th>Joining date</th>
...
//To active  menu.......//
	$(document).ready(function() {
		...
		$("#Permanent_Staff").addClass('active');
	});
</script>
