<?php $__env->startSection('main_content'); ?>
			...
			<table id = "example1" class = "table table-bordered table-striped">
				...
				<?php $__currentLoopData = $allData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr>
						...
						<td><?php echo e($data->br_code); ?></td>
						<td><?php echo e(date("d-m-Y", strtotime($data->branch_opening_date))); ?></td>
						
						<td><?php echo e($data->branch_present_address); ?>, Upazila:<?php echo e($data->upa_name); ?>, District:<?php echo e($data->dis_name); ?></td>
						
						<!--td><?php echo e($data->branch_lat); ?></td>
						
						<td><?php echo e($data->branch_long); ?></td-->
						
						<!--td>
							<?php if(!empty($data->branch_location_updated_at)): ?>
								<?php echo e(\Carbon\Carbon::parse($data->branch_location_updated_at)->diffForhumans()); ?>

							<?php else: ?>
								<?php echo e(\Carbon\Carbon::parse($data->branch_location_created_at)->diffForhumans()); ?>
						...
						<td>
							<button type = "button" class = "btn btn-primary btn-xs button edit_button"
							        ...
							        data-branch_location_id = "<?php echo e($data->branch_location_id); ?>"
							        data-branch_code = "<?php echo e($data->branch_code); ?>"
							        data-branch_opening_date = "<?php echo e($data->branch_opening_date); ?>"
									data-dis_code = "<?php echo e($data->dis_code); ?>"
									data-upa_code = "<?php echo e($data->upa_code); ?>"
							        data-branch_present_address = "<?php echo e($data->branch_present_address); ?>"
							        data-branch_lat = "<?php echo e($data->branch_lat); ?>"
							        data-branch_long = "<?php echo e($data->branch_long); ?>"
							        data-branch_ownership_type = "<?php echo e($data->branch_ownership_type); ?>"
									data-contract_date = "<?php echo e($data->contract_date); ?>"
							        data-branch_contract_validity = "<?php echo e($data->branch_contract_validity); ?>"
							        data-advance_amount = "<?php echo e($data->advance_amount); ?>"
							        data-advance_adjust_monthly = "<?php echo e($data->advance_adjust_monthly); ?>"
							        data-adjust_amount = "<?php echo e($data->adjust_amount); ?>"
							        data-rent_amount = "<?php echo e($data->rent_amount); ?>"
							        data-vat_tax = "<?php echo e($data->vat_tax); ?>"
									data-tax_vat = "<?php echo e($data->tax_vat); ?>"
							        data-total_rent_amount_with_vat_tax = "<?php echo e($data->total_rent_amount_with_vat_tax); ?>"
							        data-office_type = "<?php echo e($data->office_type); ?>"
							        data-office_capacity_sq_feet = "<?php echo e($data->office_capacity_sq_feet); ?>"
							        data-office_capacity_rooms = "<?php echo e($data->office_capacity_rooms); ?>"
							        data-residence_facility = "<?php echo e($data->residence_facility); ?>"
									data-number_of_staff_rooms = "<?php echo e($data->number_of_staff_rooms); ?>"
							        data-number_of_guest_rooms = "<?php echo e($data->number_of_guest_rooms); ?>"
							        data-branch_photo = "<?php echo e($data->branch_photo); ?>"
									data-agreement_file = "<?php echo e($data->agreement_file); ?>"
							        data-branch_location_status = "<?php echo e($data->branch_location_status); ?>"
							        data-branch_location_created_by = "<?php echo e($data->branch_location_created_by); ?>"
							        data-branch_location_created_at = "<?php echo e($data->branch_location_created_at); ?>"
							        data-branch_location_updated_by = "<?php echo e($data->branch_location_updated_by); ?>"
							        data-branch_location_updated_at = "<?php echo e($data->branch_location_updated_at); ?>"
							>
		...
		<div class = "modal-dialog">
			<div class = "modal-content">
				...
				<div class = "modal-body">
					<div class = "row">
						<form method = "post" action = "<?php echo e(URL::to('save_branch_locations')); ?>" data-parsley-validate
							...
							<div class = "col-md-6">
								...
								<div class = "form-group" id = "pre_vou_code1">
									...
									<div class = "col-md-6 col-sm-6 col-xs-12">
										<select required name = "dis_code"
										        ...
										        class = "form-control col-md-7 col-xs-12">
											<option value = "" hidden>Choose One</option>
											<?php $__currentLoopData = $allDistrictData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dbranch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value = "<?php echo e($dbranch->dis_code); ?>"><?php echo e($dbranch->dis_name); ?></option>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</select>
									</div>
								</div>
								...
								<script>
									$(document).on("change", "#dis_code", function () {
										...
										$.ajax({
											url : "<?php echo e(url::to('select-cibupazila')); ?>"+"/"+dis_code,
											type: "GET",
	...
	<div aria-hidden = "true" aria-labelledby = "myModalLabel" role = "dialog" tabindex = "-1"
		...
		<div class = "modal-dialog">
			<div class = "modal-content">
				...
				<div class = "modal-body">
					<div class = "row">
						<form method = "post" action = "<?php echo e(URL::to('update_branch_locations')); ?>" data-parsley-validate
						      class = "form-horizontal form-label-left" enctype = "multipart/form-data">
							<?php echo e(csrf_field()); ?>
								...
								<div class = "form-group" id = "pre_vou_code1">
									...
									<div class = "col-md-6 col-sm-6 col-xs-12">
										<select required name = "upa_code"
										        ...
										        class = "form-control col-md-7 col-xs-12">
											<option value = "" hidden>Choose One</option>
											<?php $__currentLoopData = $allUpazilaData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ubranch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value = "<?php echo e($ubranch->upa_code); ?>"><?php echo e($ubranch->upa_name); ?></option>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</select>
									</div>
								</div>
	...
	<!-- DataTables -->
	<script src = "<?php echo e(asset('public/admin-panel/css/datatables.net/js/jquery.dataTables.min.js')); ?>"></script>
	<script src = "<?php echo e(asset('public/admin-panel/css/datatables.net-bs/js/dataTables.bootstrap.min.js')); ?>"></script>
	<script>
		$(function () {
			$('#example1').DataTable()
