							...
							<div class="box box-widget widget-user-2">
								<div class="widget-user-header bg-blue">
									<div class="widget-user-image">
										<?php 
										if($emp_photo) { ?>
										<img class="img-circle" src="<?php echo e(asset('public/employee/'.$emp_photo)); ?>" alt="User profile picture"> 
										<?php } else { ?>
											<?php if($gender == 'Male') { ?>
											<img class="img-circle" src="<?php echo e(asset('public/avatars/no_photo_male.png')); ?>" alt="User profile picture">
											<?php } else{ ?>
											<img class="img-circle" src="<?php echo e(asset('public/avatars/no_photo_female.jpg')); ?>" alt="User profile picture">
											<?php } ?>
										<?php } ?>
									</div>
								...
								<div class="box-footer no-padding">
									<form action="<?php echo e(URL::to('/attendence')); ?>" method="post">
