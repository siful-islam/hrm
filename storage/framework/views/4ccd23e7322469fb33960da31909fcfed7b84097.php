...
<?php $__env->startSection('title', 'Demotion Staff Report'); ?>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/demotion-report')); ?>" method="post">
	...
	<div class="row">
		<div id="printme">
			<div class="col-md-12">
				...
				<b><font size="4">Demotion Staff List</font></b></p>		
			</div>
			<div class="col-md-12">
				<table class="table table-bordered" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo e($result->salary_basic); ?></td>
							<td><?php echo e($result->payable); ?></td>
							<td><?php echo e($result->net_payable); ?></td>
							<td><?php echo e($result->branch_name); ?></td>
							<td><?php echo e($result->demotion_type); ?></td>
							<td><a href="<?php echo e(URL::to('/grade-history/'.$result->emp_id)); ?>" target="_blank" class="btn btn-primary" type="button"> Details</a></td>
						</tr>
...
//To active  menu.......//
	$(document).ready(function() {
		...
		$("#Demotion_Staff").addClass('active');
	});
</script>
