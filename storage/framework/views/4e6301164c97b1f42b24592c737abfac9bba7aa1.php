	...
	<div class="row">
		<div id="printme">
			<div class="col-md-10 col-md-offset-1">
					...
					<tbody>
						...
						<tr>
							<td style="border-style:none;padding-top:10px;">
								<p style="font-size: 14px;line-height: 1.6;">কর্মী/কর্মকর্তার নাম: <?php echo e($all_result->emp_name_eng); ?>, 
								আইডি নং- <?php echo e(getBanglaDate($all_result->emp_id)); ?>, পদবী: <?php echo e($all_result->designation_name); ?>, 
								ব্রাঞ্চের নাম: <?php echo e($all_result->branch_name); ?>, সংস্থায় যোগদানের তারিখ:<?php echo e(date('d-m-Y',strtotime($all_result->org_join_date))); ?>, 
								স্থায়ীকরণের তারিখ:<?php echo e(date('d-m-Y',strtotime($permanent_date))); ?>,
								 অব্যহতির তারিখ:<?php echo e(date('d-m-Y',strtotime($all_result->re_effect_date))); ?>,
				...
				<form class="form-horizontal" action="<?php echo e(URL::to('/final-payment-insert')); ?>" method="post">
				<?php echo e(csrf_field()); ?>
							...
							<td>
								<table class="table">									
									...
									<tr>
										...
										<td>
											<input type="text" name="plus_item_amt[]" value="0" id="plus_item<?php echo e($i); ?>" onkeyup="plus_calculate(<?php echo count($all_plus_item);?>);" onClick="this.select();">
							...
							<td>
								<table class="table">									
									...
									<tr>
										...
										<td>
											<input type="text" name="minus_item_amt[]" value="0" id="minus_item<?php echo e($i); ?>" onkeyup="minus_calculate(<?php echo count($all_minus_item);?>);" onClick="this.select();">
	...
	<div class="row">
		<div id="printme">
			<div class="col-md-10 col-md-offset-1">
				...
				<form class="form-horizontal" action="<?php echo e(URL::to('/final-payment-pf')); ?>" method="post">
				<?php echo e(csrf_field()); ?>
	...
	<div class="row">
		<div id="printme">
			<div class="col-md-10 col-md-offset-1">
					...
					<tbody>
						...
						<tr>
							<td style="border-style:none;padding-top:10px;">
								...
								ব্রাঞ্চের নাম: <?php echo e($all_result->branch_name); ?>, সংস্থায় যোগদানের তারিখ:<?php echo e(date('d-m-Y',strtotime($all_result->org_join_date))); ?>, 
								স্থায়ীকরণের তারিখ:<?php echo e(date('d-m-Y',strtotime($permanent_date))); ?>,
								 অব্যহতির তারিখ:<?php echo e(date('d-m-Y',strtotime($all_result->re_effect_date))); ?>, <?php echo e($all_result->br_name_bangla); ?> 
				...
				<form class="form-horizontal" action="<?php echo e(URL::to('/final-payment-gra')); ?>" method="post">
				<?php echo e(csrf_field()); ?>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<tr>
								<td><b>চাকুরীর মেয়াদ কাল : <?php echo e($service_length); ?> </b></td>
								<td><center>-</center></td>
								<td><?php 
							...
							<tr>
								<td><?php echo e($year . ' Years'); ?> ( <?php echo e($salary->salary_basic.'*'.$gratuity->point.'*'.$year); ?> )</td>
								<td><input type="text" name="year_amt" value="<?php echo e($gra_amt_year); ?>" class="form-control" size="2"></td>
							...
							<tr>
								<td><?php echo e($month . ' Months'); ?> ( <?php echo e($salary->salary_basic.'*'.$gratuity->point.'*'.$month); ?> )/12</td>
								<td><input type="text" name="month_amt" value="<?php echo e(round($gra_amt_month)); ?>" class="form-control" size="2"></td>
								<td>সিদীপের প্রাপ্য (কর্মীর দেনা)</td>
								<td><input type="text" name="org_deserve_own" value="" class="form-control" size="2"></td>
							</tr>
							<tr>
								<td>সর্ব-মোট গ্র্যাচুইটি</td>
								<td><input type="text" name="total_pay" value="<?php echo e(round($gra_amt_year+$gra_amt_month)); ?>" class="form-control" size="2"></td>
								<td>সর্ব-মোট দেনা</td>
