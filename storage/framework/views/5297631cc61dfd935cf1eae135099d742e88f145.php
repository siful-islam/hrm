			...
			<!-- form start -->				
				...
				<div class="box-body">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="emp_id" name="emp_id" value="<?php echo e($emp_id); ?>" required>
						</div>
					</div>
					<div class="form-group">
						<label for="org_full_name" class="col-sm-2 control-label">Deposit Date</label>
						<div class="col-sm-4">
							<input type="date" class="form-control" id="diposit_date" name="diposit_date" value="<?php echo e($diposit_date); ?>" required>
						</div>
					</div>
					<div class="form-group">
						<label for="org_full_name" class="col-sm-2 control-label">Deposit Amount</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="diposit_amount" name="diposit_amount" value="<?php echo e($diposit_amount); ?>" required>
						</div>
					</div>
