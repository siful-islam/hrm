		...
		<div class="col-md-12">
			<div class="container-fluid">
				<div style="text-align:center;">
					<h4 style="margin-top:4px;"><b>কর্মদক্ষতা মূল্যায়ন ফরম: <?php echo e($designation_type->desig_type_name_short); ?></b></h4>
					<h5 style="margin-top:4px;"><u><b>মূল্যায়নকাল: <?php echo '01-07-2020';?> হতে  <?php echo '30-06-2021';?></b></u></h5>
				</div>				
				<div class="col-md-10">
					<p><?php echo e($designation_type->desig_type_name_level); ?>: <?php echo e($emp_result->emp_name); ?></p>
					<p>আইডি নং: <?php echo e($emp_result->emp_id); ?></p>
					<p><?php if($emp_result->desig_type_id ==5 || $emp_result->desig_type_id ==6) { echo 'অবস্থানকৃত';} ?> ব্রাঞ্চ: <?php echo e($emp_result->branch_name); ?></p>  
					...
					<p>বর্তমান <?php if($emp_result->desig_type_id ==5) { echo 'এরিয়ায়';} elseif($emp_result->desig_type_id ==6) { echo 'ডিসট্রিক্ট এ';} else {echo 'ব্রাঞ্চে';} ?> যোগদানের তারিখ: <?php echo e(date('d-m-Y', strtotime($emp_result->br_join_date))); ?></p>
					<p>সর্বশেষ শিক্ষাগত যোগ্যতা: <?php echo e($emp_result->education); ?></p>
				</div>
			</div>
		</div>
	</div>
