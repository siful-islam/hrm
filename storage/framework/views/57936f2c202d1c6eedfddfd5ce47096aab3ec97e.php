<?php $__env->startSection('title', 'Employee Turnover Report'); ?>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/employee_turnover_report')); ?>" method="post">
						...
						<div class="form-group">
							...
							<select class="form-control" id="emp_group_code" name="emp_group_code" required>						
								...
								<?php $__currentLoopData = $all_emp_group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp_group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($emp_group->id); ?>"><?php echo e($emp_group->group_name); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</select>
						</div>
						<div class="form-group">
						  <label for="pwd">From Date:</label>
						  <input type="text" class="form-control form_date" name="form_date" size="10" value="<?php echo e($form_date); ?>" required />
						</div>
						<div class="form-group">
						  <label for="pwd">To Date:</label>
						  <input type="text" class="form-control form_date" name="to_date" size="10" value="<?php echo e($to_date); ?>" required />
						</div>						
...
$(document).ready(function() {
	...
	document.getElementById("emp_group_code").value="<?php echo e($emp_group_code); ?>";
});
//--></script>
