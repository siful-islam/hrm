				...
				<div class="box box-info">
					<div class="box-body">							
						<div class="form-group">
							...
							<div class="col-sm-3"><div class="form-control"><?php echo e($assign_info->open_date); ?></div></div>
							<label class="col-sm-2 control-label">Employee ID</label>
							<div class="col-sm-3"><div class="form-control"><?php echo e($assign_info->emp_id); ?></div></div>
						</div>
						<hr>
						<div class="form-group">
							...
							<div class="col-sm-3"><div class="form-control"><?php echo e($assign_info->emp_name_eng); ?>

							</div></div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">Designation</label>
							<div class="col-sm-3"><div class="form-control"><?php echo e($assign_info->designation_name); ?></div></div>
							<?php if($assign_info->select_type=="2") { ?>
							<label class="col-sm-2 control-label">Branch</label>
							<div class="col-sm-3"><div class="form-control"><?php echo e($assign_info->branch_name); ?></div></div>
							<?php } ?>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-3"><div class="form-control"><?php echo e($assign_info->incharge_as); ?></div></div>
							<?php if($assign_info->select_type=="2") { ?>
							<label class="col-sm-2 control-label">Salary Branch</label>
							<div class="col-sm-3"><div class="form-control"><?php echo e($assign_info->salary_branch_name); ?></div></div>
							<?php } ?>
						</div>						
					</div>
					<!-- /.box-body -->
					<div class="box-footer">
						<a href="<?php echo e(URL::to('/emp-assign')); ?>" class="btn bg-olive" ><i class="fa fa-fw fa-long-arrow-left" ></i> Back-to-List</a>
					</div>
				   <!-- /.box-footer -->
				</div>
			</div>
