		...
		<div class="box box-info"> 
			<div class="box-body">  
				<h4>Visit Information</h4>
						...
						<input type="hidden" name="visit_type"   id="visit_type"  class="form-control" value="<?php echo e($visit_type); ?>" > 
						<input type="hidden"    id="purpose"  class="form-control" value="<?php echo e($purpose); ?>" > 
						<div class="row"> 
								...
								<div class="col-md-12 table-responsive" >
									<table class="table table-bordered">
										...
										<tbody>
											<tr>
												<td >
													<input type="date" name="travel_date" onchange="select_travel_amt()"  id="travel_date" autocomplete="off"  class="form-control middle" value="<?php echo e($travel_date); ?>" min="<?php echo e($travel_date); ?>" required  max="<?php echo e($arrival_date); ?>" >
												...
												<td> 
													...
													<?php }else{ ?>
													<input type="text" name="dest_br_code"  id="dest_br_code"  class="form-control middle" value="<?php echo e($destination_code); ?>"> 
													<?php }  ?>
												</td> 
												<td>
						...
						<div class="box-body">  	
							...
							<div class="row"> 
								<form class="form-horizontal" id="ajax_insert_bill" action="" role="form" method="POST" enctype="multipart/form-data">
									...
									<input type="hidden" name="move_id_bill"   id="move_id_bill"  class="form-control" value="<?php echo e($move_id); ?>" > 
									...
									<div class="col-md-12 table-responsive">
										<table class="table table-bordered"> 
											...
											<tr>
												<td>
													<input type="date" name="bill_date" onchange="get_grade_wise_allowance()"  id="bill_date" autocomplete="off"  class="form-control middle" value="<?php echo e($travel_date); ?>"  min="<?php echo e($travel_date); ?>" max="<?php echo e($arrival_date); ?>" required> 
												</td> 
												<td>
													<input type="number" name="breakfast" id="breakfast" onkeyup="calculate_bill_allowance()" onclick="this.select();" autocomplete="off"  class="form-control middle amount" value="<?php echo e($breakfast); ?>" required> 
												</td> 
												<td>
													<input type="number" name="lunch"  id="lunch" onkeyup="calculate_bill_allowance()" autocomplete="off" onclick="this.select();" class="form-control middle amount" value="<?php echo e($lunch); ?>" required> 
												</td> 
												<td>
													<input type="number" name="dinner"  onkeyup="calculate_bill_allowance()" id="dinner" autocomplete="off" onclick="this.select();" class="form-control middle amount" value="<?php echo e($dinner); ?>" required> 
												</td> 
												<td>
													<input type="number" name="tot_amt" readonly id="tot_amt" autocomplete="off" align="right" class="form-control middle amount" onclick="this.select();" value="<?php echo e($tot_amt); ?>" required> 
												</td>  
												<td align="center">
					...
					<div class="box-body"> 
						<div class="row"> 
							...
							<div class="box-header with-border">			
								...
								<img src="<?php echo e(asset(Session::get('org_logo'))); ?>" style="float:left;margin-top:0%;" width="50" >
								</span>
                            ...
                            <div class="col-md-12 table-responsive" >
								...
								<div class="modal-footer"> 
									<span id="modal_save_btn">
									 <a class="btn btn-sm btn-success" title="Create bill"  href="<?php echo e(URL::to('tra_bill_save/'.$move_id.'/'.$grade_code.'/'.$designation_code)); ?>">Save</a> &nbsp;&nbsp;
									</span>
 ...
 function check_destination(){
	 var source_br_code = document.getElementById("source_br_code").value;
		...
		$('#ajax_insert').on('submit',function(e){ 
				e.preventDefault();
					...
					//alert('ok');
						...
						$.ajax({ 
							url : "<?php echo e(URL::to('travel_insert')); ?>", 
		...
		function edit(id)
		{
			...
			$.ajax({
				url : "<?php echo e(URL::to('travel_edit')); ?>"+"/"+id,		
				type: "GET",
				dataType: "JSON",
				success: function(data)
				{
	...
	function delete_row(id)
		{
			...
			{  
				...
				$.ajax({ 
				url : "<?php echo e(URL::to('movement_delete')); ?>"+"/"+ table +"/"+ id,
				type : "get", 
				success : function(data) {  
					$("#reload_tbl").load(location.href + " #reload_tbl"); 
						console.log(data);
		...
		$('#ajax_insert_bill').on('submit',function(e){
				e.preventDefault();
					...
					//alert('ok');
				$.ajax({ 
					url : "<?php echo e(URL::to('bill_insert')); ?>", 
					type : "POST", // type of action POST || GET 
		...
		function edit_bill(id)
		{
			...
			$.ajax({
				url : "<?php echo e(URL::to('bill_edit')); ?>"+"/"+id,		
				type: "GET",
				dataType: "JSON",
				success: function(data)
				{
