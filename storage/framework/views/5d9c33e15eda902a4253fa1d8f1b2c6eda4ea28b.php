			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						...
						<!-- <a href="<?php echo e(URL::to('/shoesize_update')); ?>" id="add_new" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Update</a> -->
						<?php }else{ ?>
							<a href="<?php echo e(URL::to('/shoesize_create')); ?>" id="add_new" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Add New</a>
						<?php } ?>
