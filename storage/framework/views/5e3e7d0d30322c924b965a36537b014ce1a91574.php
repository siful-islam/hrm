			...
			<!-- form start -->
				...
				<div class="box-body col-md-7">					
					...
					<div class="form-group">
						...
						<label for="Console_salary" class="col-sm-3 control-label">Present Designation:</label>
						<div class="col-sm-3"> 
							<span class="form-control"> <?php  echo  $pre_designation_name;  ?></span>
						</div>
					</div> 
					<div class="form-group"> 
						<label for="Console_salary" class="col-sm-3 control-label">New Designation: </label>
						<div class="col-sm-3"> 
							<span class="form-control"> <?php  echo  $c_designation_name;  ?></span>
						</div>
