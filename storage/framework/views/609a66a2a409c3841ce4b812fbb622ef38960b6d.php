<?php $__env->startSection('title', 'View Records'); ?>
	...
	<section class="content">
		<div class="box box-info">
			<div class="box-header with-border">
				...
				<form class="form-horizontal" action="<?php echo e(URL::to('view-records')); ?>" method="post">
		...
		<?php if(count($employee_info) > 0) {?>	
			<div class="col-md-12">
				<div class="box box-solid">
					...
					<!-- /.box-header -->
					<div class="box-body">
						<a class="btn btn-info pull-right" target="_BLANK" href="document-view/<?php echo e($emp_id); ?>/0/0"><i class="fa fa-book" aria-hidden="true"></i> EDMS</a>
						<br></br>
