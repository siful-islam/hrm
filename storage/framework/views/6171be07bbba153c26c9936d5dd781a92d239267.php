			...
			<form id="form" class="form-horizontal" <?php if(empty($mode)){?>  onsubmit="return validateForm()" <?php } ?> name="employee_nonid" action="<?php echo e(URL::to($action)); ?>" method="post" enctype="multipart/form-data">
				...
				<div class="box-body col-md-8">	
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" <?php if($mode == 'edit'){?> readonly <?php } ?> id="sacmo_id" name="sacmo_id" value="<?php echo e($sacmo_id); ?>" onChange="get_employee_info();" required> 
						</div>
					...
					<div class="form-group">
						...
						<input type="hidden" name="br_code" id="br_code" value="<?php echo e($br_code); ?>" class="form-control">
						<input type="hidden" name="salary_br_code" id="salary_br_code" value="<?php echo e($salary_br_code); ?>" class="form-control">
	...
	function get_employee_info()
		{
			...
			//alert(emp_type);
			$.ajax({
				url : "<?php echo e(URL::to('get_nonemployee_official_info')); ?>"+"/"+ sacmo_id +"/"+emp_type,
				type: "GET",
				dataType: "JSON",
				success: function(data)
				{
