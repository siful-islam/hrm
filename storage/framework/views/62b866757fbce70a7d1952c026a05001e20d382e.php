				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label class="col-sm-2 control-label"> Receive Amount <span class="required">*</span></label>
							<div class="col-sm-1">
							...
							<label class="col-sm-2 control-label">Receive Date <span class="required">*</span></label>
							<div class="col-sm-2">
