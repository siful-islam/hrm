	...
	<section class="content">
		...
		<div class="box box-info">
			<div class="box-header">
				<form action="<?php echo e(URL::to('/loan_reports')); ?>" method="post" class="form-inline">
				...
				<div class="table-responsive" id="dynamic_report">
						...
						<table class="table table-bordered table-striped">
							...
							<tr>
								...
								<td><a target="_BLANCK" href='<?php echo e(URL::to("/application_location/$result->loan_app_id")); ?>'><?php echo $status; ?></a></td> 
							</tr>
