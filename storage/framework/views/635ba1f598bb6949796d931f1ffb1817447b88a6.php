...
<?php $__env->startSection('title', 'Edit Contractual Transfer'); ?>
<?php $__env->startSection('main_content'); ?>
	...
	<section class="content">
		...
		<div class="box box-info"> 
			...
			<form id="form" class="form-horizontal" <?php if(empty($mode)){?>  onsubmit="return validateForm()" <?php } ?> action="<?php echo e(URL::to($action)); ?>" method="post" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>	 
				<?php echo $method_control; ?>

				<input type="hidden" class="form-control" id="designation_code" name="designation_code" value="<?php echo e($designation_code); ?>"> 
				<input type="hidden" class="form-control" id="after_trai_join_date" name="after_trai_join_date" value="<?php echo e($after_trai_join_date); ?>"> 
				<input type="hidden" class="form-control" id="after_trai_br_code" name="after_trai_br_code" value="<?php echo e($after_trai_br_code); ?>"> 
				<input type="hidden" class="form-control" id="next_renew_date" name="next_renew_date" value="<?php echo e($next_renew_date); ?>"> 
				<input type="hidden" class="form-control" id="end_type" name="end_type" value="<?php echo e($end_type); ?>"> 
				<input type="hidden" class="form-control" id="c_end_date" name="c_end_date" value="<?php echo e($c_end_date); ?>">  
				<input type="hidden" class="form-control" id="br_join_date" name="br_join_date" value="<?php echo e($br_join_date); ?>"> 
				<input type="hidden" class="form-control" id="emp_id" name="emp_id" value="<?php echo e($emp_id); ?>"> 
				<input type="hidden" class="form-control" name="tran_db_id" value="<?php echo e($tran_db_id); ?>"> 
				<div class="box-body col-md-7">					
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" <?php echo $mode;?> id="sacmo_id" name="sacmo_id" value="<?php echo e($sacmo_id); ?>" onChange="get_employee_info();" required> 
						</div>
	...
	function get_employee_info()
		{
			...
			//alert(emp_type);
			$.ajax({
				url : "<?php echo e(URL::to('get_nonemployee_transfer')); ?>"+"/"+ sacmo_id +"/"+emp_type,
				type: "GET",
				dataType: "JSON",
				success: function(data)
				{
		...
		function validateForm()
		{
			...
			//alert(emp_id);
			$.ajax({
				url : "<?php echo e(url::to('check_nonid_effect_date')); ?>"+"/"+ emp_id+"/"+ effect_date,
				type: "GET",
				async: false,
				success: function(data)
				{
