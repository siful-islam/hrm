...
<?php $__env->startSection('title', 'Leave Edit'); ?>
<?php $__env->startSection('main_content'); ?>
	...
	<section class="content">
		<div class="box box-info">
			...
			<!-- /.box-header -->
			<!-- form start -->
				<form   action="<?php echo e(URL::to('/search_emp_info')); ?>" method="post" enctype="multipart/form-data" id="form1">
						...
						<div class="col-md-4">
							<div class="form-group"> 
								<label class="control-label col-md-4"> Financial Year:</label>
									<div class="col-md-6">
										<select name="f_year_start" id="f_year_start" class="form-control"  required style="pointer-events:none;">  
						...
						<div class="col-md-3">
							<div class="form-group"> 
								<label class="control-label col-md-4">Employee ID :</label>
									<div class="col-md-6">
										<input type="text"  name="employee_id" id="employee_id"  class="form-control"  value="<?php // echo $employee_id; ?>" required  readonly />
				...
				<br>
				<br>
				<form class="form-horizontal" action="<?php echo e(URL::to('/update_aprove_leave')); ?>" onsubmit="return change_with_pay();" role="form" method="POST" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>

				<input type="hidden" name="f_year_id" id="f_year_id" class="form-control" value="<?php echo e($f_year_id); ?>" readonly >
				<input type="hidden"   id="f_year_from" class="form-control" value="<?php echo e($f_year_from); ?>" readonly > 
				<input type="hidden"  name="db_id" id="db_id" class="form-control" value="<?php echo e($db_id); ?>" readonly >
				<input type="hidden" name="pre_no_of_days" class="form-control" readonly value="<?php echo e($no_of_days); ?>" required>
				<input type="hidden" name="org_join_date" id="org_join_date"  class="form-control" value="<?php echo e($joining_date); ?>" readonly required>
								...
								<div class="row"> 
									<div class="col-md-5">
										<div class="form-group"> 
											<label class="control-label col-md-4">Employee ID</label>
												<div class="col-md-6">
													<input type="text" name="emp_id" id="emp_id" class="form-control" value="<?php echo e($emp_id); ?>" readonly required>
													<span class="help-block"></span>
												</div> 
										</div> 
									</div>
									<div class="col-md-5">
										<div class="form-group"> 
											<label class="control-label col-md-4">Employee Name </label>
												<div class="col-md-6">
													<input type="text" name="emp_name_eng" class="form-control" value="<?php echo e($emp_name); ?>" readonly required>
													<span class="help-block"></span>
												</div> 
										</div> 
									</div> 
									...
									<div class="col-md-5">
										<div class="form-group"> 
											<label class="control-label col-md-4">Designation</label>
												<div class="col-md-6">
													<input type="text" class="form-control" value="<?php echo e($designation_name); ?>" readonly required>
													<input type="hidden" name="designation_code"  class="form-control" value="<?php echo e($designation_code); ?>" readonly required>
													<span class="help-block"></span>
												</div> 
										</div> 
									</div> 
									<div class="col-md-5">
										<div class="form-group"> 
											<label class="control-label col-md-4">Working Station</label>
												<div class="col-md-6">
													<input type="text"   readonly  class="form-control" value="<?php echo e($branch_name); ?>" required>
													<input type="hidden" name="branch_code" readonly  class="form-control" value="<?php echo e($branch_code); ?>" required>
													<span class="help-block"></span>
												</div> 
										</div> 
									</div> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Application Date </label>
											<div class="col-md-6">
												<input type="text" name="application_date" id="application_date" onchange="calculate_earn_leave();"  class="form-control" value="<?php echo e($application_date); ?>" autocomplete="off"   required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Serial No</label>
											<div class="col-md-6">
												<input type="text" name="serial_no"      class="form-control" value="<?php echo e($serial_no); ?>"  required> 
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">FY Cummulative </label>
											<div class="col-md-6">
												<input type="text" name="cum_balance_less_12" id="cum_balance_less_12" class="form-control" value="<?php echo e($cum_balance_less_12); ?>" readonly required> 
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4" style="margin-left:0px;padding-left:0px;padding-right:0px;">Cum.balance till last year</label>
											<div class="col-md-6">
												<input type="text" name="pre_cumulative_open" id="pre_cumulative_open"  class="form-control" value="<?php echo e($pre_cumulative_open); ?>" readonly required>
												<input type="hidden" name="cum_balance" id="cum_balance"  class="form-control" value="<?php echo e($cum_balance); ?>" readonly required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4" style="margin-left:0px;padding-left:0px;padding-right:0px;margin-right:0px;">curr. Opening Balance </label>
											<div class="col-md-6">
												<input type="text" name="current_open_balance" id="current_open_balance" class="form-control" value="<?php echo e($current_open_balance); ?>" readonly required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4" style="margin-left:0px;padding-left:0px;padding-right:0px;margin-right:0px;">Casual Opening Balance </label>
											<div class="col-md-6">
												<input type="text" name="casual_leave_open" id="casual_leave_open" class="form-control" value="<?php echo e($casual_leave_open); ?>" readonly required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4" style="margin-left:0px;padding-left:0px;padding-right:0px;margin-right:0px;">Apply For </label>
											<div class="col-md-6">
												<select class="form-control" name="apply_for" id="apply_for" onchange="set_day_half();" style="pointer-events:none;">
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Leave Type </label>
											<div class="col-md-6">
												<select  name="type_id" class="form-control" onchange="change_leave_type()" id="type_id" style="pointer-events:none;" required > 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Pay Type </label>
											<div class="col-md-6">
												<select  name="is_pay" class="form-control"  onchange="change_pay_type();"  id="is_pay" required style="pointer-events:none;"> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Approved's From </label>
											<div class="col-md-6">
												<input type="text" autocomplete="off"  name="from_date" onchange="settotalday1();"  id="from_date" class="form-control" value="<?php echo e($from_date); ?>" required>
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Approved's To </label>
											<div class="col-md-6">
												<input type="text" autocomplete="off"  name="to_date"  id="to_date"  onchange="settotalday();"  class="form-control" value="<?php echo e($to_date); ?>" required>
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Total Leave Day/s</label>
											<div class="col-md-6">
												<input type="text" name="no_of_days" onkeyup="change_tot_leave()" id="no_of_days" class="form-control" value="<?php echo e($no_of_days); ?>" required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div>
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Remarks</label>
											<div class="col-md-6">
												 <input list="browsers" class="form-control"   name="remarks" value="<?php echo e($remarks); ?>" id="remarks">
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Cumulative Closing</label>
											<div class="col-md-6">
												<input type="text" name="pre_cumulative_close" id="pre_cumulative_close" class="form-control" readonly value="<?php echo e($cum_close_balance); ?>" required>
												<input type="hidden" name="cum_close_balance" id="cum_close_balance" class="form-control" readonly value="<?php echo e($cum_close_balance); ?>">
												<span class="help-block"></span>
											</div> 
									</div> 
								</div>
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Casual Closing</label>
											<div class="col-md-6">
												<input type="text" name="casual_leave_close" id="casual_leave_close" class="form-control" readonly value="<?php echo $casual_leave_close;?>" required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div>
								 <div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">FY Cummulative close</label>
											<div class="col-md-6">
												<input type="text"  id="cum_balance_less_close_12" name="cum_balance_less_close_12" class="form-control" readonly value="<?php echo e($cum_balance_less_close_12); ?>" required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Total Earn Leave</label>
											<div class="col-md-6">
												<input type="text" name="tot_earn_leave" id="tot_earn_leave" class="form-control" readonly value="<?php echo e($tot_earn_leave); ?>" required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Adjustment</label>
											<div class="col-md-6"> 
												<select  name="leave_adjust" id="leave_adjust"  class="form-control"  required style="pointer-events:none;"> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Total Leave enjoy</label>
											<div class="col-md-6">
												<input type="text"  id="tot_expense" name="tot_expense" class="form-control" readonly value="<?php echo e($tot_expense); ?>" required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div>
									...
									<div class="form-group"> 
										<label class="control-label col-md-4">Approved By</label>
											<div class="col-md-6">
												...
												<?php $__currentLoopData = $branch_staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo $staff['emp_id'].','.$staff['designation_code'] ?>"><?php echo e($staff['emp_name'].' ( '.$staff['designation_name'].' ) '); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
											</div> 
									</div> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Balance</label>
											<div class="col-md-6">
												<input type="text" name="leave_remain" id="leave_remain" class="form-control" readonly value="<?php echo e($leave_remain); ?>" required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
									...
									<div class="form-group"> 
										<label class="control-label col-md-2"></label>
											<div class="col-md-6"> 
												...
												<a href="<?php echo e(URL::to('/approved-leave')); ?>" class="btn btn-success" >&nbsp;&nbsp;list&nbsp;&nbsp;</a>
											</div> 
									</div> 
								</div>
							</div>  
...
<script>
 function settotalday1(){
	...
	// var dataString = 'employee_id='+employee_id;
			$.ajax({
				type:'get',
				url : "<?php echo e(URL::to('leave_date_exist_edit')); ?>"+"/"+from_date+"/"+to_date+"/"+emp_id+"/"+db_id,
...
<script>
 if('<?php echo e($is_pay); ?>' != ''){
	document.getElementById("is_pay").value = "<?php echo e($is_pay); ?>";
} 
if('<?php echo e($leave_adjust); ?>' != ''){
	document.getElementById("leave_adjust").value = "<?php echo e($leave_adjust); ?>";
}
if('<?php echo e($apply_for); ?>' != ''){
	document.getElementById("apply_for").value = "<?php echo e($apply_for); ?>"; 
}
 if('<?php echo e($type_id); ?>' != ''){
	document.getElementById("type_id").value = "<?php echo e($type_id); ?>";
	change_leave_type();
}if('<?php echo e($f_year_id); ?>' != ''){
	document.getElementById("f_year_start").value = "<?php echo e($f_year_id); ?>"; 
} if('<?php echo e($employee_id); ?>' != ''){
	document.getElementById("employee_id").value = "<?php echo e($employee_id); ?>"; 
} if('<?php echo e($approved_id); ?>' != ''){
	document.getElementById("approved_id").value = "<?php echo e($approved_id.','.$appr_desig_code); ?>"; 
} 
function change_leave_type() {
	var type_id = document.getElementById("type_id").value;
	 //alert(type_id);
		 $.ajax({
			type: "GET",
			url : "<?php echo e(URL::to('yearly-tot-leave')); ?>"+"/"+type_id, 
