	...
	<section class="content">
		<div class="box box-info">
			...
			<?php if(!empty($all_result)){?>
				<br>
				<br>
				<form class="form-horizontal"  action="<?php echo e(URL::to('/insert_dairy_calender')); ?>" role="form" method="POST" enctype="multipart/form-data">
						...
						<table class="table no-border table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo $emp['emp_type'];?>
									<input type="hidden" name="emp_type[<?php echo $i;?>]" class="form-control" value="<?php echo $emp['emp_type_code'];?>">
									</td>
									...
									<td><input type="text" name="num_dairy[<?php echo $i;?>]" class="form-control" value=""></td> 
									<td><input type="text" name="num_calender[<?php echo $i;?>]" class="form-control" value="" ></td> 
