  ...
  -moz-appearance: textfield;
		...
		<div class="box box-info"> 
			<div class="box-header with-border"> 
				<h3 class="box-title" style="float:left;">Salary Information&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h3>
					 <span class="help-block">is Consolidated? &nbsp;&nbsp;&nbsp;<input type="checkbox"   id="is_Consolidated1" onclick="change_is_cosoleded()" value="<?php echo e($is_consolidated); ?>" <?php if($is_consolidated == 1) echo "checked";?> ></span>
			</div>
			<div class="box-body">	
				<form id="form" class="form-horizontal" <?php if(empty($mode)){?>  onsubmit="return validateForm()"  <?php } ?>  name="employee_nonid" action="<?php echo e(URL::to($action)); ?>" method="post" enctype="multipart/form-data">
					...
					<input type="hidden" class="form-control" id="br_code" name="br_code" value="<?php echo e($br_code); ?>"> 
					<input type="hidden" class="form-control" id="is_consolidated" name="is_consolidated" value="<?php echo e($is_consolidated); ?>"> 
							...
							<div class="form-group">
								<div class="col-md-6">	
									...
									<div class="col-sm-6">
										...
										<input type="date" class="form-control" autocomplete="off" <?php if($mode == 'edit'){?> readonly <?php } ?> id="letter_date" name="letter_date" value="<?php echo e($letter_date); ?>" onChange="get_employee_info();" required>
								...
								<div class="col-md-6">	
									...
									<div class="col-sm-6">
										<input type="number" class="form-control" autocomplete="off" <?php if($mode == 'edit'){?> readonly <?php } ?> id="emp_id" min="200000" name="emp_id" value="<?php echo e($emp_id); ?>" onChange="get_employee_info();" required>
										<span class="help-block"></span>							
									</div>
								</div>
								<div class="col-md-6">	
	...
	<script language="javascript">
		...
		function validateForm()
		{
			...
			var succeed = false;
			$.ajax({
				url : "<?php echo e(url::to('check_nonid_salary_effect_date')); ?>"+"/"+ emp_id+"/"+ effect_date,
				type: "GET",
				async: false,
		...
		function get_employee_info()
		{
			...
			$.ajax({
				url : "<?php echo e(URL::to('get_nonemployee_info')); ?>"+"/"+ emp_id +"/"+letter_date,
				type: "GET",
				dataType: "JSON",
				success: function(data)
				{
