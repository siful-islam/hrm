...
<?php $__env->startSection('main_content'); ?>
	...
	<section class="content">
		...
		<div class="box box-info">
			...
			<div class="col-md-6"> 
                    ...
                    <div class="col-md-6">
                        <input type="hidden" name="vill_road" readonly id="vill_road" value="<?php echo e($vill_road); ?>" class="form-control" required placeholder="Village">
			...
			<div class="col-md-6"> 		
                    ...
                    <div class="col-md-6">
                        <input type="hidden" name="post_office"  readonly id="post_office" value="<?php echo e($post_office); ?>" class="form-control" required placeholder="Post Office">
				...
				<div class="col-md-6"> 
                    ...
                    <div class="col-md-6">
						<textarea   class="form-control" name="permanent_add" id="address" ><?php echo e($permanent_add); ?></textarea>
						  <span class="help-block"></span>
			...
			<div class="box-header with-border">
				...
				<div class="col-md-6" <?php if($is_field_reduce == 1){  if($emp_type == 7){?> style="display:block;"  <?php }else{ ?> style="display:none;" <?php } } ?>> 
                    ...
                    <div class="col-md-6"> 
                        ...
                        <span class="help-block">Till the Project is running &nbsp;&nbsp;&nbsp;<input type="checkbox" name="end_type" id="end_type" value="<?php echo e($end_type); ?>" <?php if($end_type == 0){ ?> checked <?php }  ?> ></span>
						   <span class="help-block"></span>
                    </div>
                </div>
				<div class="col-md-6"> 
				...
				<div class="box-header with-border">
					...
					<h3 class="box-title" style="float:left;">Salary Information&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h3>
					 <span class="help-block" >is Consolidated? &nbsp;&nbsp;&nbsp;<input type="checkbox"  name="is_Consolidated" id="is_Consolidated" value="<?php echo e($is_Consolidated); ?>" <?php if($is_Consolidated == 2) echo "checked";?> ></span>
				</div><br>
					<div class="form-group">
				<div class="col-md-6"> 
	...
	<script>
		...
		<?php if(!empty($after_trai_br_code)){ ?>
				document.getElementById("br_code").value= "<?php echo e($after_trai_br_code); ?>";
		<?php }else{ ?>
		...
		document.getElementById("join_br_code").value= "<?php echo e($join_br_code); ?>";  
	</script>
