...
<body>
    ...
    <b>Dear Concern,</b>
	<br><br />
	This is for your kind information, <b><?php echo e($mail_data['emp_name']); ?></b> has joined CDIP on <?php echo e(date('d-m-Y',strtotime($mail_data['org_join_date']))); ?>. <?php if($mail_data['gender']=='Male'): ?>He <?php else: ?> She <?php endif; ?> will complete <?php if($mail_data['gender']=='Male'): ?> his <?php else: ?> her <?php endif; ?> probation period on <?php echo e(date('d-m-Y',strtotime($mail_data['permanent_date']))); ?>. Please take necessary step for <?php if($mail_data['gender']=='Male'): ?> his <?php else: ?> her <?php endif; ?> confirmation.
	<br><br>
