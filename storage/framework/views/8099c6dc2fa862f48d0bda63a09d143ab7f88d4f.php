<?php $__env->startSection('title', 'Upcomming Actiities'); ?>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="table-responsive">
								...
								<table class="table table-bordered table-striped">
                                    <tr>
                                        <td style="background-color: #323131; color: white;" align="center" colspan="7">Upcoming Confirmation/Permanent</td>
                                    </tr>
									<tr>
                                        <th>SL</th>
                                        <th>Employee Name</th>
									...
									if($today >=$notification_start_date && $today <=$staff->next_permanent_date) { ?>
										<td><?php echo $i++; ?></td>
										<td><a target="_BLANK" href="<?php echo e(URL::to("/emp-cv/$staff->emp_id")); ?>"><?php echo $staff->emp_name; ?></a></td>
								...
								<table class="table table-bordered table-striped">
                                    <tr>
                                        <td style="background-color: #323131; color: white;" align="center" colspan="8">Upcoming Retirement</th>
                                    </tr>
									<tr>
                                        <th>SL</th>
                                        <th>Employee Name</th>
									...
									if($days_left_to_retirment <=45) { ?>
										...
										<td style="color:red"><?php echo $days_left_to_retirment ?> days</td>
									<?php } ?>
									</tr>
									<?php } ?>
                                </table>
								<table class="table table-bordered table-striped">
                                    <tr>
                                        <td style="background-color: #323131; color: white;" align="center" colspan="7">Upcoming Contract End</th>
                                    </tr>
									<tr>
                                        <th>SL</th>
                                        <th>Employee Name</th>
									...
									<?php $r = 1; foreach($staffs as $staff) { ?>
									<tr>
										<?php if($staff->emp_group == 3) { 
										...
										if($contruct_days_left <= 45 && $contruct_days_left >0) { ?>
											...
											<td style="color:red"><?php echo $contruct_days_left; ?> days</td>
										<?php } } ?>
