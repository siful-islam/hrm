...
<?php $__env->startSection('title', 'Contractual Staff Report'); ?>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/contractual-report')); ?>" method="post">
	...
	<?php if(!empty($all_result)): ?>
		<div id="printme">		
			<div class="col-md-12">
				...
				<b><font size="4">Contractual Staff List</font></b></p>		
			</div>
			<div class="col-md-12">
...
//To active  menu.......//
	$(document).ready(function() {
		...
		$("#Contractual_Staff").addClass('active');
	});
</script>
