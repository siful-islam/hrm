...
body {
	...
	<section class="content">
		<div class="box-header with-border" style="text-align:justfy;text-justify: inter-word;text-align:center;">					 
			<table width="90%" align="center">
				...
				<tr>
					<td align="center" style="font-size:12px;">web:www.cdipbd.org, Email:info@cdipbd.org, Phone:9141891,9141893</td>
				</tr>
			</table>
		...
		সেপ্টেম্বর ০১ , <?php echo $year_bangla; ?><br><br>
		...
		if($designation_code == 211 || $designation_code == 209) { // Zonal Manager hole ?>
		
		<?php echo $zone_name_bn; ?>। 
		
		<?php } elseif($designation_code == 122 || $designation_code == 212) { // Area Manager hole  ?>
		...
		<br><br>	
		জনাব,<br>
		আপনি জেনে আনন্দিত হবেন যে, সেপ্টেম্বর ০১ , <?php echo $year_bangla; ?> হতে আপনাকে <strong> <?php echo $incre_bn ?> </strong> টি বার্ষিক ইনক্রিমেন্ট প্রদান করা হলো। উল্লিখিত  তারিখ থেকে আপনার বেতন ভাতা হবে নিম্নরূপ: <br><br>
		...
		<center>
			...
			$extra_item_count = sizeof($others_allowance_name);
			...
			<table width="80%" border="1" style="font-size:15px;"> 
				...
				<?php if($emp_id == 1131) { $taka = '৩,০০০'; } elseif($emp_id == 2031) {$taka = '২,০০০';}  
					...
					<?php 
					/*$hobe_na = array(209,211,122,212,75,147,227,226,207,213,210);
		...
		<table>
			...
			<?php if($ho_bo ==1) { ?>
				...
				<?php if($designation_code == 209 || $designation_code == 211 || $designation_code == 207|| $designation_code == 210|| $designation_code == 213|| $designation_code == 226|| $designation_code == 227|| $designation_code == 228 || $designation_code == 186 || $designation_code == 241) { ?>
				<tr>
		...
		$designation_rank = array(99,47,145,167,28,144,194,225);
		
		if(in_array($designation_code, $designation_rank)) { ?>
		
		<table>
			<tr>
				<td><img src="<?php echo e(asset('public/ed.PNG')); ?>" height="50" style="float:left;margin-top:0%;"></td>
			</tr>
			<tr>
				<td><b>মোহাম্মদ ইয়াহিয়া </b></td>
			</tr>
			<tr>
		...
		<table>
			<tr>
				<td><img src="<?php echo e(asset('public/lutfor.PNG')); ?>" height="50" style="float:left;margin-top:0%;"></td>
			</tr>
			<tr>
				<td><b>সৈয়দ লুৎফর রহমান</b></td>
			</tr>
			<tr>
				<td> জেনারেল ম্যানেজার (মানব সম্পদ বিভাগ) </td>
			</tr>
		</table>
		...
		<?php if($br_code != 9999) { ?>
			...
			<?php } elseif($designation_code == 13 || $designation_code == 15 || $designation_code == 19 ||$designation_code == 23 ||$designation_code == 24 ||$designation_code == 37||$designation_code == 228 ) { ?>
					<ul style="list-style: none;">
	...
	<?php } ?> 
		<table width="100%" border="0" align="center">
			<tr>
				<td align="center" style="font-size:8px;">This Letter Generated by CDIP Human Resource Management Software</td>
			</tr>
		</table>
	</section> 
