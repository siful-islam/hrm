...
<body>
    ...
    <b>Dear Concern,</b>
	<br><br />
	This is for your kind information, <b><?php echo e($mail_data['emp_name']); ?></b> has joined CDIP on <?php echo e(date('d-m-Y',strtotime($mail_data['org_join_date']))); ?>. Based on our HR policy <?php if($mail_data['gender']=='Male'): ?>his <?php else: ?> her <?php endif; ?> retirement date will be on <?php echo e(date('d-m-Y',strtotime($mail_data['retire_date']))); ?>. Please take necessary step.
	<br><br>
