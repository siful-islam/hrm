...
<?php $__env->startSection('title', 'Other Staff Report'); ?>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/other-report')); ?>" method="post">
	...
	<div class="row">
		<div id="printme">
			<div class="col-md-12">
				...
				<b><font size="4">Other Staff List</font></b></p>		
			</div>
			<div class="col-md-12">
				<table class="table table-bordered" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo e($result->increment_review); ?></td>
						</tr>
