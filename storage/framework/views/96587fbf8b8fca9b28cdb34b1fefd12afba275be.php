...
?>
	...
	<section class="content">
		<div class="box box-info">
			...
			<form id="form" class="form-horizontal" action="<?php echo e(URL::to($action)); ?>" method="<?php echo e($method); ?>" enctype="multipart/form-data">
				...
				<input type="hidden" id="session_branch_code" value="<?php echo e($session_branch_code); ?>">
				...
				<div class="box-body col-md-9">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="date" class="form-control" id="effect_date" <?php if($session_branch_code != 9999){   if($id == '' ){ ?> min="<?php echo date("Y-m-01");?>" <?php }   }  ?> name="effect_date" value="<?php echo e($effect_date); ?>" required>
						</div>
	...
	<script>
		$(document).ready(function() {
			...
			document.getElementById("resignation_by").value = '<?php echo e($resignation_by); ?>';
		})
