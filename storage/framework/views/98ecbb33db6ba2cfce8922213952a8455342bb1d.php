		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<a href="<?php echo e(URL::to('/functional-designation/create')); ?>" class="btn bg-navy pull-right btn-xs" type="button"><i class="glyphicon glyphicon-plus" ></i> Add </a>
				</div>
				<div class="box-body">
					...
					<table id="table" class="table table-bordered table-striped">
						...
						<tbody>								
							...
							<tr>
								<td><?php echo e($i++); ?></td>
								<td><?php echo e($result->fun_deg_name); ?></td>
								...
								<td class="text-center">
									...
									<a class="btn btn-primary" title="Edit" href="<?php echo e(URL::to('/functional-designation/'.$result->id.'/edit')); ?>"><i class="glyphicon glyphicon-pencil"></i></a>
								</td>
							</tr>
