...
<section class="content">	
	<div class="row">
		...
		<?php if ($staff_status->submission_status != 3) { ?>
		<div class="col-md-12">
			<p style="float:right;margin-bottom: 10px;"><a href="<?php echo e(URL::to('/pms-submission-supervisor/'.$emp_id)); ?>" class="btn btn-success pull-right" onclick="return checkSubmit()" ><i class="glyphicon glyphicon-plus" ></i> Submit to Supervisor</a></p>
		</div>
		<?php } else { ?>
		<div class="col-md-12">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
						<form method="post" action="<?php echo e(URL::to('/pms-submission-save')); ?>" id="new_form" class="form-horizontal form-label-left">
