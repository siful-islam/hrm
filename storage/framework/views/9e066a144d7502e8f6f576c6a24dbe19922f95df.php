...
<section class="content">	
	<div class="row">			
		...
		<div class="col-md-12">
			<form class="form-horizontal" action="<?php echo e(URL::to($action)); ?>" onsubmit="return pay_month_validation_arrear()" method="<?php echo e($method); ?>" enctype="multipart/form-data">
...
function pay_month_validation_arrear() { 
		...
		var succeed = false;
		$.ajax({
			url : "<?php echo e(url::to('pay_month_validation_arrear')); ?>"+"/"+ arrear_emp_id+"/"+ arrear_to_pay_month,
			type: "GET",
			dataType: "JSON",
			async: false,
