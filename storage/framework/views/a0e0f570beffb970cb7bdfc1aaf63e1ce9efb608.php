...
<?php $__env->startSection('main_content'); ?>
			...
			<!-- form start -->				
				...
				<div class="box-body">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="designation_name" name="designation_name" value="<?php echo e($designation_name); ?>" required>
						</div>
					</div>
					<div class="form-group">
						<label for="org_full_name" class="col-sm-2 control-label">Designation Name Bangla</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="designation_bangla" name="designation_bangla" value="<?php echo e($designation_bangla); ?>" required>
						</div>
					</div>
					<div class="form-group">
	...
	<script>
		...
		document.getElementById("is_reportable").value = '<?php echo e($is_reportable); ?>';
	</script>
		<script>
	//To active  menu.......//
