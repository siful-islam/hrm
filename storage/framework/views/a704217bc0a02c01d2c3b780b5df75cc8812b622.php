...
<?php $__env->startSection('title','Eid Execution form'); ?>
						...
						<div class="col-md-4 col-md-offset-2">
							<div class="form-group"> 
								<label class="control-label col-md-4">Days </label>
									<div class="col-md-6">
										<input type="text"  readonly class="form-control"  value="3" name="no_of_days" id="no_of_days"/>
										<span class="help-block"></span>
									</div> 
							</div> 
						</div> 
...
<script>
	 $(document).ready(function() {
            ...
            $('#eid_form').on('submit', function(event) {
                ...
                url = "<?php echo e(URL::to('/insert_eid_leave_execute')); ?>";
