				...
				<div class="box">
					...
					<div class="box-header">
						<h3 class="box-title pull-right"> 
							<a href="<?php echo e(URL::to('/testimonyadd_gen')); ?>" class="btn btn-success pull-right"><i class="fa fa-plus"></i>New Add</a>
						</h3>
					</div> 
					<div class="box-body">
						...
						<table id="table" class="table no-border table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo e(date("d-m-Y",strtotime($testimonial->created_at))); ?></td>  
									<td class="text-center">
									<a class="btn bg-olive" title="View" href="<?php echo e(URL::to('/testimony_view_gen/'.$testimonial->id.'/'.$testimonial->emp_id)); ?>"><i class="fa fa-eye"></i></a> &nbsp;&nbsp;&nbsp;  
									</td>
								</tr>
