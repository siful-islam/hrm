	...
	<section class="content">
		...
		<div class="box box-info">
			<div class="box-header with-border">
				...
				<input type="hidden" name="f_year_id" id="f_year_id" class="form-control" value="<?php echo e($fiscal_year->id); ?>" readonly required> 
				<input type="hidden" name="supervisor_type"   class="form-control" value="<?php echo e($supervisor_type); ?>" readonly > 
				<input type="hidden" name="recommend_type"   class="form-control" value="<?php echo e($recommend_type); ?>" readonly > 
				<div class="box-body"> 
					<div class="row">  
							<div class="col-md-9">  
								<div class="col-md-6">
									...
									<div class="form-group"> 
										<label class="control-label col-md-4"></label>
											<div class="col-md-7">
												...
												<a href="<?php echo e(URL::to('/approved_by_sup_reject/'.$id.'/'.$supervisor_type)); ?>" class="btn btn-danger" >Reject</a>
