								...
								<tr>
									...
									<td><?php echo e($emp_leave['application_date']); ?></td>  
									 ...
									 <td class="text-center"> 
									  <a class="btn btn-primary" title="view" href="<?php echo e(URL::to('/recommend_leave_view_hrhead/'.$emp_leave['id'].'/'.$emp_leave['emp_id'])); ?>"><i class="fa fa-file" aria-hidden="true"></i></a>
									</td> 
									<td><?php    
												...
												<?php 	}else{ ?>
														 <a class="btn btn-primary" title="details" href="<?php echo e(URL::to('/approved_by_sup_approve_hrhead/'.$emp_leave['id'])); ?>"> Approved</a>  
												<?php 	}
												...
												<?php }else {
													...
													<?php }else{ ?>
														  <span style="color:#FF9900;"><a class="btn btn-info" title="details" href="<?php echo e(URL::to('/approved_by_sup_reject_hrhead/'.$emp_leave['id'])); ?>">Recommend </a> </span> 
													<?php  }
													?>
											...
											<?php	}else{ ?>
													<a class="btn btn-danger" title="details" href="<?php echo e(URL::to('/approved_by_sup_reject_hrhead/'.$emp_leave['id'])); ?>">Reject </a>  
											<?php }
											?>
