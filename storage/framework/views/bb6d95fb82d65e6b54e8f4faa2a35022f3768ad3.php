...
<section class="content">	
				...
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/br_transfer_emp')); ?>" method="post">
						...
						<div class="form-group">
							...
							<input type="text" id="emp_id" class="form-control" name="emp_id" size="10" value="<?php echo e($emp_id); ?>" readonly required>
						</div>
					</form>
				</div>
			</div>
	...
	<div class="row">
		<div class="col-md-12">			
			...
			<form class="form-horizontal" action="<?php echo e(URL::to($action)); ?>" method="POST" onsubmit="return validateForm()" enctype="multipart/form-data">
				<?php echo e(csrf_field()); ?>
					...
					<div class="box box-info">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<textarea class="form-control" name="comments" rows="2" ><?php echo e($comments); ?></textarea>
								</div>
							</div>
						</div>
