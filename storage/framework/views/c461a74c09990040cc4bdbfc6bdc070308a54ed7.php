<?php $__env->startSection('title', 'Manage Supervisor'); ?>
...
<script>
	...
	$(document).ready(function() {
	   table = $('#table').DataTable({
				...
				"responsive": true,
				"ajax":{
					"url": "<?php echo e(URL::to('/all-supervisor')); ?>",
					"dataType": "json",
					"type": "POST",
	...
	function edit(id)
	{
		...
		var url = "<?php echo e(url('')); ?>"+"/"+segment+"/"+ id+"/edit";
	...
	function save()
	{
		...
		if(mapping_id === '') {
			...
			url = "<?php echo e(URL::to('/')); ?>"+"/"+segment+"/"+ mapping_id;
