			...
			<ul class="sidebar-menu" data-widget="tree" id="left_menu"> 
				...
				<li class="treeview" id="MainGroupSelf_Care">
				  ...
				  <ul class="treeview-menu">
					...
					<li id="My_Loan"><a href="<?php echo e(URL::to('/my_loan')); ?>"><i class="fa fa-money"></i> My Loan</a></li>
					<!--<li id="My_Attendence"><a href="<?php echo e(URL::to('/attendence')); ?>"><i class="fa fa-calendar"></i> Attendence</a></li>-->
				    ...
				    <li id="loan_recomendation">
						<a href="<?php echo e(URL::to('/pending_approval')); ?>"><i class="fa fa-check-circle"></i> Loan Recommendation <span class="pull-right-container">
					</span></a>
					</li>
					<li id="group-up-activities"><a href="<?php echo e(URL::to('/upcomming-notification')); ?>"><i class="fa fa-check-circle"></i> Upcoming Activities<span class="pull-right-container">
				...
				<li class="treeview" id="MainGroupPms">
				  ...
				  <ul class="treeview-menu">
					...
					<li id="assessment_report"><a href="<?php echo e(URL::to('/pms-assessment-report')); ?>"><i class="fa fa-user"></i><span>Assessment Report</span></a></li>
					<li id="report_pms"><a href="<?php echo e(URL::to('/pms-report')); ?>"><i class="fa fa-circle-o"></i><span>PMS Status Report</span></a></li>					
					<li id="own_pms"><a href="<?php echo e(URL::to('/pms-assessment')); ?>"><i class="fa fa-user"></i>All PMS Detail</a></li>
					<?php } ?>
				  </ul>
				</li>
					<?php 
