	...
	<section class="content">
		...
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title"> User Role Permission for : <span style="color:red;"><?php echo e($admin_role_name->admin_role_name); ?></span></h3>
			</div>
			<!-- /.box-header -->

			<form role="form" action="<?php echo e(URL::to('save-permission')); ?>" method="post" name="theForm">
			<?php echo e(csrf_field()); ?>

			
				<input type="hidden" name="user_role" value="<?php echo e($user_role); ?>">
