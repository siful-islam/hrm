<?php $__env->startSection('title', 'Probation'); ?>
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Probation List</h3>
							<!--<a href="<?php echo e(URL::to('/probation/create')); ?>" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Add Probarion </a>-->
					</div>
					<!-- /.box-header -->
					<div class="box-body">
...
<script>
	...
	$(document).ready(function() {
	   table = $('#table').DataTable({
			...
			"responsive": true,
			"ajax":{
					 "url": "<?php echo e(URL::to('/all-probation')); ?>",
					 "dataType": "json",
					 "type": "POST",
