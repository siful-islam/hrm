...
<?php $__env->startSection('main_content'); ?>
					...
					<div class="table-responsive">
						...
						<table class="table table-bordered table-striped">
							...
							<tr>
								...
								<td><a class="btn btn-info" href="<?php echo e(URL::to("/loan-approval/$v_pending->loan_app_id/$action_type")); ?>";> <?php echo $btn_link;?></a></td>
							</tr>
							<?php } ?>
						</table>
	...
	<script>
		function show_data()
		{
			...
			var url = "<?php echo e(URL::to('/loan_report')); ?>"; 
			$.ajax({
				type: "GET",
