...
<?php $__env->startSection('main_content'); ?>
	...
	<section class="content">
		<div class="box box-info">
			...
			<!-- /.box-header -->
			<!-- form start -->
				<form   action="<?php echo e(URL::to('/emp_info_testimony_gen')); ?>" method="post" enctype="multipart/form-data" id="form1">
			...
			<?php if(!empty($employee_his)){?>
				<br>
				<br>
				<form class="form-horizontal" action="<?php echo e(URL::to('/insert_emp_testimony_gen')); ?>" role="form" method="POST" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?> 
						<div class="box-body"> 
							 <input type="hidden" name="letter_date" id="letter_date" value="<?php echo e($letter_date); ?>" class="form-control">  
							 <input type="hidden" name="is_short" id="is_short" value="<?php echo e($is_short); ?>" class="form-control"> 
									...
									<div class="col-md-11 col-md-offset-1">
										<div class="form-group"> 
												...
												<input type="submit" id="submit_btn" class="btn btn-primary" value="<?php echo e($button); ?>">
													<a href="<?php echo e(URL::to('/certi_general')); ?>" class="btn btn-success" >&nbsp;&nbsp;list&nbsp;&nbsp;</a>
													</span>
												</div>  
										</div> 
									</div> 
