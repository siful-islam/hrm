	...
	<section class="content">
		<div class="box box-info">
			...
			<?php if(!empty($employee_his)){?> 
				<form class="form-horizontal" onsubmit="return check_leave_exist();" action="<?php echo e(URL::to('/insert_aprove_leave_byhrm')); ?>" role="form" method="POST" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>

				<input type="hidden" name="application_id"  class="form-control" value="<?php echo e($application_id); ?>" readonly >
				...
				<input type="hidden" name="current_open_balance" id="current_open_balance" class="form-control" value="<?php echo e($current_open_balance); ?>" readonly required>
				<input type="hidden" name="current_close_balance" id="current_close_balance" class="form-control" value="" readonly >
				<input type="hidden" name="pre_cumulative_open" id="pre_cumulative_open"  class="form-control" value="<?php echo e($pre_cumulative_open); ?>" readonly required> 
									...
									<div class="col-md-5">
										<div class="form-group"> 
											<label class="control-label col-md-4">Employee ID</label>
												<div class="col-md-6">
													<input type="text" name="emp_id" id="emp_id" class="form-control" value="<?php echo e($employee_his['emp_id']); ?>" readonly required>
									...
									<div class="col-md-5">
										<div class="form-group"> 
											<label class="control-label col-md-4">Employee Name </label>
												<div class="col-md-6">
													<input type="text" name="emp_name_eng" class="form-control" value="<?php echo e($employee_his['emp_name']); ?>" readonly required>
													<span class="help-block"></span>
												</div> 
										</div> 
									</div> 
									...
									<div class="col-md-5">
										<div class="form-group"> 
											<label class="control-label col-md-4">Designation</label>
												<div class="col-md-6">
													<input type="text" class="form-control" value="<?php echo e($employee_his['designation_name']); ?>" readonly required>
													<input type="hidden" name="designation_code"  class="form-control" value="<?php echo e($employee_his['designation_code']); ?>" readonly required>
													<span class="help-block"></span>
												</div> 
										</div> 
									</div> 
									<div class="col-md-5">
										<div class="form-group"> 
											<label class="control-label col-md-4">Working Station</label>
												<div class="col-md-6">
													<input type="text"   readonly  class="form-control" value="<?php echo e($employee_his['branch_name']); ?>" required>
													<input type="hidden" name="branch_code" readonly  class="form-control" value="<?php echo e($employee_his['br_code']); ?>" required>
													<span class="help-block"></span>
												</div> 
										</div> 
									</div> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Application Date </label>
											<div class="col-md-6">
												<input type="text" name="application_date" autocomplete="off"  id="application_date"  class="form-control" value="<?php echo e($application_date); ?>"  required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">FY Cummulative </label>
											<div class="col-md-6">
												<input type="text" name="cum_balance_less_12" autocomplete="off" onkeyup="change_fy_balance()" id="cum_balance_less_12" class="form-control" value="<?php echo e($cum_balance_less_12); ?>"  required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 	 				
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Approved's From </label>
											<div class="col-md-6">
												<input type="text" style="pointer-events:none;" name="from_date" autocomplete="off"  id="from_date" class="form-control" value="<?php echo e($from_date); ?>" required>
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Approved's To </label>
											<div class="col-md-6">
												<input type="text" style="pointer-events:none;" name="to_date"  id="to_date"     autocomplete="off"  class="form-control" value="<?php echo e($to_date); ?>" required>
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Total Leave Day/s</label>
											<div class="col-md-6">
												<input type="text" readonly name="no_of_days"  id="no_of_days" class="form-control" value="<?php echo e($no_of_days); ?>" required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div> 
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">Reason of Leave</label>
											<div class="col-md-6">
												 <input list="browsers" class="form-control" required   name="remarks" value="<?php echo e($remarks); ?>" id="remarks">
								...
								<div class="col-md-5">
									<div class="form-group"> 
										<label class="control-label col-md-4">FY Cummulative close</label>
											<div class="col-md-6">
												<input type="text"  id="cum_balance_less_close_12" name="cum_balance_less_close_12" class="form-control" readonly value="<?php echo e($cum_balance_less_12); ?>" required>
												<span class="help-block"></span>
											</div> 
									</div> 
								</div>  
									...
									<div class="form-group"> 
										<label class="control-label col-md-2"></label>
											<div class="col-md-6"> 
												...
												<a href="<?php echo e(URL::to('/approved_by_hrm')); ?>" class="btn btn-success" >&nbsp;&nbsp;list&nbsp;&nbsp;</a>
											</div> 
									</div>  
								</div> 
							</div> 
 ...
 function check_leave_exist(){
	...
	// var dataString = 'employee_id='+employee_id;
			 $.ajax({
				type:'get',
				async: false,
				url : "<?php echo e(URL::to('leave_date_exist_app')); ?>"+"/"+from_date+"/"+to_date+"/"+emp_id,
