					...
					<tr>
						...
						<td style="text-align:center;">
							<select class="form-control" id="ratingid<?php echo $i; ?>" name="result_item[<?php echo $result->id; ?>][score]" onchange="getid(<?php echo $i;?>)" required >						
								...
								<?php $__currentLoopData = $all_pms_rating; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pms_rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($pms_rating->id); ?>"><?php echo e($pms_rating->number); ?></option>
...
function getid(id) {
	...
	$.ajax({
	url: "<?php echo e(URL::to('/get-marks')); ?>"+ "/"+ rating_id,
	type: 'GET',
	dataType: 'json',
...
function getconeid(id) {
	...
	$.ajax({
	url: "<?php echo e(URL::to('/get-marks')); ?>"+ "/"+ scoreid,
	type: 'GET',
	dataType: 'json',
	success: function(values)
		{                                                                    
...
function getctwoid(id) {
	...
	$.ajax({
	url: "<?php echo e(URL::to('/get-marks')); ?>"+ "/"+ cscoreid,
	type: 'GET',
	dataType: 'json',
	success: function(values)
		{                                                                    
...
function getcthreeid(id) {
	...
	$.ajax({
	url: "<?php echo e(URL::to('/get-marks')); ?>"+ "/"+ cs_coreid,
	type: 'GET',
	dataType: 'json',
	success: function(values)
		{                                                                    
...
function getcfourid(id) {
	...
	$.ajax({
	url: "<?php echo e(URL::to('/get-marks')); ?>"+ "/"+ cs_core_id,
	type: 'GET',
	dataType: 'json',
	success: function(values)
		{                                                                    
