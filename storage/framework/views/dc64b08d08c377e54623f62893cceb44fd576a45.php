	...
	<section class="content">
		...
		<div class="box box-info">
			...
			<form class="form-horizontal" action="<?php echo e(URL::to($action)); ?>"  onsubmit="return duplicate_check()" role="form" method="POST" enctype="multipart/form-data">
				...
				<input type="hidden" id="document_id" class="form-control" value="<?php echo e($document_id); ?>" readonly> 
                <fieldset>
				...
				<fieldset>
						...
						<div class="box-body"> 
											...
											<label class="control-label col-md-5">Group<span class="required">*</span></label>
												<div class="col-md-5">
													 ...
													 <?php $__currentLoopData = $category_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<option value="<?php echo e($category->category_id); ?>"><?php echo e($category->category_name); ?><?php echo "( ".$category->category_id." )";?></option> 
											...
											<label class="control-label col-md-5">Category </label>
												...
												<select  name="subcat_id" id="subcat_id" class="form-control"> 
													...
													<?php $__currentLoopData = $subcategory_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<option value="<?php echo e($subcategory->subcat_id); ?>"><?php echo e($subcategory->subcategory_name); ?><?php echo "( ".$subcategory->subcat_id." )";?></option> 
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												</select>
													<span class="help-block"></span>
												</div> 
								...
								<?php if($access_label == 34 || $access_label == 35 || $access_label == 38) { ?>
									<div class="col-md-5 col-md-offset-1">
										<div class="form-group"> 
		  ...
		  $.ajax({
			...
			success: function(data)
			{
				...
				if(data["emp_id"]){
					...
					<?php //if($access_label != 3) { ?>
						/* if(data["br_code"] != 9999){
							$("#btn_show_hide").html("<button type='submit' class='btn btn-primary'><i class='fa fa-floppy-o' aria-hidden='true'></i> <?php echo e($button); ?></button>");
						}else{
							$("#btn_show_hide").html("");
						} */
					<?php //} ?>
...
$(document).ready(function() {
 ...
 document.getElementById("subcat_id").value = '<?php echo e($subcat_id); ?>';
