...
<?php $__env->startSection('main_content'); ?>
	...
	<section class="content">
		<div class="box box-info">
			...
			<form   action="<?php echo e(URL::to('/requisition_search_emp_info')); ?>" method="post">
			...
			<?php if(!empty($all_result)){?>
				<br>
				<br>
				<form class="form-horizontal"  action="<?php echo e(URL::to('/insert_dairy_calender_org')); ?>" role="form" method="POST" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?> 
