...
<?php $__env->startSection('main_content'); ?>
			...
			<!-- form start -->				
				...
				<div class="box-body">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="grade_name" name="grade_name" value="<?php echo e($grade_name); ?>" required>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-4">
							<select name="scale_id" id="scale_id" class="form-control" required>							
								...
								<?php $__currentLoopData = $all_scale; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_all_scale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($v_all_scale->scale_id); ?>"><?php echo e($v_all_scale->scale_name); ?></option>
	...
	<script>
		...
		document.getElementById("scale_id").value = '<?php echo e($scale_id); ?>';
	</script>
<script>
	//To active  menu.......//
