...
<body>
	...
	<table width="100%">
		...
		<tr>
			<td>Leave Source </td>
			<td>:</td>
			<td valign="top"><?php echo e($mail_data['leave_type_name']); ?></td>
		</tr>
		<?php
    ...
    <div>
        <a id="accept" href="<?php echo e(URL::to('/leave_mail_action' . '/' . $mail_data['application_id'] . '/' . $mail_data['supervisors_emp_id'] . '/1' . '/1')); ?>"
            target="_blanck">Approve</a>
        &nbsp;&nbsp;&nbsp;&nbsp; |
        &nbsp;&nbsp;&nbsp;&nbsp;
        <a id="reject" href="<?php echo e(URL::to('/leave_mail_action' . '/' . $mail_data['application_id'] . '/' . $mail_data['supervisors_emp_id'] . '/2' . '/1')); ?>"
