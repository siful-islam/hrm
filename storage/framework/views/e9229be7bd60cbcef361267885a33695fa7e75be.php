...
<section class="content">
	<div class="row">
				...
				<div class="box-body">
					...
					<div class="stepwizard">
						<div class="stepwizard-row setup-panel">
							...
							<div class="stepwizard-step">
								<a <?php if($status ==3) { ?> href="<?php echo e(URL::to('/pms-view/'.$emp_id.'/1')); ?>" <?php } else { ?> href="#"<?php } ?>type="button" class="btn btn-<?php echo ($status ==3) ? 'primary' : 'default'; ?> btn-circle" <?php echo ($status ==3) ? '' : 'disabled'; ?>>2</a>
								<p>Supervisor Approval</p>
							</div>
							<div class="stepwizard-step">
								<a <?php if($submission_status ==3) { ?> href="<?php echo e(URL::to('/pms-submission')); ?>" <?php } else { ?> href="#"<?php } ?>type="button" class="btn btn-<?php echo $submission_status ==3 ? 'primary' : 'default'; ?> btn-circle" <?php echo $submission_status ==3 ? '' : 'disabled'; ?>>3</a>
		...
		<div class="col-md-12">
			<form class="form-inline report" action="<?php echo e(URL::to('/pms')); ?>" method="post">
