...
<?php $__env->startSection('title', 'Manage Salary Minus'); ?>
<?php $__env->startSection('main_content'); ?>

    <!-- Content Header (Page header) -->
    <section class="content-header">
		<h1>HRM<small>Salary Minus Items</small></h1>
    </section>
    <!-- Main content -->
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Salary Items (-)</h3>
							<a href="<?php echo e(URL::to('salary-minus/create')); ?>" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Item</a>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						...
						<table id="table" class="table table-bordered table-hover" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php if($item->type == 1) {echo $item->percentage.' %';} else {echo $item->fixed_amount.' Taka';} ?></td>
									...
									<td><a class="btn btn-sm btn-primary" title="Edit" href="<?php echo e(URL::to('/salary-minus/'.$item->id.'/edit')); ?>"><i class="glyphicon glyphicon-pencil"></i></a></td>
								</tr>
								<?php } ?>
							</tbody>          
						</table>
