...
<?php $__env->startSection('main_content'); ?>
			...
			<!-- form start -->
				...
				<div class="form-group"> 
					...
					<div class="col-md-6">	
						...
						<div class="col-md-6"> 
							<input type="text" name="sacmo_id" id="sacmo_id" readonly value="<?php echo e($sacmo_id); ?>" required class="form-control">
							<span class="help-block"></span>
						</div> 
					</div>  
				<div class="col-md-6">
				...
				<div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="mother_name" id="mother_name" value="<?php echo e($mother_name); ?>" class="form-control" required placeholder="Mother Name">
                        <span class="help-block"></span>
                    </div>
                </div>  
				<div class="col-md-6">                   
                    ...
                    <div class="col-md-6">
                        <input type="text" name="father_name" id="father_name" value="<?php echo e($father_name); ?>" class="form-control" required placeholder="Father Name">
                        <span class="help-block"></span>
                    </div>
                </div>
				<div class="col-md-6">    
				...
				<div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="contact_num" id="contact_num" value="<?php echo e($contact_num); ?>" <?php if($is_field_reduce == 0){ ?> required  <?php } ?>  class="form-control">
                        <span class="help-block"></span>
                    </div>
				...
				<div class="col-md-6">
                    ...
                    <div class="col-md-6">
						<input type="text" name="last_education" id="last_education" value="<?php echo e($last_education); ?>" <?php if($is_field_reduce == 0){ ?> required <?php } ?>  class="form-control">
                        <span class="help-block"></span>
                    </div>
                </div>
				...
				<div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="vill_road" id="vill_road" value="<?php echo e($vill_road); ?>" class="form-control" required placeholder="Village">
                        <span class="help-block"></span>
                    </div>
                </div>
				<div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="post_office" id="post_office" value="<?php echo e($post_office); ?>" class="form-control" required placeholder="Post Office">
                        <span class="help-block"></span>
                    </div>
                </div>
				...
				<div class="col-md-6" <?php if($is_field_reduce ==1){ if($emp_type == 7){?> style="display:block;"  <?php }else{ ?> style="display:none;" <?php } } ?> >
                    ...
                    <div class="col-md-6">
                        <input type="date" name="c_end_date" <?php if($end_type == 0){ ?>  readonly <?php }  ?>  id="c_end_date" value="<?php echo e($c_end_date); ?>" class="form-control">
				...
				<div class="col-md-6" <?php if($is_field_reduce == 1){ ?> style="display:none;" <?php } ?> >
                    ...
                    <div class="col-md-6">
                        <input type="date" name="next_renew_date"   id="next_renew_date" value="<?php echo e($next_renew_date); ?>" class="form-control"> 
                    </div>
				...
				<div class="box-header with-border"> 
					<h3 class="box-title" style="float:left;">Salary Information&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h3>
					 <span class="help-block">is Consolidated? &nbsp;&nbsp;&nbsp;<input type="checkbox" onclick="change_is_cosoleded()"  name="is_Consolidated" id="is_Consolidated" value="<?php echo e($is_Consolidated); ?>" <?php if($is_Consolidated == 2) echo "checked";?> ></span>
				</div><br>
				<div class="form-group">
				<div class="col-md-6">
	...
	function set_effect_date()
		...
		document.getElementById("emp_type").value= "<?php echo e($emp_type.','.$is_field_reduce); ?>";
		...
		document.getElementById("after_trai_br_code").value= "<?php echo e($after_trai_br_code); ?>";
