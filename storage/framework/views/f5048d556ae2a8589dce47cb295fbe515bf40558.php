<?php $__env->startSection('title', 'Reports|Grade Unnoyon Report'); ?>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/grade_unnoyon_report')); ?>" method="POST">
    ...
    $(document).ready(function () {
        $("#btnExport").click(function () {
            $("#tblExport").table2excel({
                exclude:".noExl",
				name:"Staff List",
				filename:"staff_list_"+<?php echo e($data['emp_grade']); ?>,
            });
        });
    });
</script>
