<?php $__env->startSection('title', 'Grade Wise Service Length Report'); ?>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/grade-service-length')); ?>" method="post">
						...
						<div class="form-group">
							<a href="<?php echo e(URL::to('/demotion-report')); ?>" target="_blank" class="btn btn-success" type="button"> Demotion Staff Report</a>
						</div>
					</form>
				</div>
			</div>
