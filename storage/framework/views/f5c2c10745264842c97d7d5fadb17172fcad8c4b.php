					 ...
					 <div class="box-body">  
									...
									<div class="form-group" style="margin-top:-35px;padding-left:20%;"> 
										 <div class="col-md-12" style="text-align:left;">
											 	<?php echo e($emp_name); ?> 
												<br>
												 <?php echo e($designation_code); ?>, <?php echo e($branch_code); ?> 
										</div>  		
									</div>
									<?php } ?> 
...
/* 	$("#search_attachment").on('submit',function(e){
	...
	function show_image(val,ext,category_id,subcat_id,effect_date){
		...
		if(category_id == 13){
			...
			if((effect_date == '2019-07-01') && (category_id == 23) && (subcat_id == 24))
			{
	  ...
	  if(ext == 1){ ///for pdf
			...
			if(u_user_type == 7){
				var dd="<embed src='<?php echo asset('attachments/"+folder_name+file_name+"#toolbar=1'); ?>' type='application/pdf'  width='100%'  height='700'>";
			}else{
				var dd="<embed src='<?php echo asset('attachments/"+folder_name+file_name+"#toolbar=0&navpanes=0&scrollbar=0'); ?>' type='application/pdf'  width='100%'  height='700'>";
			}
...
$('#category_id').on('change',function(e){
		...
		if(category_id != ''){
			$.ajax({
					type: "GET",
					url : "<?php echo e(URL::to('select_subcategory_per')); ?>"+"/"+category_id, 
					success: function(data)
					{ 
						 $("#subcat_id").html(data); 
					}
