<?php $__env->startSection('title','View License'); ?>
                ...
                <?php echo e(csrf_field()); ?>  
												...
												<div class="row">
													...
													<table class="table no-border" style="width:100%;">
													 ...
													 <table class="table table-bordered" style="width:100%;">
															...
															<tbody>	 
																<tr>
																  <td><?php if(!empty($created_at)): ?> <?php echo e(date('d-m-Y',strtotime($created_at))); ?> <?php endif; ?></td>
																  <td><?php echo e($emp_name); ?></td>
																  <td><?php echo e($designation_code); ?></td>
																  <td><?php echo e($branch_code); ?></td> 
																  <td><?php echo e($license_number); ?></td>
																  <td><?php echo e($license_exp_date); ?></td>
																   <td><?php 
							...
							<?php  } if(!empty($emp_document_list)){
												...
												<div class="box-body table-responsive no-padding" align="center">
													<embed   src="<?php echo e(asset('storage/attachments/driver_license/'.$emp_document_list->document_name)); ?>" type="application/pdf"  width="70%"  style="min-height:500px;">
												</div>
												
												<?php }else if($ext == 2){
												?>
												<div class="box-body table-responsive no-padding" align="center" style="min-height:500px;">
													<iframe   src="<?php echo e(asset('storage/attachments/driver_license/'.$emp_document_list->document_name)); ?>"  width="70%"></iframe>
												</div>
												
												<?php }else{
												?>
												<div class="box-body table-responsive no-padding" align="center" style="min-height:500px;">
													<img  src="<?php echo e(asset('storage/attachments/driver_license/'.$emp_document_list->document_name)); ?>"  width="70%">
												</div>
