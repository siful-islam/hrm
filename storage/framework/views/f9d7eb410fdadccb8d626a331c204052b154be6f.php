...
<?php $__env->startSection('title','Contractual|Designation'); ?>
	...
	<section class="content">
		...
		<div class="box box-info"> 
			...
			<form id="form" class="form-horizontal"  action="<?php echo e(URL::to($action)); ?>" method="post" enctype="multipart/form-data">
				...
				<input type="hidden" class="form-control" id="branch_code" name="branch_code" value="<?php echo e($branch_code); ?>">  
				...
				<input type="hidden" class="form-control"   name="sarok_no" value="<?php echo e($sarok_no); ?>"> 
				...
				<div class="box-body col-md-7">					
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" autocomplete="off" <?php echo $mode;?> id="sacmo_id" name="sacmo_id" value="<?php echo e($sacmo_id); ?>" onChange="get_employee_info();" required> 
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<select class="form-control"   name="pre_designation" id="pre_designation" required>
								...
								<?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_designation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	function get_employee_info()
		{
			...
			//alert(emp_type);
			$.ajax({
				url : "<?php echo e(URL::to('get_nonemployee_designation')); ?>"+"/"+ sacmo_id +"/"+emp_type,
				type: "GET",
				dataType: "JSON",
		...
		function get_designation_his()
		{
			...
			//alert(emp_id);
			$.ajax({
				url : "<?php echo e(url::to('get_nonid_designation_info')); ?>"+"/"+ emp_id,
				type: "GET",
				success: function(data)
				{
					//alert(data);
