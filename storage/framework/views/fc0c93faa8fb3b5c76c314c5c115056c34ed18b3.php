...
<section class="content">	
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/br_transfer_emp')); ?>" method="post">
	...
	<div class="row">
		<div class="col-md-12">			
			...
			<form class="form-horizontal" action="<?php echo e(URL::to($action)); ?>" method="<?php echo e($method); ?>" onsubmit="return validateForm()" enctype="multipart/form-data">
				<?php echo e(csrf_field()); ?>
				...
				<input type="hidden" name="designation_code" value="<?php echo e($all_result->designation_code); ?>">
				<input type="hidden" name="grade_code" value="<?php echo e($all_result->grade_code); ?>">				
				<input type="hidden" name="grade_step" value="<?php echo e($all_result->grade_step); ?>">	
				<input type="hidden" name="grade_effect_date" value="<?php echo e($all_result->grade_effect_date); ?>">	
				<input type="hidden" name="effect_date" value="<?php echo e($all_result->effect_date); ?>">
				<input type="hidden" name="basic_salary" value="<?php echo e($all_result->basic_salary); ?>">
				<input type="hidden" name="next_increment_date" value="<?php echo e($all_result->next_increment_date); ?>">				
				<input type="hidden" name="is_permanent" value="<?php echo e($all_result->is_permanent); ?>">	
				<input type="hidden" name="report_to" value="<?php echo e($all_result->report_to); ?>">
				<input type="hidden" name="pre_br_code" value="<?php echo e($all_result->br_code); ?>">
				<input type="hidden" name="pre_br_join_date" value="<?php echo e($all_result->br_join_date); ?>">
					...
					<div class="box box-info">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">			
									<select class="form-control" name="area_code" id="area_code" >						
										...
										<?php $__currentLoopData = $result_area; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control form_date" id="br_join_date" name="br_join_date" value="<?php echo e($br_join_date); ?>" required onchange="Checkdate()">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label">Transfer Handover Date :</label>
								<div class="col-sm-4">
									<input type="text" class="form-control form_date" id="br_handover_date" name="br_handover_date" value="<?php echo e($br_handover_date); ?>" required>
								</div>
							</div>
							<div class="form-group">
...
<script>
	$(document).on("change", "#area_code", function () {
		...
		//alert(area_code);		 
		$.ajax({
			url : "<?php echo e(url::to('select-branch')); ?>"+"/"+area_code,
			type: "GET",
