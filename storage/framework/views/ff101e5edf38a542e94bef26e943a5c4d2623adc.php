...
<?php $__env->startSection('title', 'Punishment Report'); ?>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/punishment-report')); ?>" method="post">
	...
	<div class="row">
		<div id="printme">
			<div class="col-md-12">
				...
				<b><font size="4">Date wise Punishment Report</font></b></p>		
			</div>
			<div class="col-md-12">
				<table class="table table-bordered" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php if(!empty($result['re_effect_date'])) { 
...
//To active  menu.......//
	$(document).ready(function() {
		...
		$("#Punishment_Report").addClass('active');
	});
</script>
