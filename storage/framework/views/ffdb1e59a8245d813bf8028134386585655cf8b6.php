...
<?php $__env->startSection('title', 'Promotion Staff Report'); ?>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/promotion-report')); ?>" method="post">
	...
	<div class="row">
		<div id="printme">
			<div class="col-md-12">
				...
				<b><font size="4">Promotion Staff List</font></b></p>		
			</div>
			<div class="col-md-12">
				<table class="table table-bordered" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo e($result->promotion_type); ?></td>
						</tr>
...
//To active  menu.......//
	$(document).ready(function() {
		...
		$("#Promotion_Staff").addClass('active');
	});
</script>
