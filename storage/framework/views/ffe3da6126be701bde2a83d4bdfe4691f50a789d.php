...
<?php $__env->startSection('title', 'HeldUp Staff Report'); ?>
	...
	<div class="row">
        <div class="col-md-12"> 
			<div class="box box-info" style="margin-bottom:10px;">
				<div class="box-body">
					<form class="form-inline report" action="<?php echo e(URL::to('/heldup-report')); ?>" method="post">
	...
	<div class="row">
		<div id="printme">
			<div class="col-md-12">
				...
				<b><font size="4">Heldup Staff List</font></b></p>		
			</div>
			<div class="col-md-12">
				<table class="table table-bordered" cellspacing="0">
					<thead>
						<tr>
							...
							<th>Letter Date</th>
							<th>Which HeldUp</th>
							<th>Cause of Heldup</th>
							<th>Heldup Time</th>
							<th>HeldUp untill date</th>
							<th>Join Date Org.</th>
							<th>Ho/Bo name</th>	
							<th>Br. join Date</th>	
							<th>Grade</th>	
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo e($result['what_heldup']); ?></td>
							<td><?php echo e($result['heldup_cause']); ?></td>
							<td><?php echo e($result['heldup_time'].' Months'); ?></td>
							<td><?php echo e($result['heldup_until_date']); ?></td>
